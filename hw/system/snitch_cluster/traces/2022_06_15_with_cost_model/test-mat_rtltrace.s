       ...
       0     3196        M 0x8000092c addi    t2, s6, -1             #; s6  = 5, (wrb) t2  <-- 4
       0     3205        M 0x80000930 slli    s2, a5, 3              #; a5  = 7, (wrb) s2  <-- 56
       0     3206        M 0x80000934 mul     a0, s2, t2             #; s2  = 56, t2  = 4
       0     3209        M                                           #; (acc) a0  <-- 0x00ae8533
       0     3210        M 0x80000938 add     a0, t4, a0             #; t4  = 48, a0  = 224, (wrb) a0  <-- 272
       0     3211        M 0x8000093c add     s3, a0, s7             #; a0  = 272, s7  = 0x00100240, (wrb) s3  <-- 0x00100350
       0     3217        M 0x80000940 sltu    a3, s3, a0             #; s3  = 0x00100350, a0  = 272, (wrb) a3  <-- 0
       0     3218        M 0x80000944 bge     zero, a4, pc + 80      #; a4  = 6, not taken
       0     3219        M 0x80000948 addi    t0, a4, -1             #; a4  = 6, (wrb) t0  <-- 5
       0     3220        M 0x8000094c slli    t1, t0, 3              #; t0  = 5, (wrb) t1  <-- 40
       0     3229        M 0x80000950 slli    s5, a4, 3              #; a4  = 6, (wrb) s5  <-- 48
       0     3230        M 0x80000954 mul     a0, s5, t2             #; s5  = 48, t2  = 4
       0     3233        M                                           #; (acc) t6  <-- 0x00a30fb3
       0     3234        M 0x80000958 add     t6, t1, a0             #; t1  = 40, a0  = 192, (wrb) t6  <-- 232
       0     3235        M 0x8000095c add     t5, t6, a1             #; t6  = 232, a1  = 0x00100000, (wrb) t5  <-- 0x001000e8
       0     3241        M 0x80000960 mul     a7, s2, t0             #; s2  = 56, t0  = 5
       0     3242        M 0x80000964 beqz    a3, pc + 112           #; a3  = 0, taken, goto 0x800009d4
       0     3264        M 0x800009d4 sltu    a0, s3, a1             #; s3  = 0x00100350, a1  = 0x00100000, (wrb) a0  <-- 0
       0     3265        M 0x800009d8 add     t3, a7, t4             #; a7  = 280, t4  = 48, (wrb) t3  <-- 328
       0     3266        M 0x800009dc bgeu    t5, t6, pc - 104       #; t5  = 0x001000e8, t6  = 232, taken, goto 0x80000974
       0     3267        M 0x80000974 sltu    s0, t5, s7             #; t5  = 0x001000e8, s7  = 0x00100240, (wrb) s0  <-- 1
       0     3268        M 0x80000978 add     s4, t3, a2             #; t3  = 328, a2  = 0x001000f0, (wrb) s4  <-- 0x00100238
       0     3269        M 0x8000097c bnez    a3, pc + 112           #; a3  = 0, not taken
       0     3279        M 0x80000980 sltu    s1, s3, a2             #; s3  = 0x00100350, a2  = 0x001000f0, (wrb) s1  <-- 0
       0     3280        M 0x80000984 or      a0, s0, a0             #; s0  = 1, a0  = 0, (wrb) a0  <-- 1
       0     3281        M 0x80000988 bltu    s4, t3, pc + 112       #; s4  = 0x00100238, t3  = 328, not taken
       0     3282        M 0x8000098c sltu    s0, s4, s7             #; s4  = 0x00100238, s7  = 0x00100240, (wrb) s0  <-- 1
       0     3291        M 0x80000990 j       pc + 0x6c              #; goto 0x800009fc
       0     3303        M 0x800009fc or      s0, s1, s0             #; s1  = 0, s0  = 1, (wrb) s0  <-- 1
       0     3315        M 0x80000a00 and     s0, a0, s0             #; a0  = 1, s0  = 1, (wrb) s0  <-- 1
       0     3316        M 0x80000a04 srli    a0, s7, 20             #; s7  = 0x00100240, (wrb) a0  <-- 1
       0     3317        M 0x80000a08 snez    s1, a0                 #; a0  = 1, (wrb) s1  <-- 1
       0     3318        M 0x80000a0c lui     a0, 0x120              #; (wrb) a0  <-- 0x00120000
       0     3327        M 0x80000a10 addi    a0, a0, 1              #; a0  = 0x00120000, (wrb) a0  <-- 0x00120001
       0     3328        M 0x80000a14 beqz    a3, pc + 12            #; a3  = 0, taken, goto 0x80000a20
       0     3339        M 0x80000a20 sltu    a3, s3, a0             #; s3  = 0x00100350, a0  = 0x00120001, (wrb) a3  <-- 1
       0     3340        M 0x80000a24 and     a3, s1, a3             #; s1  = 1, a3  = 1, (wrb) a3  <-- 1
       0     3341        M 0x80000a28 and     a3, a3, s0             #; a3  = 1, s0  = 1, (wrb) a3  <-- 1
       0     3342        M 0x80000a2c srli    s0, a1, 20             #; a1  = 0x00100000, (wrb) s0  <-- 1
       0     3351        M 0x80000a30 snez    s0, s0                 #; s0  = 1, (wrb) s0  <-- 1
       0     3352        M 0x80000a34 bgeu    t5, t6, pc + 12        #; t5  = 0x001000e8, t6  = 232, taken, goto 0x80000a40
       0     3363        M 0x80000a40 sltu    s1, t5, a0             #; t5  = 0x001000e8, a0  = 0x00120001, (wrb) s1  <-- 1
       0     3364        M 0x80000a44 and     s1, s0, s1             #; s0  = 1, s1  = 1, (wrb) s1  <-- 1
       0     3365        M 0x80000a48 and     a3, s1, a3             #; s1  = 1, a3  = 1, (wrb) a3  <-- 1
       0     3366        M 0x80000a4c srli    s1, a2, 20             #; a2  = 0x001000f0, (wrb) s1  <-- 1
       0     3375        M 0x80000a50 snez    s1, s1                 #; s1  = 1, (wrb) s1  <-- 1
       0     3376        M 0x80000a54 bgeu    s4, t3, pc + 12        #; s4  = 0x00100238, t3  = 328, taken, goto 0x80000a60
       0     3387        M 0x80000a60 sltu    a0, s4, a0             #; s4  = 0x00100238, a0  = 0x00120001, (wrb) a0  <-- 1
       0     3388        M 0x80000a64 and     a0, s1, a0             #; s1  = 1, a0  = 1, (wrb) a0  <-- 1
       0     3389        M 0x80000a68 and     a0, a0, a3             #; a0  = 1, a3  = 1, (wrb) a0  <-- 1
       ...
       0     3414        M 0x80000a8c scfgw   t2, s1                 #; t2  = 4, s1  = 96
       ...
       0     3438        M 0x80000aac scfgw   t0, s0                 #; t0  = 5, s0  = 65, (acc) ra  <-- 0x0082a0ab
       ...
       0     3472        M 0x80000ad4 scfgw   t2, a3                 #; t2  = 4, a3  = 129
       ...
       0     3496        M 0x80000af4 scfgw   t0, a3                 #; t0  = 5, a3  = 66
       0     3497        M 0x80000af8 scfgw   s2, s1                 #; s2  = 56, s1  = 194
       0     3498        M 0x80000afc sub     a3, t4, a7             #; t4  = 8, a7  = 280, (wrb) a3  <-- -272
       ...
       0     4916        M 0x8000092c addi    t2, s6, -1             #; s6  = 5, (wrb) t2  <-- 4
       0     4917        M 0x80000930 slli    s2, a5, 3              #; a5  = 7, (wrb) s2  <-- 56
       0     4918        M 0x80000934 mul     a0, s2, t2             #; s2  = 56, t2  = 4
       0     4921        M                                           #; (acc) a0  <-- 0x00ae8533
       0     4922        M 0x80000938 add     a0, t4, a0             #; t4  = 48, a0  = 224, (wrb) a0  <-- 272
       0     4923        M 0x8000093c add     s3, a0, s7             #; a0  = 272, s7  = 0x00100240, (wrb) s3  <-- 0x00100350
       0     4924        M 0x80000940 sltu    a3, s3, a0             #; s3  = 0x00100350, a0  = 272, (wrb) a3  <-- 0
       0     4925        M 0x80000944 bge     zero, a4, pc + 80      #; a4  = 0, taken, goto 0x80000994
       0     4929        M 0x80000994 srli    a0, s7, 20             #; s7  = 0x00100240, (wrb) a0  <-- 1
       0     4930        M 0x80000998 snez    a0, a0                 #; a0  = 1, (wrb) a0  <-- 1
       0     4931        M 0x8000099c beqz    a3, pc + 572           #; a3  = 0, taken, goto 0x80000bd8
       0     4952        M 0x80000bd8 lui     a1, 0x120              #; (wrb) a1  <-- 0x00120000
       0     4953        M 0x80000bdc addi    a1, a1, 1              #; a1  = 0x00120000, (wrb) a1  <-- 0x00120001
       0     4964        M 0x80000be0 sltu    a1, s3, a1             #; s3  = 0x00100350, a1  = 0x00120001, (wrb) a1  <-- 1
       0     4965        M 0x80000be4 and     a0, a0, a1             #; a0  = 1, a1  = 1, (wrb) a0  <-- 1
       ...
       0     4994        M 0x80000c0c scfgw   t2, a2                 #; t2  = 4, a2  = 96, (acc) ra  <-- 0x00c3a0ab
