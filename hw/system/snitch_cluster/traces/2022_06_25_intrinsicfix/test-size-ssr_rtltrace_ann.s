...
;  in main (test_size.c:40)
      0x800006cc auipc   a0, 0x3                #; (wrb) a0  <-- 0x800036cc
      0x800006d0 addi    a0, a0, -1332          #; a0  = 0x800036cc, (wrb) a0  <-- 0x80003198
      0x800006d8 auipc   a0, 0x3                #; (wrb) a0  <-- 0x800036d8
      0x800006dc addi    a0, a0, -1336          #; a0  = 0x800036d8, (wrb) a0  <-- 0x800031a0
      0x800006d4 fld     ft3, 0(a0)             #; ft3  <~~ Doub[0x80003198]
                                                #; (f:lsu) ft3  <-- 0.001
      0x800006e0 fld     ft4, 0(a0)             #; ft4  <~~ Doub[0x800031a0]
; init_data (test_size.c:6)
;  in main (test_size.c:40)
