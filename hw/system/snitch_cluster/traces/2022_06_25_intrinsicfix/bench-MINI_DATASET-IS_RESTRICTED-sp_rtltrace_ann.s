...
;  in main (bench_sp.c:40)
      0x8000072c csrr    a2, mcycle             #; mcycle = 4916, (wrb) a2  <-- 4916
; benchmark_get_cycle (benchmark.c:0)
;  in main (bench_sp.c:40)
      0x80000734 li      a4, 800                #; (wrb) a4  <-- 800
      0x80000730 fcvt.d.w fs0, zero             #; ac1  = 0
; scalarprod_restricted (scalarprod.c:15)
;  in main (bench_sp.c:43)
...
; scalarprod_restricted (scalarprod.c:14)
;  in main (bench_sp.c:43)
...
; main (bench_sp.c:50)
      0x80000758 sub     a1, a0, a2             #; a0  = 5645, a2  = 4916, (wrb) a1  <-- 729
      0x8000075c auipc   a0, 0x2                #; (wrb) a0  <-- 0x8000275c
                                                #; (f:fpu) fs0  <-- 2850.0
      0x80000760 addi    a0, a0, 933            #; a0  = 0x8000275c, (wrb) a0  <-- 0x80002b01
...
; printf_ (printf.c:863)
      ...
      0x800007c4 mv      t0, a0                 #; a0  = 0x80002b01, (wrb) t0  <-- 0x80002b01
      ...
      0x800007dc sw      a2, 24(sp)             #; sp  = 0x0011ff10, 4916 ~~> Word[0x0011ff28]
      0x800007e0 sw      a1, 20(sp)             #; sp  = 0x0011ff10, 729 ~~> Word[0x0011ff24]
...
; printf_ (printf.c:867)
      ...
      0x80000800 mv      a3, t0                 #; t0  = 0x80002b01, (wrb) a3  <-- 0x80002b01
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:578)
      ...
      0x80000854 mv      s0, a3                 #; a3  = 0x80002b01, (wrb) s0  <-- 0x80002b01
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x8000089c addi    s10, s0, 2             #; s0  = 0x80002b01, (wrb) s10 <-- 0x80002b03
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x800008a0 mv      s9, s8                 #; s8  = 0, (wrb) s9  <-- 0
      0x800008a4 li      s8, 10                 #; (wrb) s8  <-- 10
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x800008a8 lbu     a0, 0(s0)              #; s0  = 0x80002b01, a0  <~~ Byte[0x80002b01]
                                                #; (lsu) a0  <-- 99
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:593)
      0x800008c8 addi    s0, s0, 1              #; s0  = 0x80002b01, (wrb) s0  <-- 0x80002b02
; _vsnprintf.llvm.1805434900161566649 (printf.c:594)
      0x800008cc addi    s10, s10, 1            #; s10 = 0x80002b03, (wrb) s10 <-- 0x80002b04
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x800008d0 mv      s9, s1                 #; s1  = 1, (wrb) s9  <-- 1
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x800008d4 lbu     a0, 0(s0)              #; s0  = 0x80002b02, a0  <~~ Byte[0x80002b02]
                                                #; (lsu) a0  <-- 121
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:604)
      0x800008f4 lbu     a0, -1(s10)            #; s10 = 0x80002b0c, a0  <~~ Byte[0x80002b0b]
                                                #; (lsu) a0  <-- 108
      0x800008f8 addi    a1, a0, -32            #; a0  = 108, (wrb) a1  <-- 76
      0x800008fc bltu    s11, a1, pc + 56       #; s11 = 16, a1  = 76, taken, goto 0x80000934
; _is_digit (printf.c:183)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:616)
      0x80000934 addi    a1, a0, -48            #; a0  = 108, (wrb) a1  <-- 60
      0x80000938 andi    a2, a1, 255            #; a1  = 60, (wrb) a2  <-- 60
; _vsnprintf.llvm.1805434900161566649 (printf.c:616)
      ...
      0x80000944 bltu    a3, a2, pc + 124       #; a3  = 9, a2  = 60, taken, goto 0x800009c0
; _vsnprintf.llvm.1805434900161566649 (printf.c:619)
      0x800009c0 li      a2, 42                 #; (wrb) a2  <-- 42
      0x800009c4 bne     a0, a2, pc + 80        #; a0  = 108, a2  = 42, taken, goto 0x80000a14
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:633)
      0x80000a1c beq     a0, s7, pc - 164       #; a0  = 108, s7  = 46, not taken
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000a20 li      s7, 0                  #; (wrb) s7  <-- 0
      0x80000a24 j       pc + 0xc               #; goto 0x80000a30
; _vsnprintf.llvm.1805434900161566649 (printf.c:647)
      0x80000a30 addi    a1, a0, -104           #; a0  = 108, (wrb) a1  <-- 4
      0x80000a34 srli    a2, a1, 1              #; a1  = 4, (wrb) a2  <-- 2
      0x80000a38 slli    a1, a1, 31             #; a1  = 4, (wrb) a1  <-- 0
      0x80000a3c or      a1, a1, a2             #; a1  = 0, a2  = 2, (wrb) a1  <-- 2
      0x80000a40 li      a2, 9                  #; (wrb) a2  <-- 9
      0x80000a44 bltu    a2, a1, pc + 100       #; a2  = 9, a1  = 2, not taken
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000a48 slli    a1, a1, 2              #; a1  = 2, (wrb) a1  <-- 8
      0x80000a4c auipc   a2, 0x2                #; (wrb) a2  <-- 0x80002a4c
      0x80000a50 addi    a2, a2, 268            #; a2  = 0x80002a4c, (wrb) a2  <-- 0x80002b58
      0x80000a54 add     a1, a1, a2             #; a1  = 8, a2  = 0x80002b58, (wrb) a1  <-- 0x80002b60
      0x80000a58 lw      a3, 0(a1)              #; a1  = 0x80002b60, a3  <~~ Word[0x80002b60]
      0x80000a5c li      a1, 1                  #; (wrb) a1  <-- 1
      0x80000a60 li      a2, 256                #; (wrb) a2  <-- 256
                                                #; (lsu) a3  <-- 0x80000a88
      0x80000a64 jr      a3                     #; a3  = 0x80000a88, goto 0x80000a88
; _vsnprintf.llvm.1805434900161566649 (printf.c:651)
      0x80000a88 lbu     a0, 1(s10)             #; s10 = 0x80002b0b, a0  <~~ Byte[0x80002b0c]
      0x80000a8c li      a1, 108                #; (wrb) a1  <-- 108
                                                #; (lsu) a0  <-- 117
      0x80000a90 bne     a0, a1, pc + 272       #; a0  = 117, a1  = 108, taken, goto 0x80000ba0
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000ba0 ori     s0, s0, 256            #; s0  = 0, (wrb) s0  <-- 256
      0x80000ba4 addi    s10, s10, 1            #; s10 = 0x80002b0b, (wrb) s10 <-- 0x80002b0c
      0x80000ba8 j       pc - 0x100             #; goto 0x80000aa8
; _vsnprintf.llvm.1805434900161566649 (printf.c:683)
      0x80000aa8 addi    a1, a0, -37            #; a0  = 117, (wrb) a1  <-- 80
      0x80000aac li      a2, 83                 #; (wrb) a2  <-- 83
      0x80000ab0 bltu    a2, a1, pc + 264       #; a2  = 83, a1  = 80, not taken
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000ab4 slli    a1, a1, 2              #; a1  = 80, (wrb) a1  <-- 320
      0x80000ab8 auipc   a2, 0x2                #; (wrb) a2  <-- 0x80002ab8
      0x80000abc addi    a2, a2, 200            #; a2  = 0x80002ab8, (wrb) a2  <-- 0x80002b80
      0x80000ac0 add     a1, a1, a2             #; a1  = 320, a2  = 0x80002b80, (wrb) a1  <-- 0x80002cc0
      0x80000ac4 lw      a2, 0(a1)              #; a1  = 0x80002cc0, a2  <~~ Word[0x80002cc0]
      0x80000ac8 li      a1, 8                  #; (wrb) a1  <-- 8
      0x80000acc li      s8, 16                 #; (wrb) s8  <-- 16
                                                #; (lsu) a2  <-- 0x80000ad4
      0x80000ad0 jr      a2                     #; a2  = 0x80000ad4
; _vsnprintf.llvm.1805434900161566649 (printf.c:704)
      0x80000ad4 andi    s0, s0, -17            #; s0  = 256, (wrb) s0  <-- 256
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000ad8 li      s8, 10                 #; (wrb) s8  <-- 10
; _vsnprintf.llvm.1805434900161566649 (printf.c:707)
      0x80000adc li      a1, 88                 #; (wrb) a1  <-- 88
      0x80000ae0 bne     a0, a1, pc + 8         #; a0  = 117, a1  = 88, taken, goto 0x80000ae8
; _vsnprintf.llvm.1805434900161566649 (printf.c:712)
      0x80000ae8 li      a1, 100                #; (wrb) a1  <-- 100
      0x80000aec beq     a0, a1, pc + 240       #; a0  = 117, a1  = 100, not taken
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000af0 mv      a1, s8                 #; s8  = 10, (wrb) a1  <-- 10
; _vsnprintf.llvm.1805434900161566649 (printf.c:712)
      0x80000af4 li      a2, 105                #; (wrb) a2  <-- 105
      0x80000af8 beq     a0, a2, pc + 228       #; a0  = 117, a2  = 105, not taken
      0x80000afc j       pc + 0xd8              #; goto 0x80000bd4
; _vsnprintf.llvm.1805434900161566649 (printf.c:713)
      0x80000bd4 andi    s0, s0, -13            #; s0  = 256, (wrb) s0  <-- 256
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000bd8 mv      s8, a1                 #; a1  = 10, (wrb) s8  <-- 10
; _vsnprintf.llvm.1805434900161566649 (printf.c:717)
      0x80000bdc andi    a1, s0, 1024           #; s0  = 256, (wrb) a1  <-- 0
      0x80000be0 beqz    a1, pc + 8             #; a1  = 0, taken, goto 0x80000be8
; _vsnprintf.llvm.1805434900161566649 (printf.c:722)
      0x80000be8 li      a1, 105                #; (wrb) a1  <-- 105
      0x80000bec beq     a0, a1, pc + 12        #; a0  = 117, a1  = 105, not taken
      0x80000bf0 li      a1, 100                #; (wrb) a1  <-- 100
      0x80000bf4 bne     a0, a1, pc + 312       #; a0  = 117, a1  = 100, taken, goto 0x80000d2c
; _vsnprintf.llvm.1805434900161566649 (printf.c:741)
      0x80000d2c andi    a0, s0, 512            #; s0  = 256, (wrb) a0  <-- 0
      0x80000d30 bnez    a0, pc + 196           #; a0  = 0, not taken
; _vsnprintf.llvm.1805434900161566649 (printf.c:746)
      0x80000d34 andi    a0, s0, 256            #; s0  = 256, (wrb) a0  <-- 256
      0x80000d38 bnez    a0, pc + 1148          #; a0  = 256, taken, goto 0x800011b4
; _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x800011b4 lw      a0, 0(s3)              #; s3  = 0x0011ff24, a0  <~~ Word[0x0011ff24]
                                                #; (lsu) a0  <-- 729
; _ntoa_long (printf.c:287)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x800011b8 bnez    a0, pc + 8             #; a0  = 729, taken, goto 0x800011c0
; _ntoa_long (printf.c:0)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x800011c0 seqz    a1, a0                 #; a0  = 729, (wrb) a1  <-- 0
; _ntoa_long (printf.c:292)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x800011c4 andi    a2, s0, 1024           #; s0  = 256, (wrb) a2  <-- 0
      0x800011c8 srli    a2, a2, 10             #; a2  = 0, (wrb) a2  <-- 0
      0x800011cc and     a1, a1, a2             #; a1  = 0, a2  = 0, (wrb) a1  <-- 0
; _ntoa_long (printf.c:0)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x800011d0 li      a5, 0                  #; (wrb) a5  <-- 0
; _ntoa_long (printf.c:292)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x800011d4 bnez    a1, pc + 248           #; a1  = 0, not taken
; _ntoa_long (printf.c:0)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x800011d8 li      a2, 0                  #; (wrb) a2  <-- 0
      0x800011dc andi    a1, s0, 32             #; s0  = 256, (wrb) a1  <-- 0
      0x800011e0 xori    a1, a1, 97             #; a1  = 0, (wrb) a1  <-- 97
      0x800011e4 addi    a6, a1, 246            #; a1  = 97, (wrb) a6  <-- 343
      0x800011e8 j       pc + 0x34              #; goto 0x8000121c
; _ntoa_long (printf.c:296)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x8000121c divu    a3, a0, s8             #; a0  = 729, s8  = 10
      0x80001220 mul     a4, a3, s8             #; a3  = 72, s8  = 10
                                                #; (acc) a4  <-- 0x40e50733
      0x80001224 sub     a4, a0, a4             #; a0  = 729, a4  = 720, (wrb) a4  <-- 9
; _ntoa_long (printf.c:295)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x80001228 andi    s1, a4, 254            #; a4  = 9, (wrb) s1  <-- 8
      0x8000122c li      a5, 48                 #; (wrb) a5  <-- 48
      0x80001230 li      a1, 10                 #; (wrb) a1  <-- 10
      0x80001234 bltu    s1, a1, pc - 72        #; s1  = 8, a1  = 10, taken, goto 0x800011ec
      0x800011ec add     a4, a5, a4             #; a5  = 48, a4  = 9, (wrb) a4  <-- 57
      0x800011f0 addi    a5, a2, 1              #; a2  = 0, (wrb) a5  <-- 1
      0x800011f4 addi    a1, sp, 28             #; sp  = 0x0011fea0, (wrb) a1  <-- 0x0011febc
      0x800011f8 add     s1, a1, a2             #; a1  = 0x0011febc, a2  = 0, (wrb) s1  <-- 0x0011febc
; _ntoa_long (printf.c:297)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x800011fc sltu    a0, a0, s8             #; a0  = 729, s8  = 10, (wrb) a0  <-- 0
      0x80001200 xori    a0, a0, 1              #; a0  = 0, (wrb) a0  <-- 1
      0x80001204 sltiu   a2, a2, 31             #; a2  = 0, (wrb) a2  <-- 1
      0x80001208 and     a1, a2, a0             #; a2  = 1, a0  = 1, (wrb) a1  <-- 1
; _ntoa_long (printf.c:295)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x8000120c sb      a4, 0(s1)              #; s1  = 0x0011febc, 57 ~~> Byte[0x0011febc]
; _ntoa_long (printf.c:0)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x80001210 mv      a2, a5                 #; a5  = 1, (wrb) a2  <-- 1
      0x80001214 mv      a0, a3                 #; a3  = 72, (wrb) a0  <-- 72
; _ntoa_long (printf.c:297)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x80001218 beqz    a1, pc + 180           #; a1  = 1, not taken
; _ntoa_long (printf.c:296)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x8000121c divu    a3, a0, s8             #; a0  = 72, s8  = 10
                                                #; (acc) a4  <-- 0x03868733
      0x80001220 mul     a4, a3, s8             #; a3  = 7, s8  = 10
                                                #; (acc) a4  <-- 0x40e50733
      0x80001224 sub     a4, a0, a4             #; a0  = 72, a4  = 70, (wrb) a4  <-- 2
; _ntoa_long (printf.c:295)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x80001228 andi    s1, a4, 254            #; a4  = 2, (wrb) s1  <-- 2
      0x8000122c li      a5, 48                 #; (wrb) a5  <-- 48
      0x80001230 li      a1, 10                 #; (wrb) a1  <-- 10
      0x80001234 bltu    s1, a1, pc - 72        #; s1  = 2, a1  = 10, taken, goto 0x800011ec
      0x800011ec add     a4, a5, a4             #; a5  = 48, a4  = 2, (wrb) a4  <-- 50
      0x800011f0 addi    a5, a2, 1              #; a2  = 1, (wrb) a5  <-- 2
      0x800011f4 addi    a1, sp, 28             #; sp  = 0x0011fea0, (wrb) a1  <-- 0x0011febc
      0x800011f8 add     s1, a1, a2             #; a1  = 0x0011febc, a2  = 1, (wrb) s1  <-- 0x0011febd
; _ntoa_long (printf.c:297)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x800011fc sltu    a0, a0, s8             #; a0  = 72, s8  = 10, (wrb) a0  <-- 0
      0x80001200 xori    a0, a0, 1              #; a0  = 0, (wrb) a0  <-- 1
      0x80001204 sltiu   a2, a2, 31             #; a2  = 1, (wrb) a2  <-- 1
      0x80001208 and     a1, a2, a0             #; a2  = 1, a0  = 1, (wrb) a1  <-- 1
; _ntoa_long (printf.c:295)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x8000120c sb      a4, 0(s1)              #; s1  = 0x0011febd, 50 ~~> Byte[0x0011febd]
; _ntoa_long (printf.c:0)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x80001210 mv      a2, a5                 #; a5  = 2, (wrb) a2  <-- 2
      0x80001214 mv      a0, a3                 #; a3  = 7, (wrb) a0  <-- 7
; _ntoa_long (printf.c:297)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x80001218 beqz    a1, pc + 180           #; a1  = 1, not taken
; _ntoa_long (printf.c:296)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x8000121c divu    a3, a0, s8             #; a0  = 7, s8  = 10
                                                #; (acc) a4  <-- 0x03868733
      0x80001220 mul     a4, a3, s8             #; a3  = 0, s8  = 10
                                                #; (acc) a4  <-- 0x40e50733
      0x80001224 sub     a4, a0, a4             #; a0  = 7, a4  = 0, (wrb) a4  <-- 7
; _ntoa_long (printf.c:295)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x80001228 andi    s1, a4, 254            #; a4  = 7, (wrb) s1  <-- 6
      0x8000122c li      a5, 48                 #; (wrb) a5  <-- 48
      0x80001230 li      a1, 10                 #; (wrb) a1  <-- 10
      0x80001234 bltu    s1, a1, pc - 72        #; s1  = 6, a1  = 10, taken, goto 0x800011ec
      0x800011ec add     a4, a5, a4             #; a5  = 48, a4  = 7, (wrb) a4  <-- 55
      0x800011f0 addi    a5, a2, 1              #; a2  = 2, (wrb) a5  <-- 3
      0x800011f4 addi    a1, sp, 28             #; sp  = 0x0011fea0, (wrb) a1  <-- 0x0011febc
      0x800011f8 add     s1, a1, a2             #; a1  = 0x0011febc, a2  = 2, (wrb) s1  <-- 0x0011febe
; _ntoa_long (printf.c:297)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x800011fc sltu    a0, a0, s8             #; a0  = 7, s8  = 10, (wrb) a0  <-- 1
      0x80001200 xori    a0, a0, 1              #; a0  = 1, (wrb) a0  <-- 0
      0x80001204 sltiu   a2, a2, 31             #; a2  = 2, (wrb) a2  <-- 1
      0x80001208 and     a1, a2, a0             #; a2  = 1, a0  = 0, (wrb) a1  <-- 0
; _ntoa_long (printf.c:295)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x8000120c sb      a4, 0(s1)              #; s1  = 0x0011febe, 55 ~~> Byte[0x0011febe]
; _ntoa_long (printf.c:0)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x80001210 mv      a2, a5                 #; a5  = 3, (wrb) a2  <-- 3
      0x80001214 mv      a0, a3                 #; a3  = 0, (wrb) a0  <-- 0
; _ntoa_long (printf.c:297)
;  in _vsnprintf.llvm.1805434900161566649 (printf.c:747)
      0x80001218 beqz    a1, pc + 180           #; a1  = 0, taken, goto 0x800012cc
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x800012cc addi    s3, s3, 4              #; s3  = 0x0011ff24, (wrb) s3  <-- 0x0011ff28
      0x800012d0 addi    a4, sp, 28             #; sp  = 0x0011fea0, (wrb) a4  <-- 0x0011febc
      0x800012d4 mv      a0, s2                 #; s2  = 0x80001410, (wrb) a0  <-- 0x80001410
      0x800012d8 mv      a1, s4                 #; s4  = 0x0011ff17, (wrb) a1  <-- 0x0011ff17
      0x800012dc mv      a2, s9                 #; s9  = 9, (wrb) a2  <-- 9
      0x800012e0 mv      a3, s5                 #; s5  = -1, (wrb) a3  <-- -1
      0x800012e4 li      a6, 0                  #; (wrb) a6  <-- 0
      0x800012e8 mv      a7, s8                 #; s8  = 10, (wrb) a7  <-- 10
      0x800012ec mv      t2, s7                 #; s7  = 0, (wrb) t2  <-- 0
      0x800012f0 mv      t3, s6                 #; s6  = 0, (wrb) t3  <-- 0
      0x800012f4 mv      t4, s0                 #; s0  = 256, (wrb) t4  <-- 256
      0x800012f8 auipc   ra, 0x1                #; (wrb) ra  <-- 0x800022f8
      0x800012fc jalr    ra, ra, -620           #; ra  = 0x800022f8, (wrb) ra  <-- 0x80001300, goto 0x8000208c
; _ntoa_format (printf.c:228)
      0x8000208c addi    sp, sp, -64            #; sp  = 0x0011fea0, (wrb) sp  <-- 0x0011fe60
      0x80002090 sw      ra, 60(sp)             #; sp  = 0x0011fe60, 0x80001300 ~~> Word[0x0011fe9c]
      0x80002094 sw      s0, 56(sp)             #; sp  = 0x0011fe60, 256 ~~> Word[0x0011fe98]
      0x80002098 sw      s1, 52(sp)             #; sp  = 0x0011fe60, 0x0011febe ~~> Word[0x0011fe94]
      0x8000209c sw      s2, 48(sp)             #; sp  = 0x0011fe60, 0x80001410 ~~> Word[0x0011fe90]
      0x800020a0 sw      s3, 44(sp)             #; sp  = 0x0011fe60, 0x0011ff28 ~~> Word[0x0011fe8c]
      0x800020a4 sw      s4, 40(sp)             #; sp  = 0x0011fe60, 0x0011ff17 ~~> Word[0x0011fe88]
      0x800020a8 sw      s5, 36(sp)             #; sp  = 0x0011fe60, -1 ~~> Word[0x0011fe84]
      0x800020ac sw      s6, 32(sp)             #; sp  = 0x0011fe60, 0 ~~> Word[0x0011fe80]
      0x800020b0 sw      s7, 28(sp)             #; sp  = 0x0011fe60, 0 ~~> Word[0x0011fe7c]
      0x800020b4 sw      s8, 24(sp)             #; sp  = 0x0011fe60, 10 ~~> Word[0x0011fe78]
      0x800020b8 sw      s9, 20(sp)             #; sp  = 0x0011fe60, 9 ~~> Word[0x0011fe74]
      0x800020bc sw      s10, 16(sp)            #; sp  = 0x0011fe60, 0x80002b0c ~~> Word[0x0011fe70]
      0x800020c0 sw      s11, 12(sp)            #; sp  = 0x0011fe60, 16 ~~> Word[0x0011fe6c]
      0x800020c4 mv      s7, t4                 #; t4  = 256, (wrb) s7  <-- 256
; _ntoa_format (printf.c:230)
      0x800020c8 andi    s5, t4, 2              #; t4  = 256, (wrb) s5  <-- 0
      0x800020cc mv      s2, t3                 #; t3  = 0, (wrb) s2  <-- 0
; _ntoa_format (printf.c:0)
      0x800020d0 mv      s10, t2                #; t2  = 0, (wrb) s10 <-- 0
      0x800020d4 mv      s9, a7                 #; a7  = 10, (wrb) s9  <-- 10
      0x800020d8 mv      s8, a5                 #; a5  = 3, (wrb) s8  <-- 3
      0x800020dc mv      s3, a3                 #; a3  = -1, (wrb) s3  <-- -1
      0x800020e0 mv      s4, a2                 #; a2  = 9, (wrb) s4  <-- 9
      0x800020e4 mv      s6, a1                 #; a1  = 0x0011ff17, (wrb) s6  <-- 0x0011ff17
      0x800020e8 mv      s11, a0                #; a0  = 0x80001410, (wrb) s11 <-- 0x80001410
      0x800020ec sw      a4, 8(sp)              #; sp  = 0x0011fe60, 0x0011febc ~~> Word[0x0011fe68]
; _ntoa_format (printf.c:230)
      0x800020f0 bnez    s5, pc + 220           #; s5  = 0, not taken
; _ntoa_format (printf.c:0)
      0x800020f4 andi    s0, s7, 1              #; s7  = 256, (wrb) s0  <-- 0
; _ntoa_format (printf.c:231)
      0x800020f8 beqz    s2, pc + 28            #; s2  = 0, taken, goto 0x80002114
; _ntoa_format (printf.c:0)
      0x80002114 li      s2, 0                  #; (wrb) s2  <-- 0
; _ntoa_format (printf.c:234)
      0x80002118 sltu    a0, s8, s10            #; s8  = 3, s10 = 0, (wrb) a0  <-- 0
      0x8000211c xori    a1, a0, 1              #; a0  = 0, (wrb) a1  <-- 1
      0x80002120 li      a0, 31                 #; (wrb) a0  <-- 31
      0x80002124 sltu    a2, a0, s8             #; a0  = 31, s8  = 3, (wrb) a2  <-- 0
      0x80002128 or      a1, a2, a1             #; a2  = 0, a1  = 1, (wrb) a1  <-- 1
      0x8000212c bnez    a1, pc + 72            #; a1  = 1, taken, goto 0x80002174
; _ntoa_format (printf.c:237)
      0x80002174 beqz    s0, pc + 88            #; s0  = 0, taken, goto 0x800021cc
; _ntoa_format (printf.c:243)
      0x800021cc andi    a0, s7, 16             #; s7  = 256, (wrb) a0  <-- 0
      0x800021d0 beqz    a0, pc + 228           #; a0  = 0, taken, goto 0x800022b4
; _ntoa_format (printf.c:0)
      0x800022b4 li      a0, 31                 #; (wrb) a0  <-- 31
; _ntoa_format (printf.c:264)
      0x800022b8 bltu    a0, s8, pc + 72        #; a0  = 31, s8  = 3, not taken
; _ntoa_format (printf.c:265)
      0x800022bc beqz    a6, pc + 20            #; a6  = 0, taken, goto 0x800022d0
; _ntoa_format (printf.c:268)
      0x800022d0 andi    a0, s7, 4              #; s7  = 256, (wrb) a0  <-- 0
      0x800022d4 bnez    a0, pc + 28            #; a0  = 0, not taken
; _ntoa_format (printf.c:271)
      0x800022d8 andi    a0, s7, 8              #; s7  = 256, (wrb) a0  <-- 0
      0x800022dc beqz    a0, pc + 36            #; a0  = 0, taken, goto 0x80002300
; _out_rev (printf.c:204)
;  in _ntoa_format (printf.c:276)
      0x80002300 andi    a0, s7, 3              #; s7  = 256, (wrb) a0  <-- 0
      0x80002304 snez    a0, a0                 #; a0  = 0, (wrb) a0  <-- 0
      0x80002308 sltu    a1, s8, s2             #; s8  = 3, s2  = 0, (wrb) a1  <-- 0
      0x8000230c xori    a1, a1, 1              #; a1  = 0, (wrb) a1  <-- 1
      0x80002310 or      a0, a0, a1             #; a0  = 0, a1  = 1, (wrb) a0  <-- 1
      0x80002314 mv      s0, s4                 #; s4  = 9, (wrb) s0  <-- 9
      0x80002318 bnez    a0, pc + 44            #; a0  = 1, taken, goto 0x80002344
; _out_rev (printf.c:0)
;  in _ntoa_format (printf.c:276)
      0x80002344 snez    s5, s5                 #; s5  = 0, (wrb) s5  <-- 0
; _out_rev (printf.c:211)
;  in _ntoa_format (printf.c:276)
      0x80002348 beqz    s8, pc + 60            #; s8  = 3, not taken
      0x8000234c lw      a0, 8(sp)              #; sp  = 0x0011fe60, a0  <~~ Word[0x0011fe68]
                                                #; (lsu) a0  <-- 0x0011febc
      0x80002350 addi    s7, a0, -1             #; a0  = 0x0011febc, (wrb) s7  <-- 0x0011febb
; _out_rev (printf.c:212)
;  in _ntoa_format (printf.c:276)
      0x80002354 add     a0, s7, s8             #; s7  = 0x0011febb, s8  = 3, (wrb) a0  <-- 0x0011febe
      0x80002358 lbu     a0, 0(a0)              #; a0  = 0x0011febe, a0  <~~ Byte[0x0011febe]
      0x8000235c addi    s9, s8, -1             #; s8  = 3, (wrb) s9  <-- 2
                                                #; (lsu) a0  <-- 55
      0x80002360 addi    s1, s0, 1              #; s0  = 9, (wrb) s1  <-- 10
      0x80002364 mv      a1, s6                 #; s6  = 0x0011ff17, (wrb) a1  <-- 0x0011ff17
      0x80002368 mv      a2, s0                 #; s0  = 9, (wrb) a2  <-- 9
      0x8000236c mv      a3, s3                 #; s3  = -1, (wrb) a3  <-- -1
      0x80002370 jalr    s11                    #; s11 = 0x80001410, (wrb) ra  <-- 0x80002374, goto 0x80001410
; _out_char.llvm.1805434900161566649 (printf.c:152)
      0x80001410 beqz    a0, pc + 168           #; a0  = 55, not taken
; snrt_hartid (snrt.h:181)
;  in snrt_putchar (putchar.c:22)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x80001414 csrr    a1, mhartid            #; mhartid = 0, (wrb) a1  <-- 0
...
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      ...
      0x8000143c sb      a0, 72(a4)             #; a4  = 0x80002e5d, 55 ~~> Byte[0x80002ea5]
; snrt_putchar (putchar.c:24)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x80001440 lw      a4, 0(a1)              #; a1  = 0x80002e54, a4  <~~ Word[0x80002e54]
                                                #; (lsu) a4  <-- 10
      ...
      0x8000144c addi    a0, a0, -10            #; a0  = 55, (wrb) a0  <-- 45
      0x80001450 snez    a0, a0                 #; a0  = 45, (wrb) a0  <-- 1
      0x80001454 and     a0, a0, a4             #; a0  = 1, a4  = 1, (wrb) a0  <-- 1
      0x80001458 bnez    a0, pc + 96            #; a0  = 1, taken, goto 0x800014b8
; _out_char.llvm.1805434900161566649 (printf.c:155)
      0x800014b8 ret                            #; ra  = 0x80002374, goto 0x80002374
; _out_rev (printf.c:0)
;  in _ntoa_format (printf.c:276)
      0x80002374 mv      s0, s1                 #; s1  = 10, (wrb) s0  <-- 10
      0x80002378 mv      s8, s9                 #; s9  = 2, (wrb) s8  <-- 2
; _out_rev (printf.c:211)
;  in _ntoa_format (printf.c:276)
      0x8000237c bnez    s9, pc - 40            #; s9  = 2, taken, goto 0x80002354
; _out_rev (printf.c:212)
;  in _ntoa_format (printf.c:276)
      0x80002354 add     a0, s7, s8             #; s7  = 0x0011febb, s8  = 2, (wrb) a0  <-- 0x0011febd
      0x80002358 lbu     a0, 0(a0)              #; a0  = 0x0011febd, a0  <~~ Byte[0x0011febd]
      0x8000235c addi    s9, s8, -1             #; s8  = 2, (wrb) s9  <-- 1
      0x80002360 addi    s1, s0, 1              #; s0  = 10, (wrb) s1  <-- 11
      0x80002364 mv      a1, s6                 #; s6  = 0x0011ff17, (wrb) a1  <-- 0x0011ff17
      0x80002368 mv      a2, s0                 #; s0  = 10, (wrb) a2  <-- 10
      0x8000236c mv      a3, s3                 #; s3  = -1, (wrb) a3  <-- -1
      0x80002370 jalr    s11                    #; s11 = 0x80001410, (wrb) ra  <-- 0x80002374, goto 0x80001410
                                                #; (lsu) a0  <-- 50
; _out_char.llvm.1805434900161566649 (printf.c:152)
      0x80001410 beqz    a0, pc + 168           #; a0  = 50, not taken
; snrt_hartid (snrt.h:181)
;  in snrt_putchar (putchar.c:22)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x80001414 csrr    a1, mhartid            #; mhartid = 0, (wrb) a1  <-- 0
...
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      ...
      0x8000143c sb      a0, 72(a4)             #; a4  = 0x80002e5e, 50 ~~> Byte[0x80002ea6]
; snrt_putchar (putchar.c:24)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x80001440 lw      a4, 0(a1)              #; a1  = 0x80002e54, a4  <~~ Word[0x80002e54]
                                                #; (lsu) a4  <-- 11
      ...
      0x8000144c addi    a0, a0, -10            #; a0  = 50, (wrb) a0  <-- 40
      0x80001450 snez    a0, a0                 #; a0  = 40, (wrb) a0  <-- 1
      0x80001454 and     a0, a0, a4             #; a0  = 1, a4  = 1, (wrb) a0  <-- 1
      0x80001458 bnez    a0, pc + 96            #; a0  = 1, taken, goto 0x800014b8
; _out_char.llvm.1805434900161566649 (printf.c:155)
      0x800014b8 ret                            #; ra  = 0x80002374, goto 0x80002374
; _out_rev (printf.c:0)
;  in _ntoa_format (printf.c:276)
      0x80002374 mv      s0, s1                 #; s1  = 11, (wrb) s0  <-- 11
      0x80002378 mv      s8, s9                 #; s9  = 1, (wrb) s8  <-- 1
; _out_rev (printf.c:211)
;  in _ntoa_format (printf.c:276)
      0x8000237c bnez    s9, pc - 40            #; s9  = 1, taken, goto 0x80002354
; _out_rev (printf.c:212)
;  in _ntoa_format (printf.c:276)
      0x80002354 add     a0, s7, s8             #; s7  = 0x0011febb, s8  = 1, (wrb) a0  <-- 0x0011febc
      0x80002358 lbu     a0, 0(a0)              #; a0  = 0x0011febc, a0  <~~ Byte[0x0011febc]
      0x8000235c addi    s9, s8, -1             #; s8  = 1, (wrb) s9  <-- 0
      0x80002360 addi    s1, s0, 1              #; s0  = 11, (wrb) s1  <-- 12
      0x80002364 mv      a1, s6                 #; s6  = 0x0011ff17, (wrb) a1  <-- 0x0011ff17
      0x80002368 mv      a2, s0                 #; s0  = 11, (wrb) a2  <-- 11
      0x8000236c mv      a3, s3                 #; s3  = -1, (wrb) a3  <-- -1
      0x80002370 jalr    s11                    #; s11 = 0x80001410, (wrb) ra  <-- 0x80002374, goto 0x80001410
                                                #; (lsu) a0  <-- 57
; _out_char.llvm.1805434900161566649 (printf.c:152)
      0x80001410 beqz    a0, pc + 168           #; a0  = 57, not taken
; snrt_hartid (snrt.h:181)
;  in snrt_putchar (putchar.c:22)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x80001414 csrr    a1, mhartid            #; mhartid = 0, (wrb) a1  <-- 0
...
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      ...
      0x8000143c sb      a0, 72(a4)             #; a4  = 0x80002e5f, 57 ~~> Byte[0x80002ea7]
; snrt_putchar (putchar.c:24)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x80001440 lw      a4, 0(a1)              #; a1  = 0x80002e54, a4  <~~ Word[0x80002e54]
                                                #; (lsu) a4  <-- 12
      ...
      0x8000144c addi    a0, a0, -10            #; a0  = 57, (wrb) a0  <-- 47
      0x80001450 snez    a0, a0                 #; a0  = 47, (wrb) a0  <-- 1
      0x80001454 and     a0, a0, a4             #; a0  = 1, a4  = 1, (wrb) a0  <-- 1
      0x80001458 bnez    a0, pc + 96            #; a0  = 1, taken, goto 0x800014b8
; _out_char.llvm.1805434900161566649 (printf.c:155)
      0x800014b8 ret                            #; ra  = 0x80002374, goto 0x80002374
; _out_rev (printf.c:0)
;  in _ntoa_format (printf.c:276)
      0x80002374 mv      s0, s1                 #; s1  = 12, (wrb) s0  <-- 12
      0x80002378 mv      s8, s9                 #; s9  = 0, (wrb) s8  <-- 0
; _out_rev (printf.c:211)
;  in _ntoa_format (printf.c:276)
      0x8000237c bnez    s9, pc - 40            #; s9  = 0, not taken
      0x80002380 j       pc + 0x8               #; goto 0x80002388
; _out_rev (printf.c:0)
;  in _ntoa_format (printf.c:276)
      0x80002388 sub     a0, s1, s4             #; s1  = 12, s4  = 9, (wrb) a0  <-- 3
      0x8000238c sltu    a0, a0, s2             #; a0  = 3, s2  = 0, (wrb) a0  <-- 0
      0x80002390 xori    a0, a0, 1              #; a0  = 0, (wrb) a0  <-- 1
; _out_rev (printf.c:216)
;  in _ntoa_format (printf.c:276)
      0x80002394 xori    a1, s5, 1              #; s5  = 0, (wrb) a1  <-- 1
      0x80002398 or      a0, a1, a0             #; a1  = 1, a0  = 1, (wrb) a0  <-- 1
      0x8000239c bnez    a0, pc + 48            #; a0  = 1, taken, goto 0x800023cc
; _ntoa_format (printf.c:0)
      0x800023cc mv      s0, s1                 #; s1  = 12, (wrb) s0  <-- 12
; _ntoa_format (printf.c:276)
      0x800023d0 mv      a0, s0                 #; s0  = 12, (wrb) a0  <-- 12
      0x800023d4 lw      s11, 12(sp)            #; sp  = 0x0011fe60, s11 <~~ Word[0x0011fe6c]
                                                #; (lsu) s11 <-- 16
      0x800023d8 lw      s10, 16(sp)            #; sp  = 0x0011fe60, s10 <~~ Word[0x0011fe70]
                                                #; (lsu) s10 <-- 0x80002b0c
      0x800023dc lw      s9, 20(sp)             #; sp  = 0x0011fe60, s9  <~~ Word[0x0011fe74]
                                                #; (lsu) s9  <-- 9
      0x800023e0 lw      s8, 24(sp)             #; sp  = 0x0011fe60, s8  <~~ Word[0x0011fe78]
                                                #; (lsu) s8  <-- 10
      0x800023e4 lw      s7, 28(sp)             #; sp  = 0x0011fe60, s7  <~~ Word[0x0011fe7c]
                                                #; (lsu) s7  <-- 0
      0x800023e8 lw      s6, 32(sp)             #; sp  = 0x0011fe60, s6  <~~ Word[0x0011fe80]
                                                #; (lsu) s6  <-- 0
      0x800023ec lw      s5, 36(sp)             #; sp  = 0x0011fe60, s5  <~~ Word[0x0011fe84]
                                                #; (lsu) s5  <-- -1
      0x800023f0 lw      s4, 40(sp)             #; sp  = 0x0011fe60, s4  <~~ Word[0x0011fe88]
                                                #; (lsu) s4  <-- 0x0011ff17
      0x800023f4 lw      s3, 44(sp)             #; sp  = 0x0011fe60, s3  <~~ Word[0x0011fe8c]
                                                #; (lsu) s3  <-- 0x0011ff28
      0x800023f8 lw      s2, 48(sp)             #; sp  = 0x0011fe60, s2  <~~ Word[0x0011fe90]
                                                #; (lsu) s2  <-- 0x80001410
      0x800023fc lw      s1, 52(sp)             #; sp  = 0x0011fe60, s1  <~~ Word[0x0011fe94]
                                                #; (lsu) s1  <-- 0x0011febe
      0x80002400 lw      s0, 56(sp)             #; sp  = 0x0011fe60, s0  <~~ Word[0x0011fe98]
                                                #; (lsu) s0  <-- 256
      0x80002404 lw      ra, 60(sp)             #; sp  = 0x0011fe60, ra  <~~ Word[0x0011fe9c]
      0x80002408 addi    sp, sp, 64             #; sp  = 0x0011fe60, (wrb) sp  <-- 0x0011fea0
                                                #; (lsu) ra  <-- 0x80001300
      0x8000240c ret                            #; ra  = 0x80001300, goto 0x80001300
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80001300 mv      s8, a0                 #; a0  = 12, (wrb) s8  <-- 12
      0x80001304 li      s6, 37                 #; (wrb) s6  <-- 37
      0x80001308 li      s7, 46                 #; (wrb) s7  <-- 46
      0x8000130c addi    s0, s10, 1             #; s10 = 0x80002b0c, (wrb) s0  <-- 0x80002b0d
      0x80001310 j       pc - 0xa74             #; goto 0x8000089c
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x8000089c addi    s10, s0, 2             #; s0  = 0x80002b0d, (wrb) s10 <-- 0x80002b0f
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x800008a0 mv      s9, s8                 #; s8  = 12, (wrb) s9  <-- 12
      0x800008a4 li      s8, 10                 #; (wrb) s8  <-- 10
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x800008a8 lbu     a0, 0(s0)              #; s0  = 0x80002b0d, a0  <~~ Byte[0x80002b0d]
                                                #; (lsu) a0  <-- 10
      0x800008ac beqz    a0, pc + 2824          #; a0  = 10, not taken
      0x800008b0 beq     a0, s6, pc + 48        #; a0  = 10, s6  = 37, not taken
; _vsnprintf.llvm.1805434900161566649 (printf.c:592)
      0x800008b4 addi    s1, s9, 1              #; s9  = 12, (wrb) s1  <-- 13
      0x800008b8 mv      a1, s4                 #; s4  = 0x0011ff17, (wrb) a1  <-- 0x0011ff17
      0x800008bc mv      a2, s9                 #; s9  = 12, (wrb) a2  <-- 12
      0x800008c0 mv      a3, s5                 #; s5  = -1, (wrb) a3  <-- -1
      0x800008c4 jalr    s2                     #; s2  = 0x80001410, (wrb) ra  <-- 0x800008c8, goto 0x80001410
; _out_char.llvm.1805434900161566649 (printf.c:152)
...
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      ...
      0x8000143c sb      a0, 72(a4)             #; a4  = 0x80002e60, 10 ~~> Byte[0x80002ea8]
; snrt_putchar (putchar.c:24)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x80001440 lw      a4, 0(a1)              #; a1  = 0x80002e54, a4  <~~ Word[0x80002e54]
                                                #; (lsu) a4  <-- 13
...
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x8000148c sw      zero, 36(a0)           #; a0  = 0x80002e54, 0 ~~> Word[0x80002e78]
                                                #; (lsu) a2  <-- 13
      0x80001490 sw      a2, 32(a0)             #; a0  = 0x80002e54, 13 ~~> Word[0x80002e74]
...
; _out_char.llvm.1805434900161566649 (printf.c:155)
      0x800014b8 ret                            #; ra  = 0x800008c8, goto 0x800008c8
; _vsnprintf.llvm.1805434900161566649 (printf.c:593)
      0x800008c8 addi    s0, s0, 1              #; s0  = 0x80002b0d, (wrb) s0  <-- 0x80002b0e
; _vsnprintf.llvm.1805434900161566649 (printf.c:594)
      0x800008cc addi    s10, s10, 1            #; s10 = 0x80002b0f, (wrb) s10 <-- 0x80002b10
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x800008d0 mv      s9, s1                 #; s1  = 13, (wrb) s9  <-- 13
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x800008d4 lbu     a0, 0(s0)              #; s0  = 0x80002b0e, a0  <~~ Byte[0x80002b0e]
                                                #; (lsu) a0  <-- 0
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:853)
      0x800013b4 mv      a2, s9                 #; s9  = 13, (wrb) a2  <-- 13
      0x800013b8 bltu    s9, s5, pc + 8         #; s9  = 13, s5  = -1, taken, goto 0x800013c0
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:856)
      0x800013d0 mv      a0, s9                 #; s9  = 13, (wrb) a0  <-- 13
...
; main (bench_sp.c:57)
      ...
      0x8000077c fsgnjx.d fs0, ft0, ft0         #; ft0  = 0.0, ft0  = 0.0
      0x8000078c auipc   a0, 0x2                #; (wrb) a0  <-- 0x8000278c
                                                #; (f:fpu) fs0  <-- 0.0
      0x80000780 fsd     fs0, 8(sp)             #; 0.0 ~~> Doub[0x0011ff48]
                                                #; (lsu) a3  <-- 0
      0x80000790 addi    a0, a0, 873            #; a0  = 0x8000278c, (wrb) a0  <-- 0x80002af5
...
; printf_ (printf.c:863)
      ...
      0x800007c8 sw      a7, 44(sp)             #; sp  = 0x0011ff10, 10 ~~> Word[0x0011ff3c]
      0x800007cc sw      a6, 40(sp)             #; sp  = 0x0011ff10, 0 ~~> Word[0x0011ff38]
      0x800007d0 sw      a5, 36(sp)             #; sp  = 0x0011ff10, 13 ~~> Word[0x0011ff34]
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x800008e4 j       pc + 0x10              #; goto 0x800008f4
; _vsnprintf.llvm.1805434900161566649 (printf.c:604)
      0x800008f4 lbu     a0, -1(s10)            #; s10 = 0x80002aff, a0  <~~ Byte[0x80002afe]
                                                #; (lsu) a0  <-- 102
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:616)
      0x8000093c addi    a1, s10, -1            #; s10 = 0x80002aff, (wrb) a1  <-- 0x80002afe
      0x80000940 li      a3, 9                  #; (wrb) a3  <-- 9
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000a14 li      s6, 0                  #; (wrb) s6  <-- 0
      0x80000a18 mv      s10, a1                #; a1  = 0x80002afe, (wrb) s10 <-- 0x80002afe
; _vsnprintf.llvm.1805434900161566649 (printf.c:633)
...
; _ftoa (printf.c:340)
      ...
      0x800014f0 sw      s10, 64(sp)            #; sp  = 0x0011fe30, 0x80002afe ~~> Word[0x0011fe70]
      0x800014f4 fsd     fs0, 56(sp)            #; 0.0 ~~> Doub[0x0011fe68]
...
; _ftoa (printf.c:386)
      0x800017f0 fcvt.d.wu ft3, a0              #; ac1  = 0, (f:lsu) ft0  <-- 0.5
                                                #; (f:fpu) ft3  <-- 0.0
      0x800017f4 fsub.d  ft2, ft2, ft3          #; ft2  = 0.0, ft3  = 0.0
                                                #; (f:fpu) ft2  <-- 0.0
; _ftoa (printf.c:388)
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      ...
      0x80001304 li      s6, 37                 #; (wrb) s6  <-- 37
      0x80001308 li      s7, 46                 #; (wrb) s7  <-- 46
      0x8000130c addi    s0, s10, 1             #; s10 = 0x80002afe, (wrb) s0  <-- 0x80002aff
      0x80001310 j       pc - 0xa74             #; goto 0x8000089c
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x8000089c addi    s10, s0, 2             #; s0  = 0x80002aff, (wrb) s10 <-- 0x80002b01
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x800008a0 mv      s9, s8                 #; s8  = 16, (wrb) s9  <-- 16
      0x800008a4 li      s8, 10                 #; (wrb) s8  <-- 10
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x800008a8 lbu     a0, 0(s0)              #; s0  = 0x80002aff, a0  <~~ Byte[0x80002aff]
                                                #; (lsu) a0  <-- 10
      0x800008ac beqz    a0, pc + 2824          #; a0  = 10, not taken
      0x800008b0 beq     a0, s6, pc + 48        #; a0  = 10, s6  = 37, not taken
; _vsnprintf.llvm.1805434900161566649 (printf.c:592)
...
; _out_char.llvm.1805434900161566649 (printf.c:155)
      0x800014b8 ret                            #; ra  = 0x800008c8, goto 0x800008c8
; _vsnprintf.llvm.1805434900161566649 (printf.c:593)
      0x800008c8 addi    s0, s0, 1              #; s0  = 0x80002aff, (wrb) s0  <-- 0x80002b00
; _vsnprintf.llvm.1805434900161566649 (printf.c:594)
      0x800008cc addi    s10, s10, 1            #; s10 = 0x80002b01, (wrb) s10 <-- 0x80002b02
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x800008d0 mv      s9, s1                 #; s1  = 17, (wrb) s9  <-- 17
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x800008d4 lbu     a0, 0(s0)              #; s0  = 0x80002b00, a0  <~~ Byte[0x80002b00]
                                                #; (lsu) a0  <-- 0
      0x800008d8 bnez    a0, pc - 40            #; a0  = 0, not taken
      0x800008dc j       pc + 0xad8             #; goto 0x800013b4
; _vsnprintf.llvm.1805434900161566649 (printf.c:853)
...
; main (bench_sp.c:60)
      ...
      0x800007a8 flt.d   a0, ft0, fs0           #; ft0  = 0.0001, fs0  = 0.0
                                                #; (lsu) ra  <-- 0x80002870
...
; ?? (start.S:195)
      0x8000287c mv      a0, s0                 #; s0  = 0, (wrb) a0  <-- 0
; ?? (start.S:196)
...
; ?? (start_snitch.S:16)
      0x80002ab0 sw      a0, 0(sp)              #; sp  = 0x0011ff58, 0 ~~> Word[0x0011ff58]
; ?? (start_snitch.S:17)
...
; ?? (start_snitch.S:27)
      0x80002acc bnez    a0, pc + 24            #; a0  = 0, not taken
                                                #; (lsu) ra  <-- 0x80002888
; ?? (start_snitch.S:28)
      0x80002ad0 slli    t0, t0, 1              #; t0  = 0, (wrb) t0  <-- 0
; ?? (start_snitch.S:29)
      0x80002ad4 ori     t0, t0, 1              #; t0  = 0, (wrb) t0  <-- 1
; ?? (start_snitch.S:30)
      0x80002ad8 auipc   t1, 0x0                #; (wrb) t1  <-- 0x80002ad8
      0x80002adc addi    t1, t1, 616            #; t1  = 0x80002ad8, (wrb) t1  <-- 0x80002d40
; ?? (start_snitch.S:31)
      0x80002ae0 sw      t0, 0(t1)              #; t1  = 0x80002d40, 1 ~~> Word[0x80002d40]
; ?? (start_snitch.S:32)
