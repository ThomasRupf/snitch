       ...
       0     4889        M 0x80000864 csrr    a2, mcycle             #; mcycle = 4888, (wrb) a2  <-- 4888
                         M 0x80000860 fcvt.d.w fs0, zero             #; ac1  = 0
       ...
       0     5608        M 0x8000088c sub     a1, a0, a2             #; a0  = 5606, a2  = 4888, (wrb) a1  <-- 718
       ...
       0     5651        M 0x8000093c sw      a2, 24(sp)             #; sp  = 0x0011fec0, 4888 ~~> Word[0x0011fed8]
       0     5660        M 0x80000940 sw      a1, 20(sp)             #; sp  = 0x0011fec0, 718 ~~> Word[0x0011fed4]
       ...
       0     7032        M                                           #; (lsu) a0  <-- 718
       0     7033        M 0x80001318 bnez    a0, pc + 8             #; a0  = 718, taken, goto 0x80001320
       0     7041        M 0x80001320 seqz    a1, a0                 #; a0  = 718, (wrb) a1  <-- 0
       ...
       0     7077        M 0x8000137c divu    a3, a0, s8             #; a0  = 718, s8  = 10
       0     7089        M 0x80001380 mul     a4, a3, s8             #; a3  = 71, s8  = 10
       0     7092        M                                           #; (acc) a4  <-- 0x40e50733
       0     7093        M 0x80001384 sub     a4, a0, a4             #; a0  = 718, a4  = 710, (wrb) a4  <-- 8
       0     7094        M 0x80001388 andi    s1, a4, 254            #; a4  = 8, (wrb) s1  <-- 8
       ...
       0     7103        M 0x8000134c add     a4, a5, a4             #; a5  = 48, a4  = 8, (wrb) a4  <-- 56
       ...
       0     7118        M 0x8000135c sltu    a0, a0, s8             #; a0  = 718, s8  = 10, (wrb) a0  <-- 0
       ...
       0     7130        M 0x8000136c sb      a4, 0(s1)              #; s1  = 0x0011fe6c, 56 ~~> Byte[0x0011fe6c]
       ...
       0     7720        M                                           #; (lsu) a0  <-- 56
       0     7722        M 0x80001570 beqz    a0, pc + 168           #; a0  = 56, not taken
       ...
       0     7745        M 0x8000159c sb      a0, 72(a4)             #; a4  = 0x80002f9f, 56 ~~> Byte[0x80002fe7]
       ...
       0     7770        M 0x800015ac addi    a0, a0, -10            #; a0  = 56, (wrb) a0  <-- 46
       0     7771        M 0x800015b0 snez    a0, a0                 #; a0  = 46, (wrb) a0  <-- 1
...
Performance metrics for section 0 @ (12, 4888):
snitch_loads                                    38
snitch_stores                                   50
fpss_stores                                     12
fpss_loads                                       0
snitch_avg_load_latency                    18.2632
snitch_occupancy                            0.3448
snitch_fseq_rel_offloads                    0.2107
fseq_yield                                     1.0
fseq_fpu_yield                                 1.0
fpss_section_latency                             1
fpss_avg_fpu_latency                        1.0023
fpss_avg_load_latency                            0
fpss_occupancy                              0.0920
fpss_fpu_occupancy                          0.0886
fpss_fpu_rel_occupancy                      0.9621
cycles                                        4878
total_ipc                                   0.4369

Performance metrics for section 1 @ (4890, 5606):
fpss_loads                                     200
snitch_loads                                     0
...
fseq_fpu_yield                                 1.0
fpss_section_latency                             1
fpss_avg_fpu_latency                           3.0
fpss_avg_load_latency                          1.0
fpss_occupancy                              0.4178
fpss_fpu_occupancy                          0.1393
fpss_fpu_rel_occupancy                      0.3333
cycles                                         718
total_ipc                                   0.9777
