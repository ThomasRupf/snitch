...
; matmul (matmul.c:6)
      ...
      0x8000092c addi    t3, s6, -1             #; s6  = 5, (wrb) t3  <-- 4
      0x80000930 slli    s2, a5, 3              #; a5  = 7, (wrb) s2  <-- 56
      0x80000934 mul     a0, s2, t3             #; s2  = 56, t3  = 4
                                                #; (acc) a0  <-- 0x00ae8533
      0x80000938 add     a0, t4, a0             #; t4  = 48, a0  = 224, (wrb) a0  <-- 272
      0x8000093c add     t6, a0, s7             #; a0  = 272, s7  = 0x00100240, (wrb) t6  <-- 0x00100350
      0x80000940 sltu    a0, t6, a0             #; t6  = 0x00100350, a0  = 272, (wrb) a0  <-- 0
; matmul (matmul.c:9)
      0x80000944 bge     zero, a4, pc + 80      #; a4  = 6, not taken
; matmul (matmul.c:6)
      0x80000948 addi    a7, a4, -1             #; a4  = 6, (wrb) a7  <-- 5
      0x8000094c slli    t1, a7, 3              #; a7  = 5, (wrb) t1  <-- 40
      0x80000950 slli    s5, a4, 3              #; a4  = 6, (wrb) s5  <-- 48
      0x80000954 mul     s0, s5, t3             #; s5  = 48, t3  = 4
      0x80000958 mul     t0, s2, a7             #; s2  = 56, a7  = 5
                                                #; (acc) t2  <-- 0x01d283b3
                                                #; (acc) t2  <-- 0x01d283b3
      0x8000095c add     t2, t0, t4             #; t0  = 280, t4  = 48, (wrb) t2  <-- 328
      0x80000960 add     t5, t2, a2             #; t2  = 328, a2  = 0x001000f0, (wrb) t5  <-- 0x00100238
      0x80000964 beqz    a0, pc + 112           #; a0  = 0, taken, goto 0x800009d4
; matmul (matmul.c:0)
      0x800009d4 sltu    a3, t6, a2             #; t6  = 0x00100350, a2  = 0x001000f0, (wrb) a3  <-- 0
; matmul (matmul.c:6)
      0x800009d8 add     s3, t1, s0             #; t1  = 40, s0  = 192, (wrb) s3  <-- 232
      0x800009dc bgeu    t5, t2, pc - 104       #; t5  = 0x00100238, t2  = 328, taken, goto 0x80000974
; matmul (matmul.c:0)
      0x80000974 sltu    s0, t5, s7             #; t5  = 0x00100238, s7  = 0x00100240, (wrb) s0  <-- 1
; matmul (matmul.c:6)
      0x80000978 add     s4, s3, a1             #; s3  = 232, a1  = 0x00100000, (wrb) s4  <-- 0x001000e8
      0x8000097c bnez    a0, pc + 112           #; a0  = 0, not taken
; matmul (matmul.c:0)
      0x80000980 sltu    s1, t6, a1             #; t6  = 0x00100350, a1  = 0x00100000, (wrb) s1  <-- 0
; matmul (matmul.c:6)
      0x80000984 or      a3, a3, s0             #; a3  = 0, s0  = 1, (wrb) a3  <-- 1
      0x80000988 bltu    s4, s3, pc + 112       #; s4  = 0x001000e8, s3  = 232, not taken
; matmul (matmul.c:0)
      0x8000098c sltu    s0, s4, s7             #; s4  = 0x001000e8, s7  = 0x00100240, (wrb) s0  <-- 1
      0x80000990 j       pc + 0x6c              #; goto 0x800009fc
; matmul (matmul.c:6)
      0x800009fc or      s0, s0, s1             #; s0  = 1, s1  = 0, (wrb) s0  <-- 1
      0x80000a00 and     s0, a3, s0             #; a3  = 1, s0  = 1, (wrb) s0  <-- 1
      0x80000a04 srli    a3, s7, 20             #; s7  = 0x00100240, (wrb) a3  <-- 1
      0x80000a08 snez    s1, a3                 #; a3  = 1, (wrb) s1  <-- 1
      0x80000a0c lui     a3, 0x120              #; (wrb) a3  <-- 0x00120000
      0x80000a10 addi    a3, a3, 1              #; a3  = 0x00120000, (wrb) a3  <-- 0x00120001
      0x80000a14 beqz    a0, pc + 12            #; a0  = 0, taken, goto 0x80000a20
; matmul (matmul.c:0)
      0x80000a20 sltu    a0, t6, a3             #; t6  = 0x00100350, a3  = 0x00120001, (wrb) a0  <-- 1
; matmul (matmul.c:6)
      0x80000a24 and     a0, s1, a0             #; s1  = 1, a0  = 1, (wrb) a0  <-- 1
      0x80000a28 and     a0, a0, s0             #; a0  = 1, s0  = 1, (wrb) a0  <-- 1
      0x80000a2c srli    s1, a1, 20             #; a1  = 0x00100000, (wrb) s1  <-- 1
      0x80000a30 snez    s1, s1                 #; s1  = 1, (wrb) s1  <-- 1
      0x80000a34 bgeu    s4, s3, pc + 12        #; s4  = 0x001000e8, s3  = 232, taken, goto 0x80000a40
; matmul (matmul.c:0)
      0x80000a40 sltu    s0, s4, a3             #; s4  = 0x001000e8, a3  = 0x00120001, (wrb) s0  <-- 1
; matmul (matmul.c:6)
      0x80000a44 and     s1, s1, s0             #; s1  = 1, s0  = 1, (wrb) s1  <-- 1
      0x80000a48 and     a0, s1, a0             #; s1  = 1, a0  = 1, (wrb) a0  <-- 1
      0x80000a4c srli    s1, a2, 20             #; a2  = 0x001000f0, (wrb) s1  <-- 1
      0x80000a50 snez    s1, s1                 #; s1  = 1, (wrb) s1  <-- 1
      0x80000a54 bgeu    t5, t2, pc + 12        #; t5  = 0x00100238, t2  = 328, taken, goto 0x80000a60
; matmul (matmul.c:0)
      0x80000a60 sltu    a3, t5, a3             #; t5  = 0x00100238, a3  = 0x00120001, (wrb) a3  <-- 1
; matmul (matmul.c:6)
      0x80000a64 and     a3, s1, a3             #; s1  = 1, a3  = 1, (wrb) a3  <-- 1
      0x80000a68 and     a0, a3, a0             #; a3  = 1, a0  = 1, (wrb) a0  <-- 1
...
; matmul (matmul.c:6)
      ...
      0x80000a8c scfgw   t3, s1                 #; t3  = 4, s1  = 96
      ...
      0x80000aac scfgw   a7, s0                 #; a7  = 5, s0  = 65, (acc) ra  <-- 0x0088a0ab
      ...
      0x80000ad4 scfgw   t3, a3                 #; t3  = 4, a3  = 129
      ...
      0x80000af4 scfgw   a7, a3                 #; a7  = 5, a3  = 66
      0x80000af8 scfgw   s2, s1                 #; s2  = 56, s1  = 194
      0x80000afc sub     a3, t4, t0             #; t4  = 8, t0  = 280, (wrb) a3  <-- -272
...
; matmul (matmul.c:6)
      0x80000994 srli    a1, s7, 20             #; s7  = 0x00100240, (wrb) a1  <-- 1
      0x80000998 snez    a1, a1                 #; a1  = 1, (wrb) a1  <-- 1
      0x8000099c beqz    a0, pc + 572           #; a0  = 0, taken, goto 0x80000bd8
; matmul (matmul.c:0)
      0x80000bd8 lui     a0, 0x120              #; (wrb) a0  <-- 0x00120000
      0x80000bdc addi    a0, a0, 1              #; a0  = 0x00120000, (wrb) a0  <-- 0x00120001
      0x80000be0 sltu    a0, t6, a0             #; t6  = 0x00100350, a0  = 0x00120001, (wrb) a0  <-- 1
; matmul (matmul.c:6)
      0x80000be4 and     a0, a1, a0             #; a1  = 1, a0  = 1, (wrb) a0  <-- 1
...
; matmul (matmul.c:6)
      ...
      0x80000c0c scfgw   t3, a2                 #; t3  = 4, a2  = 96, (acc) ra  <-- 0x00ce20ab
