       ...
       0     1599        M 0x80000678 scfgwi  a2, 896                #; a2  = 0x00100000
       0     1600        M 0x8000067c auipc   a3, 0x3                #; (wrb) a3  <-- 0x8000367c
       0     1610        M 0x80000680 addi    a3, a3, -1892          #; a3  = 0x8000367c, (wrb) a3  <-- 0x80002f18
       0     1612        M 0x80000688 auipc   a3, 0x3                #; (wrb) a3  <-- 0x80003688
       0     1613        M 0x8000068c addi    a3, a3, -1896          #; a3  = 0x80003688, (wrb) a3  <-- 0x80002f20
                         M 0x80000684 fld     ft3, 0(a3)             #; ft3  <~~ Doub[0x80002f18]
       0     1622        M                                           #; (f:lsu) ft3  <-- 1.0
       0     1637        M 0x80000690 fld     ft4, 0(a3)             #; ft4  <~~ Doub[0x80002f20]
       0     1638        M 0x80000694 csrrsi  a3, ssr, 1             #; 
       0     1640        M 0x80000698 fsgnj.d ft0, ft3, ft3          #; ft3  = 1.0, ft3  = 1.0
       0     1641        M                                           #; (f:fpu) ft0  <-- 1.0
       0     1646        M                                           #; (f:lsu) ft4  <-- 1.01
       0     1647        M 0x800006a0 auipc   a3, 0x3                #; (wrb) a3  <-- 0x800036a0
                         M 0x8000069c fsgnj.d ft0, ft4, ft4          #; ft4  = 1.01, ft4  = 1.01
       ...
       0     1767        M 0x80000740 scfgwi  a3, 896                #; a3  = 0x00100050
       0     1768        M 0x80000744 auipc   a3, 0x3                #; (wrb) a3  <-- 0x80003744
       0     1769        M 0x80000748 addi    a3, a3, -2012          #; a3  = 0x80003744, (wrb) a3  <-- 0x80002f68
       0     1770        M                                           #; (acc) gp  <-- 0x0006b187
       0     1772        M 0x8000074c fld     ft3, 0(a3)             #; ft3  <~~ Doub[0x80002f68]
       0     1779        M 0x80000750 auipc   a3, 0x3                #; (wrb) a3  <-- 0x80003750
       0     1780        M 0x80000754 addi    a3, a3, -2016          #; a3  = 0x80003750, (wrb) a3  <-- 0x80002f70
       0     1781        M                                           #; (f:lsu) ft3  <-- 10.0
       0     1783        M 0x80000758 fld     ft4, 0(a3)             #; ft4  <~~ Doub[0x80002f70]
       0     1784        M 0x8000075c csrrsi  a3, ssr, 1             #; 
       0     1792        M                                           #; (f:lsu) ft4  <-- 10.01
       ...
       0     2069        M 0x800008d0 fsgnj.d fa1, ft0, ft0          #; ft0  = 64.0, ft0  = 64.0
       0     2070        M 0x800008dc auipc   a0, 0x2                #; (wrb) a0  <-- 0x800028dc
                         M 0x800008d4 fsgnj.d fa2, ft0, ft0          #; ft0  = 128.0, ft0  = 128.0, (f:fpu) fa1  <-- 64.0
       0     2071        M 0x800008d8 fsgnj.d fa3, ft0, ft0          #; ft0  = 256.0, ft0  = 256.0, (f:fpu) fa2  <-- 128.0
       0     2072        M                                           #; (f:fpu) fa3  <-- 256.0
       0     2079        M 0x800008e0 addi    a0, a0, 1820           #; a0  = 0x800028dc, (wrb) a0  <-- 0x80002ff8
       0     2082        M 0x800008e4 fld     fa4, 0(a0)             #; fa4  <~~ Doub[0x80002ff8]
       0     2083        M 0x800008e8 fsgnj.d fa5, ft0, ft0          #; ft0  = 512.0, ft0  = 512.0
       0     2084        M 0x800008ec csrrci  a0, ssr, 1             #; (f:fpu) fa5  <-- 512.0
       0     2091        M                                           #; (f:lsu) fa4  <-- -1023.0
       0     2093        M 0x800008f0 fadd.d  ft3, ft3, fa4          #; ft3  = 1.0, fa4  = -1023.0
       ...
       0     2125        M 0x80000910 fadd.d  ft3, ft3, fa3          #; ft3  = -768.0, fa3  = 256.0
