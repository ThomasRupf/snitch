...
; main (bench_sp.c:50)
      ...
      0x800007f4 addi    a0, a0, 917            #; a0  = 0x800027f0, (wrb) a0  <-- 0x80002b85
...
; _out_char.llvm.1805434900161566649 (printf.c:155)
      0x8000154c ret                            #; ra  = 0x8000095c, goto 0x8000095c
; _vsnprintf.llvm.1805434900161566649 (printf.c:593)
      0x8000095c addi    s0, s0, 1              #; s0  = 0x80002b8d, (wrb) s0  <-- 0x80002b8e
; _vsnprintf.llvm.1805434900161566649 (printf.c:594)
      0x80000960 addi    s10, s10, 1            #; s10 = 0x80002b8f, (wrb) s10 <-- 0x80002b90
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000964 mv      s9, s1                 #; s1  = 9, (wrb) s9  <-- 9
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x80000968 lbu     a0, 0(s0)              #; s0  = 0x80002b8e, a0  <~~ Byte[0x80002b8e]
                                                #; (lsu) a0  <-- 37
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:604)
      0x80000988 lbu     a0, -1(s10)            #; s10 = 0x80002b90, a0  <~~ Byte[0x80002b8f]
                                                #; (lsu) a0  <-- 102
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:616)
      0x800009d0 addi    a1, s10, -1            #; s10 = 0x80002b90, (wrb) a1  <-- 0x80002b8f
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      ...
      0x80000aac mv      s10, a1                #; a1  = 0x80002b8f, (wrb) s10 <-- 0x80002b8f
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:761)
      ...
      0x80000bb8 mv      a2, s9                 #; s9  = 9, (wrb) a2  <-- 9
...
; _ftoa (printf.c:340)
      ...
      0x80001560 sw      s1, 100(sp)            #; sp  = 0x0011fe30, 9 ~~> Word[0x0011fe94]
      ...
      0x80001580 sw      s9, 68(sp)             #; sp  = 0x0011fe30, 9 ~~> Word[0x0011fe74]
      0x80001584 sw      s10, 64(sp)            #; sp  = 0x0011fe30, 0x80002b8f ~~> Word[0x0011fe70]
      0x80001588 fsd     fs0, 56(sp)            #; 285.0 ~~> Doub[0x0011fe68]
...
; _ftoa (printf.c:0)
      ...
      0x800015b0 mv      s4, a2                 #; a2  = 9, (wrb) s4  <-- 9
...
; _ftoa (printf.c:0)
      0x800016ac fsgnj.d fs0, fa0, fa0          #; fa0  = 6.0000000, fa0  = 6.0000000
                                                #; (f:fpu) fs0  <-- 6.0000000
      ...
      0x800016b8 fld     ft0, 0(a0)             #; ft0  <~~ Doub[0x80002e30]
                                                #; (f:lsu) ft0  <-- .0000000
; _ftoa (printf.c:353)
      0x800016bc fle.d   a0, fa0, ft0           #; fa0  = 6.0000000, ft0  = .0000000
                                                #; (acc) t3  <-- 0x00051e63
...
; _ftoa (printf.c:358)
      0x800016f4 fle.d   a0, fs0, ft0           #; fs0  = 6.0000000, ft0  = 1000000000.0000000
                                                #; (acc) a0  <-- 0x00b57533
                                                #; (f:lsu) ft1  <-- -1000000000.0000000
      0x800016f8 fle.d   a1, ft1, fs0           #; ft1  = -1000000000.0000000, fs0  = 6.0000000
                                                #; (acc) a0  <-- 0x00b57533
...
; _ftoa (printf.c:0)
      0x80001810 fsgnjx.d fs2, fs0, fs0         #; fs0  = 6.0000000, fs0  = 6.0000000
                                                #; (f:fpu) fs2  <-- 6.0000000
...
; _ftoa (printf.c:383)
      0x80001864 fcvt.w.d s1, fs2               #; fs2  = 6.0000000
; _ftoa (printf.c:384)
      0x80001868 fcvt.d.w ft0, s1               #; ac1  = 6
                                                #; (f:fpu) ft0  <-- 6.0
      0x8000186c fsub.d  ft0, fs2, ft0          #; fs2  = 6.0000000, ft0  = 6.0
...
; _ftoa (printf.c:0)
      ...
      0x80001870 fmul.d  ft2, ft1, ft0          #; ft1  = 1000000.0000000, ft0  = 0.0000000
      0x8000187c fld     ft0, 0(a0)             #; ft0  <~~ Doub[0x80002e48], (f:fpu) ft2  <-- 0.0000016
; _ftoa (printf.c:385)
      0x80001880 fcvt.wu.d a0, ft2              #; ft2  = 0.0000016
                                                #; (f:lsu) ft0  <-- 0.5
                                                #; (acc) gp  <-- 0xd21501d3
; _ftoa (printf.c:386)
      0x80001884 fcvt.d.wu ft3, a0              #; ac1  = 0
                                                #; (f:fpu) ft3  <-- 0.0
      0x80001888 fsub.d  ft2, ft2, ft3          #; ft2  = 0.0000016, ft3  = 0.0
                                                #; (f:fpu) ft2  <-- 0.0000016
; _ftoa (printf.c:388)
      0x8000188c fle.d   a1, ft2, ft0           #; ft2  = 0.0000016, ft0  = 0.5
      0x80001890 bnez    a1, pc + 32            #; a1  = 1, taken, goto 0x800018b0
; _ftoa (printf.c:396)
      0x800018b0 flt.d   a1, ft2, ft0           #; ft2  = 0.0000016, ft0  = 0.5
                                                #; (acc) s4  <-- 0x00059a63
...
; _ftoa (printf.c:0)
      ...
      0x800019f8 flt.d   s9, fs0, fs1           #; fs0  = 6.0000000, fs1  = 0.0
...
; _ftoa (printf.c:434)
      0x80001a14 mulh    a0, s1, a1             #; s1  = 6, a1  = 0x66666667
                                                #; (acc) a5  <-- 0x01f55793
      0x80001a18 srli    a5, a0, 31             #; a0  = 2, (wrb) a5  <-- 0
      0x80001a1c srai    a0, a0, 2              #; a0  = 2, (wrb) a0  <-- 0
      0x80001a20 add     a0, a0, a5             #; a0  = 0, a5  = 0, (wrb) a0  <-- 0
; _ftoa (printf.c:0)
      0x80001a24 mul     a5, a0, a6             #; a0  = 0, a6  = 10
                                                #; (acc) a5  <-- 0x40f487b3
      0x80001a28 sub     a5, s1, a5             #; s1  = 6, a5  = 0, (wrb) a5  <-- 6
; _ftoa (printf.c:433)
      0x80001a2c addi    a5, a5, 48             #; a5  = 6, (wrb) a5  <-- 54
      0x80001a30 addi    s8, s0, 1              #; s0  = 7, (wrb) s8  <-- 8
      0x80001a34 add     s0, a3, s0             #; a3  = 0x0011fe38, s0  = 7, (wrb) s0  <-- 0x0011fe3f
; _ftoa (printf.c:434)
      0x80001a38 addi    a2, s1, 9              #; s1  = 6, (wrb) a2  <-- 15
; _ftoa (printf.c:433)
      0x80001a3c sb      a5, 0(s0)              #; s0  = 0x0011fe3f, 54 ~~> Byte[0x0011fe3f]
; _ftoa (printf.c:0)
      0x80001a40 mv      s0, s8                 #; s8  = 8, (wrb) s0  <-- 8
      0x80001a44 mv      s1, a0                 #; a0  = 0, (wrb) s1  <-- 0
; _ftoa (printf.c:434)
      0x80001a48 bltu    a4, a2, pc - 56        #; a4  = 18, a2  = 15, not taken
...
; _ftoa (printf.c:0)
      ...
      0x80001b34 mv      s0, s4                 #; s4  = 9, (wrb) s0  <-- 9
; _out_rev (printf.c:204)
;  in _ftoa (printf.c:461)
...
; _out_char.llvm.1805434900161566649 (printf.c:152)
      0x800014a4 beqz    a0, pc + 168           #; a0  = 54, not taken
; snrt_hartid (snrt.h:181)
;  in snrt_putchar (putchar.c:22)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x800014a8 csrr    a1, mhartid            #; mhartid = 0, (wrb) a1  <-- 0
...
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      ...
      0x800014d0 sb      a0, 72(a4)             #; a4  = 0x80002edd, 54 ~~> Byte[0x80002f25]
; snrt_putchar (putchar.c:24)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x800014d4 lw      a4, 0(a1)              #; a1  = 0x80002ed4, a4  <~~ Word[0x80002ed4]
                                                #; (lsu) a4  <-- 10
      ...
      0x800014e0 addi    a0, a0, -10            #; a0  = 54, (wrb) a0  <-- 44
      0x800014e4 snez    a0, a0                 #; a0  = 44, (wrb) a0  <-- 1
      0x800014e8 and     a0, a0, a4             #; a0  = 1, a4  = 1, (wrb) a0  <-- 1
      0x800014ec bnez    a0, pc + 96            #; a0  = 1, taken, goto 0x8000154c
; _out_char.llvm.1805434900161566649 (printf.c:155)
...
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      ...
      0x800014d0 sb      a0, 72(a4)             #; a4  = 0x80002ede, 46 ~~> Byte[0x80002f26]
; snrt_putchar (putchar.c:24)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x800014d4 lw      a4, 0(a1)              #; a1  = 0x80002ed4, a4  <~~ Word[0x80002ed4]
                                                #; (lsu) a4  <-- 11
...
;  in _ftoa (printf.c:461)
      ...
      0x80001b7c addi    s1, s0, 1              #; s0  = 16, (wrb) s1  <-- 17
      0x80001b80 mv      a1, s6                 #; s6  = 0x0011ff17, (wrb) a1  <-- 0x0011ff17
      0x80001b84 mv      a2, s0                 #; s0  = 16, (wrb) a2  <-- 16
      0x80001b88 mv      a3, s3                 #; s3  = -1, (wrb) a3  <-- -1
      0x80001b8c jalr    s7                     #; s7  = 0x800014a4, (wrb) ra  <-- 0x80001b90, goto 0x800014a4
                                                #; (lsu) a0  <-- 48
; _out_char.llvm.1805434900161566649 (printf.c:152)
...
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      ...
      0x800014d0 sb      a0, 72(a4)             #; a4  = 0x80002ee4, 48 ~~> Byte[0x80002f2c]
; snrt_putchar (putchar.c:24)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x800014d4 lw      a4, 0(a1)              #; a1  = 0x80002ed4, a4  <~~ Word[0x80002ed4]
                                                #; (lsu) a4  <-- 17
...
; _out_rev (printf.c:0)
;  in _ftoa (printf.c:461)
      0x80001b90 mv      s0, s1                 #; s1  = 17, (wrb) s0  <-- 17
...
; _out_rev (printf.c:0)
;  in _ftoa (printf.c:461)
      0x80001ba4 sub     a0, s1, s4             #; s1  = 17, s4  = 9, (wrb) a0  <-- 8
...
; _ftoa (printf.c:0)
      0x80001be8 mv      s0, s1                 #; s1  = 17, (wrb) s0  <-- 17
; _ftoa (printf.c:462)
      0x80001bec mv      a0, s0                 #; s0  = 17, (wrb) a0  <-- 17
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      ...
      0x80001394 mv      s8, a0                 #; a0  = 17, (wrb) s8  <-- 17
      0x80001398 li      s6, 37                 #; (wrb) s6  <-- 37
      0x8000139c li      s7, 46                 #; (wrb) s7  <-- 46
      0x800013a0 addi    s0, s10, 1             #; s10 = 0x80002b8f, (wrb) s0  <-- 0x80002b90
      0x800013a4 j       pc - 0xa74             #; goto 0x80000930
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x80000930 addi    s10, s0, 2             #; s0  = 0x80002b90, (wrb) s10 <-- 0x80002b92
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000934 mv      s9, s8                 #; s8  = 17, (wrb) s9  <-- 17
      0x80000938 li      s8, 10                 #; (wrb) s8  <-- 10
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x8000093c lbu     a0, 0(s0)              #; s0  = 0x80002b90, a0  <~~ Byte[0x80002b90]
                                                #; (lsu) a0  <-- 10
      0x80000940 beqz    a0, pc + 2824          #; a0  = 10, not taken
      0x80000944 beq     a0, s6, pc + 48        #; a0  = 10, s6  = 37, not taken
; _vsnprintf.llvm.1805434900161566649 (printf.c:592)
      0x80000948 addi    s1, s9, 1              #; s9  = 17, (wrb) s1  <-- 18
      0x8000094c mv      a1, s4                 #; s4  = 0x0011ff17, (wrb) a1  <-- 0x0011ff17
      0x80000950 mv      a2, s9                 #; s9  = 17, (wrb) a2  <-- 17
      0x80000954 mv      a3, s5                 #; s5  = -1, (wrb) a3  <-- -1
      0x80000958 jalr    s2                     #; s2  = 0x800014a4, (wrb) ra  <-- 0x8000095c, goto 0x800014a4
; _out_char.llvm.1805434900161566649 (printf.c:152)
...
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      ...
      0x800014c0 lw      a4, 0(a1)              #; a1  = 0x80002ed4, a4  <~~ Word[0x80002ed4]
                                                #; (lsu) a4  <-- 17
      0x800014c4 addi    a5, a4, 1              #; a4  = 17, (wrb) a5  <-- 18
      0x800014c8 sw      a5, 0(a1)              #; a1  = 0x80002ed4, 18 ~~> Word[0x80002ed4]
      0x800014cc add     a4, a1, a4             #; a1  = 0x80002ed4, a4  = 17, (wrb) a4  <-- 0x80002ee5
      0x800014d0 sb      a0, 72(a4)             #; a4  = 0x80002ee5, 10 ~~> Byte[0x80002f2d]
; snrt_putchar (putchar.c:24)
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x800014d4 lw      a4, 0(a1)              #; a1  = 0x80002ed4, a4  <~~ Word[0x80002ed4]
                                                #; (lsu) a4  <-- 18
      0x800014d8 addi    a4, a4, -1020          #; a4  = 18, (wrb) a4  <-- -1002
      0x800014dc snez    a4, a4                 #; a4  = -1002, (wrb) a4  <-- 1
...
;  in _out_char.llvm.1805434900161566649 (printf.c:153)
      0x80001520 sw      zero, 36(a0)           #; a0  = 0x80002ed4, 0 ~~> Word[0x80002ef8]
                                                #; (lsu) a2  <-- 18
      0x80001524 sw      a2, 32(a0)             #; a0  = 0x80002ed4, 18 ~~> Word[0x80002ef4]
...
; _out_char.llvm.1805434900161566649 (printf.c:155)
      0x8000154c ret                            #; ra  = 0x8000095c, goto 0x8000095c
; _vsnprintf.llvm.1805434900161566649 (printf.c:593)
      0x8000095c addi    s0, s0, 1              #; s0  = 0x80002b90, (wrb) s0  <-- 0x80002b91
; _vsnprintf.llvm.1805434900161566649 (printf.c:594)
      0x80000960 addi    s10, s10, 1            #; s10 = 0x80002b92, (wrb) s10 <-- 0x80002b93
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000964 mv      s9, s1                 #; s1  = 18, (wrb) s9  <-- 18
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x80000968 lbu     a0, 0(s0)              #; s0  = 0x80002b91, a0  <~~ Byte[0x80002b91]
                                                #; (lsu) a0  <-- 0
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:853)
      0x80001448 mv      a2, s9                 #; s9  = 18, (wrb) a2  <-- 18
      0x8000144c bltu    s9, s5, pc + 8         #; s9  = 18, s5  = -1, taken, goto 0x80001454
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:856)
      0x80001464 mv      a0, s9                 #; s9  = 18, (wrb) a0  <-- 18
...
; main (bench_sp.c:57)
      ...
      0x80000810 fsgnjx.d fs0, ft0, ft0         #; ft0  = 570.0, ft0  = 570.0
                                                #; (f:fpu) fs0  <-- 570.0
      0x80000814 fsd     fs0, 8(sp)             #; 570.0 ~~> Doub[0x0011ff48]
                                                #; (lsu) a3  <-- 0
      0x80000820 auipc   a0, 0x2                #; (wrb) a0  <-- 0x80002820
      0x80000824 addi    a0, a0, 882            #; a0  = 0x80002820, (wrb) a0  <-- 0x80002b92
...
; printf_ (printf.c:863)
      ...
      0x80000858 mv      t0, a0                 #; a0  = 0x80002b92, (wrb) t0  <-- 0x80002b92
      0x8000085c sw      a7, 44(sp)             #; sp  = 0x0011ff10, 9 ~~> Word[0x0011ff3c]
      0x80000860 sw      a6, 40(sp)             #; sp  = 0x0011ff10, 10 ~~> Word[0x0011ff38]
      0x80000864 sw      a5, 36(sp)             #; sp  = 0x0011ff10, 18 ~~> Word[0x0011ff34]
...
; printf_ (printf.c:867)
      ...
      0x8000088c li      a2, -1                 #; (wrb) a2  <-- -1
      0x80000890 addi    a4, sp, 20             #; sp  = 0x0011ff10, (wrb) a4  <-- 0x0011ff24
      0x80000894 mv      a3, t0                 #; t0  = 0x80002b92, (wrb) a3  <-- 0x80002b92
      0x80000898 auipc   ra, 0x0                #; (wrb) ra  <-- 0x80000898
      0x8000089c jalr    ra, ra, 20             #; ra  = 0x80000898, (wrb) ra  <-- 0x800008a0, goto 0x800008ac
; _vsnprintf.llvm.1805434900161566649 (printf.c:578)
      0x800008ac addi    sp, sp, -112           #; sp  = 0x0011ff10, (wrb) sp  <-- 0x0011fea0
      ...
      0x800008e0 sw      s11, 60(sp)            #; sp  = 0x0011fea0, 0 ~~> Word[0x0011fedc]
      0x800008e4 mv      s3, a4                 #; a4  = 0x0011ff24, (wrb) s3  <-- 0x0011ff24
      0x800008e8 mv      s0, a3                 #; a3  = 0x80002b92, (wrb) s0  <-- 0x80002b92
      0x800008ec mv      s5, a2                 #; a2  = -1, (wrb) s5  <-- -1
      0x800008f0 mv      s4, a1                 #; a1  = 0x0011ff17, (wrb) s4  <-- 0x0011ff17
; _vsnprintf.llvm.1805434900161566649 (printf.c:582)
      0x800008f4 beqz    a1, pc + 12            #; a1  = 0x0011ff17, not taken
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      ...
      0x8000092c sw      a0, 16(sp)             #; sp  = 0x0011fea0, 65535 ~~> Word[0x0011feb0]
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x80000930 addi    s10, s0, 2             #; s0  = 0x80002b92, (wrb) s10 <-- 0x80002b94
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000934 mv      s9, s8                 #; s8  = 0, (wrb) s9  <-- 0
      0x80000938 li      s8, 10                 #; (wrb) s8  <-- 10
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x8000093c lbu     a0, 0(s0)              #; s0  = 0x80002b92, a0  <~~ Byte[0x80002b92]
                                                #; (lsu) a0  <-- 101
...
; _ftoa (printf.c:340)
      ...
      0x80001584 sw      s10, 64(sp)            #; sp  = 0x0011fe30, 0x80002b9b ~~> Word[0x0011fe70]
      0x80001588 fsd     fs0, 56(sp)            #; 570.0 ~~> Doub[0x0011fe68]
      0x8000158c fsd     fs1, 48(sp)            #; 0.0 ~~> Doub[0x0011fe60]
      0x80001594 auipc   s1, 0x2                #; (wrb) s1  <-- 0x80003594
      0x80001598 addi    s1, s1, -1900          #; s1  = 0x80003594, (wrb) s1  <-- 0x80002e28
      0x80001590 fsd     fs2, 40(sp)            #; 0.0 ~~> Doub[0x0011fe58]
...
; _ftoa (printf.c:0)
      0x8000187c fld     ft0, 0(a0)             #; ft0  <~~ Doub[0x80002e48]
                                                #; (f:fpu) ft2  <-- 0.0
; _ftoa (printf.c:385)
...
; _ftoa (printf.c:386)
      0x80001884 fcvt.d.wu ft3, a0              #; ac1  = 0
                                                #; (f:fpu) ft3  <-- 0.0
      0x80001888 fsub.d  ft2, ft2, ft3          #; ft2  = 0.0, ft3  = 0.0, (f:lsu) ft0  <-- 0.5
                                                #; (f:fpu) ft2  <-- 0.0
; _ftoa (printf.c:388)
...
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      ...
      0x80001398 li      s6, 37                 #; (wrb) s6  <-- 37
      0x8000139c li      s7, 46                 #; (wrb) s7  <-- 46
      0x800013a0 addi    s0, s10, 1             #; s10 = 0x80002b9b, (wrb) s0  <-- 0x80002b9c
      0x800013a4 j       pc - 0xa74             #; goto 0x80000930
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x80000930 addi    s10, s0, 2             #; s0  = 0x80002b9c, (wrb) s10 <-- 0x80002b9e
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000934 mv      s9, s8                 #; s8  = 16, (wrb) s9  <-- 16
      0x80000938 li      s8, 10                 #; (wrb) s8  <-- 10
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x8000093c lbu     a0, 0(s0)              #; s0  = 0x80002b9c, a0  <~~ Byte[0x80002b9c]
                                                #; (lsu) a0  <-- 10
      0x80000940 beqz    a0, pc + 2824          #; a0  = 10, not taken
      0x80000944 beq     a0, s6, pc + 48        #; a0  = 10, s6  = 37, not taken
; _vsnprintf.llvm.1805434900161566649 (printf.c:592)
...
; _out_char.llvm.1805434900161566649 (printf.c:155)
      0x8000154c ret                            #; ra  = 0x8000095c, goto 0x8000095c
; _vsnprintf.llvm.1805434900161566649 (printf.c:593)
      0x8000095c addi    s0, s0, 1              #; s0  = 0x80002b9c, (wrb) s0  <-- 0x80002b9d
; _vsnprintf.llvm.1805434900161566649 (printf.c:594)
      0x80000960 addi    s10, s10, 1            #; s10 = 0x80002b9e, (wrb) s10 <-- 0x80002b9f
; _vsnprintf.llvm.1805434900161566649 (printf.c:0)
      0x80000964 mv      s9, s1                 #; s1  = 17, (wrb) s9  <-- 17
; _vsnprintf.llvm.1805434900161566649 (printf.c:587)
      0x80000968 lbu     a0, 0(s0)              #; s0  = 0x80002b9d, a0  <~~ Byte[0x80002b9d]
                                                #; (lsu) a0  <-- 0
      0x8000096c bnez    a0, pc - 40            #; a0  = 0, not taken
      0x80000970 j       pc + 0xad8             #; goto 0x80001448
; _vsnprintf.llvm.1805434900161566649 (printf.c:853)
...
; ?? (start.S:195)
      0x8000290c mv      a0, s0                 #; s0  = 1, (wrb) a0  <-- 1
; ?? (start.S:196)
...
; ?? (start_snitch.S:16)
      0x80002b40 sw      a0, 0(sp)              #; sp  = 0x0011ff58, 1 ~~> Word[0x0011ff58]
; ?? (start_snitch.S:17)
...
; ?? (start_snitch.S:27)
      0x80002b5c bnez    a0, pc + 24            #; a0  = 0, not taken
                                                #; (lsu) ra  <-- 0x80002918
; ?? (start_snitch.S:28)
      0x80002b60 slli    t0, t0, 1              #; t0  = 1, (wrb) t0  <-- 2
; ?? (start_snitch.S:29)
      0x80002b64 ori     t0, t0, 1              #; t0  = 2, (wrb) t0  <-- 3
; ?? (start_snitch.S:30)
      0x80002b68 auipc   t1, 0x0                #; (wrb) t1  <-- 0x80002b68
      0x80002b6c addi    t1, t1, 600            #; t1  = 0x80002b68, (wrb) t1  <-- 0x80002dc0
; ?? (start_snitch.S:31)
      0x80002b70 sw      t0, 0(t1)              #; t1  = 0x80002dc0, 3 ~~> Word[0x80002dc0]
; ?? (start_snitch.S:32)
