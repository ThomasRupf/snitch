...
;  in main (test_reverse_conflict.c:31)
      0x80000678 auipc   a3, 0x3                #; (wrb) a3  <-- 0x80003678
      0x8000067c addi    a3, a3, -1888          #; a3  = 0x80003678, (wrb) a3  <-- 0x80002f18
      0x80000684 auipc   a3, 0x3                #; (wrb) a3  <-- 0x80003684
      0x80000688 addi    a3, a3, -1892          #; a3  = 0x80003684, (wrb) a3  <-- 0x80002f20
      0x80000680 fld     ft3, 0(a3)             #; ft3  <~~ Doub[0x80002f18]
      0x8000068c fld     ft4, 0(a3)             #; ft4  <~~ Doub[0x80002f20]
                                                #; (f:lsu) ft3  <-- 1.0
                                                #; (f:lsu) ft4  <-- 1.01
; init_data (test_reverse_conflict.c:10)
;  in main (test_reverse_conflict.c:31)
      0x80000690 scfgwi  a2, 896                #; a2  = 0x00100000
      0x80000694 csrsi   ssr, 1                 #; 
; init_data (test_reverse_conflict.c:11)
;  in main (test_reverse_conflict.c:31)
      0x80000698 fsgnj.d ft0, ft3, ft3          #; ft3  = 1.0, ft3  = 1.0
      0x8000069c fsgnj.d ft0, ft4, ft4          #; ft4  = 1.01, ft4  = 1.01, (f:fpu) ft0  <-- 1.0
                                                #; (f:fpu) ft0  <-- 1.01
; init_data (test_reverse_conflict.c:0)
;  in main (test_reverse_conflict.c:31)
...
; init_data (test_reverse_conflict.c:0)
;  in main (test_reverse_conflict.c:32)
      0x80000740 auipc   a4, 0x3                #; (wrb) a4  <-- 0x80003740
      0x80000744 addi    a4, a4, -2008          #; a4  = 0x80003740, (wrb) a4  <-- 0x80002f68
      0x8000074c auipc   a4, 0x3                #; (wrb) a4  <-- 0x8000374c
      0x80000748 fld     ft3, 0(a4)             #; ft3  <~~ Doub[0x80002f68]
      0x80000750 addi    a4, a4, -2012          #; a4  = 0x8000374c, (wrb) a4  <-- 0x80002f70
                                                #; (f:lsu) ft3  <-- 10.0
; init_data (test_reverse_conflict.c:10)
;  in main (test_reverse_conflict.c:32)
      0x80000758 scfgwi  a3, 896                #; a3  = 0x00100050
; init_data (test_reverse_conflict.c:0)
;  in main (test_reverse_conflict.c:32)
      0x80000754 fld     ft4, 0(a4)             #; ft4  <~~ Doub[0x80002f70]
; init_data (test_reverse_conflict.c:10)
;  in main (test_reverse_conflict.c:32)
...
;  in main (test_reverse_conflict.c:32)
      ...
      0x800007e8 csrci   ssr, 1                 #; (f:fpu) ft0  <-- 10.09
; reverse_conflict (reverse_conflict.c:5)
;  in main (test_reverse_conflict.c:34)
      0x800007ec fld     ft0, 0(a2)             #; ft0  <~~ Doub[0x00100000]
                                                #; (f:lsu) ft0  <-- 1.0
...
;  in main (test_reverse_conflict.c:34)
      ...
      0x800007f0 fadd.d  ft1, ft0, ft0          #; ft0  = 1.0, ft0  = 1.0
      0x800007fc fld     ft2, 0(a3)             #; ft2  <~~ Doub[0x80002fb8], (f:fpu) ft1  <-- 2.0
      0x80000800 auipc   a3, 0x2                #; (wrb) a3  <-- 0x80002800
      0x80000804 addi    a3, a3, 1984           #; a3  = 0x80002800, (wrb) a3  <-- 0x80002fc0
                                                #; (f:lsu) ft2  <-- 4.0
      0x80000808 fld     ft3, 0(a3)             #; ft3  <~~ Doub[0x80002fc0]
; reverse_conflict (reverse_conflict.c:5)
;  in main (test_reverse_conflict.c:34)
      0x8000080c fsd     ft1, 8(a2)             #; 2.0 ~~> Doub[0x00100008]
                                                #; (f:lsu) ft3  <-- 8.0
      0x80000810 fmul.d  ft1, ft0, ft2          #; ft0  = 1.0, ft2  = 4.0
; reverse_conflict (reverse_conflict.c:0)
;  in main (test_reverse_conflict.c:34)
...
; reverse_conflict (reverse_conflict.c:5)
;  in main (test_reverse_conflict.c:34)
      0x80000814 fsd     ft1, 16(a2)            #; 4.0 ~~> Doub[0x00100010]
      0x80000818 fmul.d  ft1, ft0, ft3          #; ft0  = 1.0, ft3  = 8.0
                                                #; (f:fpu) ft1  <-- 8.0
; reverse_conflict (reverse_conflict.c:0)
;  in main (test_reverse_conflict.c:34)
      ...
      0x80000824 fld     ft2, 0(a3)             #; ft2  <~~ Doub[0x80002fc8]
                                                #; (f:lsu) ft2  <-- 16.0
      0x80000830 fld     ft3, 0(a3)             #; ft3  <~~ Doub[0x80002fd0]
; reverse_conflict (reverse_conflict.c:5)
;  in main (test_reverse_conflict.c:34)
      0x80000834 fsd     ft1, 24(a2)            #; 8.0 ~~> Doub[0x00100018]
      0x80000838 fmul.d  ft1, ft0, ft2          #; ft0  = 1.0, ft2  = 16.0
                                                #; (f:fpu) ft1  <-- 16.0
      0x8000083c fsd     ft1, 32(a2)            #; 16.0 ~~> Doub[0x00100020]
                                                #; (f:lsu) ft3  <-- 32.0
; reverse_conflict (reverse_conflict.c:0)
;  in main (test_reverse_conflict.c:34)
      0x80000844 auipc   a3, 0x2                #; (wrb) a3  <-- 0x80002844
      0x80000848 addi    a3, a3, 1940           #; a3  = 0x80002844, (wrb) a3  <-- 0x80002fd8
      0x80000840 fmul.d  ft1, ft0, ft3          #; ft0  = 1.0, ft3  = 32.0
      0x8000084c fld     ft2, 0(a3)             #; ft2  <~~ Doub[0x80002fd8], (f:fpu) ft1  <-- 32.0
      0x80000850 auipc   a3, 0x2                #; (wrb) a3  <-- 0x80002850
      0x80000854 addi    a3, a3, 1936           #; a3  = 0x80002850, (wrb) a3  <-- 0x80002fe0
                                                #; (f:lsu) ft2  <-- 64.0
      0x80000858 fld     ft3, 0(a3)             #; ft3  <~~ Doub[0x80002fe0]
; reverse_conflict (reverse_conflict.c:5)
;  in main (test_reverse_conflict.c:34)
      0x8000085c fsd     ft1, 40(a2)            #; 32.0 ~~> Doub[0x00100028]
                                                #; (f:lsu) ft3  <-- 128.0
      0x80000860 fmul.d  ft1, ft0, ft2          #; ft0  = 1.0, ft2  = 64.0
; reverse_conflict (reverse_conflict.c:0)
;  in main (test_reverse_conflict.c:34)
...
; reverse_conflict (reverse_conflict.c:5)
;  in main (test_reverse_conflict.c:34)
      0x80000864 fsd     ft1, 48(a2)            #; 64.0 ~~> Doub[0x00100030]
      0x80000868 fmul.d  ft1, ft0, ft3          #; ft0  = 1.0, ft3  = 128.0
                                                #; (f:fpu) ft1  <-- 128.0
; reverse_conflict (reverse_conflict.c:0)
;  in main (test_reverse_conflict.c:34)
      ...
      0x80000874 fld     ft2, 0(a3)             #; ft2  <~~ Doub[0x80002fe8]
                                                #; (f:lsu) ft2  <-- 256.0
      0x80000880 fld     ft3, 0(a3)             #; ft3  <~~ Doub[0x80002ff0]
; reverse_conflict (reverse_conflict.c:5)
;  in main (test_reverse_conflict.c:34)
      0x80000884 fsd     ft1, 56(a2)            #; 128.0 ~~> Doub[0x00100038]
      0x80000888 fmul.d  ft1, ft0, ft2          #; ft0  = 1.0, ft2  = 256.0
                                                #; (f:fpu) ft1  <-- 256.0
      0x8000088c fsd     ft1, 64(a2)            #; 256.0 ~~> Doub[0x00100040]
                                                #; (f:lsu) ft3  <-- 512.0
; sumup (test_reverse_conflict.c:17)
;  in main (test_reverse_conflict.c:36)
      0x80000898 li      a3, 64                 #; (wrb) a3  <-- 64
      0x80000890 fmul.d  ft0, ft0, ft3          #; ft0  = 1.0, ft3  = 512.0
      0x8000089c li      a4, 192                #; (wrb) a4  <-- 192
                                                #; (f:fpu) ft0  <-- 512.0
; reverse_conflict (reverse_conflict.c:5)
;  in main (test_reverse_conflict.c:34)
      0x80000894 fsd     ft0, 72(a2)            #; 512.0 ~~> Doub[0x00100048]
; sumup (test_reverse_conflict.c:17)
;  in main (test_reverse_conflict.c:36)
...
;  in main (test_reverse_conflict.c:36)
      0x800008d8 auipc   a0, 0x2                #; (wrb) a0  <-- 0x800028d8
      0x800008d0 fsgnj.d fa1, ft0, ft0          #; ft0  = 64.0, ft0  = 64.0
      0x800008dc addi    a0, a0, 1824           #; a0  = 0x800028d8, (wrb) a0  <-- 0x80002ff8
      0x800008d4 fsgnj.d fa2, ft0, ft0          #; ft0  = 128.0, ft0  = 128.0, (f:fpu) fa1  <-- 64.0
                                                #; (f:fpu) fa2  <-- 128.0
      0x800008e0 fld     fa3, 0(a0)             #; fa3  <~~ Doub[0x80002ff8]
; sumup (test_reverse_conflict.c:18)
;  in main (test_reverse_conflict.c:36)
      0x800008e4 fsgnj.d fa4, ft0, ft0          #; ft0  = 256.0, ft0  = 256.0
      0x800008e8 fsgnj.d fa5, ft0, ft0          #; ft0  = 512.0, ft0  = 512.0, (f:fpu) fa4  <-- 256.0
; sumup (test_reverse_conflict.c:0)
;  in main (test_reverse_conflict.c:36)
      0x800008ec csrci   ssr, 1                 #; (f:fpu) fa5  <-- 512.0
                                                #; (f:lsu) fa3  <-- -1023.0
; sumup (test_reverse_conflict.c:18)
;  in main (test_reverse_conflict.c:36)
      0x800008f0 fadd.d  ft0, ft3, fa3          #; ft3  = 1.0, fa3  = -1023.0
                                                #; (f:fpu) ft0  <-- -1022.0
      0x800008f4 fadd.d  ft0, ft0, ft4          #; ft0  = -1022.0, ft4  = 2.0
                                                #; (f:fpu) ft0  <-- -1020.0
      0x800008f8 fadd.d  ft0, ft0, ft5          #; ft0  = -1020.0, ft5  = 4.0
                                                #; (f:fpu) ft0  <-- -1016.0
      0x800008fc fadd.d  ft0, ft0, ft6          #; ft0  = -1016.0, ft6  = 8.0
                                                #; (f:fpu) ft0  <-- -1008.0
      0x80000900 fadd.d  ft0, ft0, ft7          #; ft0  = -1008.0, ft7  = 16.0
                                                #; (f:fpu) ft0  <-- -992.0
      0x80000904 fadd.d  ft0, ft0, fa0          #; ft0  = -992.0, fa0  = 32.0
                                                #; (f:fpu) ft0  <-- -960.0
      0x80000908 fadd.d  ft0, ft0, fa1          #; ft0  = -960.0, fa1  = 64.0
                                                #; (f:fpu) ft0  <-- -896.0
      0x8000090c fadd.d  ft0, ft0, fa2          #; ft0  = -896.0, fa2  = 128.0
                                                #; (f:fpu) ft0  <-- -768.0
      0x80000910 fadd.d  ft0, ft0, fa4          #; ft0  = -768.0, fa4  = 256.0
; main (test_reverse_conflict.c:42)
      0x80000920 lw      a2, 8(sp)              #; sp  = 0x0011ff40, a2  <~~ Word[0x0011ff48]
                                                #; (f:fpu) ft0  <-- -512.0
; main (test_reverse_conflict.c:39)
      0x80000914 fadd.d  ft0, ft0, fa5          #; ft0  = -512.0, fa5  = 512.0
                                                #; (lsu) a2  <-- 0
; main (test_reverse_conflict.c:42)
      ...
      0x80000918 fsgnjx.d fs0, ft0, ft0         #; ft0  = 0.0, ft0  = 0.0
                                                #; (lsu) a3  <-- 0
                                                #; (f:fpu) fs0  <-- 0.0
...
; main (test_reverse_conflict.c:0)
      ...
      0x80000940 fld     ft0, 0(a0)             #; ft0  <~~ Doub[0x80003000]
; main (test_reverse_conflict.c:45)
      ...
      0x80000944 flt.d   a0, ft0, fs0           #; ft0  = 0.0001, fs0  = 0.0
                                                #; (lsu) ra  <-- 0x80002a10
