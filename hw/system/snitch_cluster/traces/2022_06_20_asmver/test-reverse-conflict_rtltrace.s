       ...
       0     1637        M 0x80000694 csrsi   ssr, 1                 #; 
       ...
       0     1783        M 0x8000075c csrsi   ssr, 1                 #; 
       ...
       0     1891        M 0x800007e8 csrci   ssr, 1                 #; (f:fpu) ft0  <-- 10.09
       0     1893        M 0x800007ec fld     ft0, 0(a2)             #; ft0  <~~ Doub[0x00100000]
       0     1894        M                                           #; (f:lsu) ft0  <-- 1.0
       0     1900        M 0x800007f4 auipc   a3, 0x2                #; (wrb) a3  <-- 0x800027f4
       0     1901        M 0x800007f8 addi    a3, a3, 1988           #; a3  = 0x800027f4, (wrb) a3  <-- 0x80002fb8
                         M 0x800007f0 fadd.d  ft1, ft0, ft0          #; ft0  = 1.0, ft0  = 1.0
       0     1904        M 0x800007fc fld     ft2, 0(a3)             #; ft2  <~~ Doub[0x80002fb8], (f:fpu) ft1  <-- 2.0
       0     1911        M 0x80000800 auipc   a3, 0x2                #; (wrb) a3  <-- 0x80002800
       0     1912        M 0x80000804 addi    a3, a3, 1984           #; a3  = 0x80002800, (wrb) a3  <-- 0x80002fc0
       0     1913        M                                           #; (f:lsu) ft2  <-- 4.0
       0     1915        M 0x80000808 fld     ft3, 0(a3)             #; ft3  <~~ Doub[0x80002fc0]
       0     1916        M 0x8000080c fsd     ft1, 8(a2)             #; 2.0 ~~> Doub[0x00100008]
       0     1924        M                                           #; (f:lsu) ft3  <-- 8.0
       0     1925        M 0x80000810 fmul.d  ft1, ft0, ft2          #; ft0  = 1.0, ft2  = 4.0
       0     1926        M 0x8000081c auipc   a3, 0x2                #; (wrb) a3  <-- 0x8000281c
       0     1928        M                                           #; (f:fpu) ft1  <-- 4.0
       0     1929        M 0x80000814 fsd     ft1, 16(a2)            #; 4.0 ~~> Doub[0x00100010]
       0     1930        M 0x80000818 fmul.d  ft1, ft0, ft3          #; ft0  = 1.0, ft3  = 8.0
       0     1933        M                                           #; (f:fpu) ft1  <-- 8.0
       ...
       0     1938        M 0x8000082c addi    a3, a3, 1960           #; a3  = 0x80002828, (wrb) a3  <-- 0x80002fd0
                         M 0x80000824 fld     ft2, 0(a3)             #; ft2  <~~ Doub[0x80002fc8]
       0     1947        M                                           #; (f:lsu) ft2  <-- 16.0
       0     1949        M 0x80000830 fld     ft3, 0(a3)             #; ft3  <~~ Doub[0x80002fd0]
       0     1950        M 0x80000834 fsd     ft1, 24(a2)            #; 8.0 ~~> Doub[0x00100018]
       0     1951        M 0x80000838 fmul.d  ft1, ft0, ft2          #; ft0  = 1.0, ft2  = 16.0
       0     1954        M                                           #; (f:fpu) ft1  <-- 16.0
       0     1955        M 0x8000083c fsd     ft1, 32(a2)            #; 16.0 ~~> Doub[0x00100020]
       0     1958        M                                           #; (f:lsu) ft3  <-- 32.0
       0     1960        M 0x80000844 auipc   a3, 0x2                #; (wrb) a3  <-- 0x80002844
       0     1961        M 0x80000848 addi    a3, a3, 1940           #; a3  = 0x80002844, (wrb) a3  <-- 0x80002fd8
                         M 0x80000840 fmul.d  ft1, ft0, ft3          #; ft0  = 1.0, ft3  = 32.0
       0     1964        M 0x8000084c fld     ft2, 0(a3)             #; ft2  <~~ Doub[0x80002fd8], (f:fpu) ft1  <-- 32.0
       0     1971        M 0x80000850 auipc   a3, 0x2                #; (wrb) a3  <-- 0x80002850
       0     1972        M 0x80000854 addi    a3, a3, 1936           #; a3  = 0x80002850, (wrb) a3  <-- 0x80002fe0
       0     1973        M                                           #; (f:lsu) ft2  <-- 64.0
       0     1975        M 0x80000858 fld     ft3, 0(a3)             #; ft3  <~~ Doub[0x80002fe0]
       0     1976        M 0x8000085c fsd     ft1, 40(a2)            #; 32.0 ~~> Doub[0x00100028]
       0     1984        M                                           #; (f:lsu) ft3  <-- 128.0
       0     1985        M 0x80000860 fmul.d  ft1, ft0, ft2          #; ft0  = 1.0, ft2  = 64.0
       0     1986        M 0x8000086c auipc   a3, 0x2                #; (wrb) a3  <-- 0x8000286c
       0     1988        M                                           #; (f:fpu) ft1  <-- 64.0
       0     1989        M 0x80000864 fsd     ft1, 48(a2)            #; 64.0 ~~> Doub[0x00100030]
       0     1990        M 0x80000868 fmul.d  ft1, ft0, ft3          #; ft0  = 1.0, ft3  = 128.0
       0     1993        M                                           #; (f:fpu) ft1  <-- 128.0
       ...
       0     1998        M 0x8000087c addi    a3, a3, 1912           #; a3  = 0x80002878, (wrb) a3  <-- 0x80002ff0
                         M 0x80000874 fld     ft2, 0(a3)             #; ft2  <~~ Doub[0x80002fe8]
       0     2007        M                                           #; (f:lsu) ft2  <-- 256.0
       0     2009        M 0x80000880 fld     ft3, 0(a3)             #; ft3  <~~ Doub[0x80002ff0]
       0     2010        M 0x80000884 fsd     ft1, 56(a2)            #; 128.0 ~~> Doub[0x00100038]
       0     2011        M 0x80000888 fmul.d  ft1, ft0, ft2          #; ft0  = 1.0, ft2  = 256.0
       0     2014        M                                           #; (f:fpu) ft1  <-- 256.0
       0     2015        M 0x8000088c fsd     ft1, 64(a2)            #; 256.0 ~~> Doub[0x00100040]
       0     2018        M                                           #; (f:lsu) ft3  <-- 512.0
       0     2021        M 0x80000898 li      a3, 64                 #; (wrb) a3  <-- 64
                         M 0x80000890 fmul.d  ft0, ft0, ft3          #; ft0  = 1.0, ft3  = 512.0
       0     2022        M 0x8000089c li      a4, 192                #; (wrb) a4  <-- 192
       0     2024        M                                           #; (f:fpu) ft0  <-- 512.0
       0     2025        M 0x80000894 fsd     ft0, 72(a2)            #; 512.0 ~~> Doub[0x00100048]
       ...
       0     2045        M 0x800008b4 csrsi   ssr, 1                 #; 
       ...
       0     2084        M 0x800008ec csrci   ssr, 1                 #; (f:fpu) fa5  <-- 512.0
       0     2090        M                                           #; (f:lsu) fa3  <-- -1023.0
       0     2093        M 0x800008f0 fadd.d  ft0, ft3, fa3          #; ft3  = 1.0, fa3  = -1023.0
       0     2096        M                                           #; (f:fpu) ft0  <-- -1022.0
       0     2097        M 0x800008f4 fadd.d  ft0, ft0, ft4          #; ft0  = -1022.0, ft4  = 2.0
       0     2100        M                                           #; (f:fpu) ft0  <-- -1020.0
       0     2101        M 0x800008f8 fadd.d  ft0, ft0, ft5          #; ft0  = -1020.0, ft5  = 4.0
       0     2104        M                                           #; (f:fpu) ft0  <-- -1016.0
       0     2105        M 0x800008fc fadd.d  ft0, ft0, ft6          #; ft0  = -1016.0, ft6  = 8.0
       0     2108        M                                           #; (f:fpu) ft0  <-- -1008.0
       0     2109        M 0x80000900 fadd.d  ft0, ft0, ft7          #; ft0  = -1008.0, ft7  = 16.0
       0     2112        M                                           #; (f:fpu) ft0  <-- -992.0
       0     2113        M 0x80000904 fadd.d  ft0, ft0, fa0          #; ft0  = -992.0, fa0  = 32.0
       0     2116        M                                           #; (f:fpu) ft0  <-- -960.0
       0     2117        M 0x80000908 fadd.d  ft0, ft0, fa1          #; ft0  = -960.0, fa1  = 64.0
       0     2120        M                                           #; (f:fpu) ft0  <-- -896.0
       0     2121        M 0x8000090c fadd.d  ft0, ft0, fa2          #; ft0  = -896.0, fa2  = 128.0
       0     2124        M                                           #; (f:fpu) ft0  <-- -768.0
       0     2125        M 0x80000910 fadd.d  ft0, ft0, fa4          #; ft0  = -768.0, fa4  = 256.0
       0     2127        M 0x80000920 lw      a2, 8(sp)              #; sp  = 0x0011ff40, a2  <~~ Word[0x0011ff48]
       0     2128        M                                           #; (f:fpu) ft0  <-- -512.0
       0     2129        M 0x80000914 fadd.d  ft0, ft0, fa5          #; ft0  = -512.0, fa5  = 512.0
       0     2130        M                                           #; (lsu) a2  <-- 0
       ...
       0     2133        M 0x8000092c addi    a0, a0, 877            #; a0  = 0x80002928, (wrb) a0  <-- 0x80002c95
                         M 0x80000918 fsgnjx.d fs0, ft0, ft0         #; ft0  = 0.0, ft0  = 0.0
       0     2134        M                                           #; (lsu) a3  <-- 0
                         M                                           #; (f:fpu) fs0  <-- 0.0
