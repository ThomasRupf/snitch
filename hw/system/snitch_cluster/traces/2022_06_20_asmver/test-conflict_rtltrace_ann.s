...
;  in main (test_conflict.c:22)
      ...
      0x80000704 auipc   t1, 0x3                #; (wrb) t1  <-- 0x80003704
      0x80000708 addi    t1, t1, -908           #; t1  = 0x80003704, (wrb) t1  <-- 0x80003378
      0x8000070c auipc   t2, 0x3                #; (wrb) t2  <-- 0x8000370c
      0x80000710 addi    t2, t2, -908           #; t2  = 0x8000370c, (wrb) t2  <-- 0x80003380
      0x80000714 auipc   t3, 0x3                #; (wrb) t3  <-- 0x80003714
      0x80000718 addi    t3, t3, -908           #; t3  = 0x80003714, (wrb) t3  <-- 0x80003388
...
;  in main (test_conflict.c:22)
      0x8000077c fld     ft4, 0(t4)             #; ft4  <~~ Doub[0x80003370]
                                                #; (f:lsu) ft3  <-- 4.2426000
      0x80000780 fld     ft5, 0(t1)             #; ft5  <~~ Doub[0x80003378], (f:lsu) ft4  <-- 5.6568
...
;  in main (test_conflict.c:22)
      ...
      0x80000798 fld     ft3, 0(t3)             #; ft3  <~~ Doub[0x80003388], (f:fpu) ft0  <-- 8.4852000
; init_data (test_conflict.c:0)
;  in main (test_conflict.c:22)
...
;  in main (test_conflict.c:22)
      ...
      0x800007b8 csrci   ssr, 1                 #; (f:fpu) ft0  <-- 14.142
; init_data (test_conflict.c:8)
...
; init_data (test_conflict.c:0)
;  in main (test_conflict.c:23)
      0x800008e8 fld     ft4, 0(t1)             #; ft4  <~~ Doub[0x80003378]
                                                #; (f:lsu) ft3  <-- 5.6568
      0x800008ec fld     ft5, 0(t2)             #; ft5  <~~ Doub[0x80003380], (f:lsu) ft4  <-- 7.071
      0x800008f0 fld     ft6, 0(t3)             #; ft6  <~~ Doub[0x80003388]
; init_data (test_conflict.c:9)
;  in main (test_conflict.c:23)
...
;  in main (test_conflict.c:23)
      ...
      0x80000924 csrci   ssr, 1                 #; (f:fpu) ft0  <-- 15.5562000
; init_data (test_conflict.c:8)
...
;  in main (test_conflict.c:24)
      ...
      0x80000a40 scfgwi  s0, 896                #; s0  = 0x001000a0
                                                #; (f:lsu) ft3  <-- 4.2426000
      0x80000a44 csrsi   ssr, 1                 #; (f:lsu) ft4  <-- 5.6568
; init_data (test_conflict.c:9)
;  in main (test_conflict.c:24)
      ...
      0x80000a4c fsgnj.d ft0, ft4, ft4          #; ft4  = 5.6568, ft4  = 5.6568, (f:fpu) ft0  <-- 4.2426000
                                                #; (f:fpu) ft0  <-- 5.6568
      0x80000a50 fld     ft3, 0(t1)             #; ft3  <~~ Doub[0x80003378]
; init_data (test_conflict.c:0)
;  in main (test_conflict.c:24)
      0x80000a54 fld     ft4, 0(t2)             #; ft4  <~~ Doub[0x80003380]
                                                #; (f:lsu) ft3  <-- 7.071
      0x80000a58 fld     ft5, 0(t3)             #; ft5  <~~ Doub[0x80003388], (f:lsu) ft4  <-- 8.4852000
...
;  in main (test_conflict.c:24)
      ...
      0x80000a98 csrci   ssr, 1                 #; (f:fpu) ft0  <-- 16.9704000
...
;  in main (test_conflict.c:26)
      0x80000b80 fld     ft0, 0(s2)             #; ft0  <~~ Doub[0x00100000]
      0x80000b84 fld     ft1, 0(s1)             #; ft1  <~~ Doub[0x00100050], (f:lsu) ft0  <-- 1.4142
      0x80000b88 fld     ft2, 0(s0)             #; ft2  <~~ Doub[0x001000a0], (f:lsu) ft1  <-- 2.8284
      0x80000b8c fadd.d  ft0, ft0, ft1          #; ft0  = 1.4142, ft1  = 2.8284, (f:lsu) ft2  <-- 0.0
                                                #; (f:fpu) ft0  <-- 4.2426000
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
      0x80000b94 li      a1, 1                  #; (wrb) a1  <-- 1
      0x80000b98 mv      a0, s0                 #; s0  = 0x001000a0, (wrb) a0  <-- 0x001000a0
      0x80000b90 fadd.d  fs0, ft0, ft2          #; ft0  = 4.2426000, ft2  = 0.0
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000ba4 fld     ft0, 8(s2)             #; ft0  <~~ Doub[0x00100008]
      0x80000ba8 fld     ft1, 8(s1)             #; ft1  <~~ Doub[0x00100058], (f:lsu) ft0  <-- 2.8284
      0x80000bac fld     ft2, 8(s0)             #; ft2  <~~ Doub[0x001000a8], (f:lsu) ft1  <-- 4.2426000
                                                #; (f:lsu) ft2  <-- 0.0
      0x80000bb0 fadd.d  ft0, ft0, fs0          #; ft0  = 2.8284, fs0  = 4.2426000
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000bb4 fadd.d  ft0, ft0, ft1          #; ft0  = 7.071, ft1  = 4.2426000
                                                #; (f:fpu) ft0  <-- 11.3136
      0x80000bb8 fadd.d  fs0, ft0, ft2          #; ft0  = 11.3136, ft2  = 0.0
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000bcc fld     ft0, 16(s2)            #; ft0  <~~ Doub[0x00100010]
                                                #; (f:lsu) ft0  <-- 4.2426000
      0x80000bd0 fld     ft1, 16(s1)            #; ft1  <~~ Doub[0x00100060]
      0x80000bd4 fld     ft2, 16(s0)            #; ft2  <~~ Doub[0x001000b0], (f:lsu) ft1  <-- 5.6568
      0x80000bd8 fadd.d  ft0, ft0, fs0          #; ft0  = 4.2426000, fs0  = 11.3136, (f:lsu) ft2  <-- 0.0
                                                #; (f:fpu) ft0  <-- 15.5562000
      0x80000bdc fadd.d  ft0, ft0, ft1          #; ft0  = 15.5562000, ft1  = 5.6568
                                                #; (f:fpu) ft0  <-- 21.2130000
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
      0x80000be4 li      a1, 3                  #; (wrb) a1  <-- 3
      0x80000be8 mv      a0, s0                 #; s0  = 0x001000a0, (wrb) a0  <-- 0x001000a0
      0x80000be0 fadd.d  fs0, ft0, ft2          #; ft0  = 21.2130000, ft2  = 0.0
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000bf4 fld     ft0, 24(s2)            #; ft0  <~~ Doub[0x00100018]
      0x80000bf8 fld     ft1, 24(s1)            #; ft1  <~~ Doub[0x00100068], (f:lsu) ft0  <-- 5.6568
      0x80000bfc fld     ft2, 24(s0)            #; ft2  <~~ Doub[0x001000b8], (f:lsu) ft1  <-- 7.071
      0x80000c00 fadd.d  ft0, ft0, fs0          #; ft0  = 5.6568, fs0  = 21.2130000, (f:lsu) ft2  <-- 0.0
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000c04 fadd.d  ft0, ft0, ft1          #; ft0  = 26.8698000, ft1  = 7.071
                                                #; (f:fpu) ft0  <-- 33.9408000
      0x80000c08 fadd.d  fs0, ft0, ft2          #; ft0  = 33.9408000, ft2  = 0.0
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000c1c fld     ft0, 32(s2)            #; ft0  <~~ Doub[0x00100020]
                                                #; (f:lsu) ft0  <-- 7.071
      0x80000c20 fld     ft1, 32(s1)            #; ft1  <~~ Doub[0x00100070]
      0x80000c24 fld     ft2, 32(s0)            #; ft2  <~~ Doub[0x001000c0], (f:lsu) ft1  <-- 8.4852000
      0x80000c28 fadd.d  ft0, ft0, fs0          #; ft0  = 7.071, fs0  = 33.9408000, (f:lsu) ft2  <-- 0.0
                                                #; (f:fpu) ft0  <-- 41.0118000
      0x80000c2c fadd.d  ft0, ft0, ft1          #; ft0  = 41.0118000, ft1  = 8.4852000
                                                #; (f:fpu) ft0  <-- 49.4970000
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
      0x80000c34 li      a1, 5                  #; (wrb) a1  <-- 5
      0x80000c38 mv      a0, s0                 #; s0  = 0x001000a0, (wrb) a0  <-- 0x001000a0
      0x80000c30 fadd.d  fs0, ft0, ft2          #; ft0  = 49.4970000, ft2  = 0.0
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000c44 fld     ft0, 40(s2)            #; ft0  <~~ Doub[0x00100028]
      0x80000c48 fld     ft1, 40(s1)            #; ft1  <~~ Doub[0x00100078], (f:lsu) ft0  <-- 8.4852000
      0x80000c4c fld     ft2, 40(s0)            #; ft2  <~~ Doub[0x001000c8], (f:lsu) ft1  <-- 9.8994
                                                #; (f:lsu) ft2  <-- 0.0
      0x80000c50 fadd.d  ft0, ft0, fs0          #; ft0  = 8.4852000, fs0  = 49.4970000
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000c54 fadd.d  ft0, ft0, ft1          #; ft0  = 57.9822000, ft1  = 9.8994
                                                #; (f:fpu) ft0  <-- 67.8816000
      0x80000c58 fadd.d  fs0, ft0, ft2          #; ft0  = 67.8816000, ft2  = 0.0
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000c6c fld     ft0, 48(s2)            #; ft0  <~~ Doub[0x00100030]
      0x80000c70 fld     ft1, 48(s1)            #; ft1  <~~ Doub[0x00100080], (f:lsu) ft0  <-- 9.8994
      0x80000c74 fld     ft2, 48(s0)            #; ft2  <~~ Doub[0x001000d0], (f:lsu) ft1  <-- 11.3136
      0x80000c78 fadd.d  ft0, ft0, fs0          #; ft0  = 9.8994, fs0  = 67.8816000, (f:lsu) ft2  <-- 0.0
                                                #; (f:fpu) ft0  <-- 77.7810000
      0x80000c7c fadd.d  ft0, ft0, ft1          #; ft0  = 77.7810000, ft1  = 11.3136
                                                #; (f:fpu) ft0  <-- 89.0946000
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
      0x80000c84 li      a1, 7                  #; (wrb) a1  <-- 7
      0x80000c88 mv      a0, s0                 #; s0  = 0x001000a0, (wrb) a0  <-- 0x001000a0
      0x80000c80 fadd.d  fs0, ft0, ft2          #; ft0  = 89.0946000, ft2  = 0.0
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000c94 fld     ft0, 56(s2)            #; ft0  <~~ Doub[0x00100038]
      0x80000c98 fld     ft1, 56(s1)            #; ft1  <~~ Doub[0x00100088], (f:lsu) ft0  <-- 11.3136
      0x80000c9c fld     ft2, 56(s0)            #; ft2  <~~ Doub[0x001000d8], (f:lsu) ft1  <-- 12.7278000
                                                #; (f:lsu) ft2  <-- 0.0
      0x80000ca0 fadd.d  ft0, ft0, fs0          #; ft0  = 11.3136, fs0  = 89.0946000
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000ca4 fadd.d  ft0, ft0, ft1          #; ft0  = 100.4082000, ft1  = 12.7278000
                                                #; (f:fpu) ft0  <-- 113.1360000
      0x80000ca8 fadd.d  fs0, ft0, ft2          #; ft0  = 113.1360000, ft2  = 0.0
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000cbc fld     ft0, 64(s2)            #; ft0  <~~ Doub[0x00100040]
                                                #; (f:lsu) ft0  <-- 12.7278000
      0x80000cc0 fld     ft1, 64(s1)            #; ft1  <~~ Doub[0x00100090]
      0x80000cc4 fld     ft2, 64(s0)            #; ft2  <~~ Doub[0x001000e0], (f:lsu) ft1  <-- 14.142
      0x80000cc8 fadd.d  ft0, ft0, fs0          #; ft0  = 12.7278000, fs0  = 113.1360000, (f:lsu) ft2  <-- 0.0
                                                #; (f:fpu) ft0  <-- 125.8638000
      0x80000ccc fadd.d  ft0, ft0, ft1          #; ft0  = 125.8638000, ft1  = 14.142
                                                #; (f:fpu) ft0  <-- 140.0058
; conflict (conflict.c:13)
;  in main (test_conflict.c:26)
      0x80000cd4 li      a1, 9                  #; (wrb) a1  <-- 9
      0x80000cd8 mv      a0, s0                 #; s0  = 0x001000a0, (wrb) a0  <-- 0x001000a0
      0x80000cd0 fadd.d  fs0, ft0, ft2          #; ft0  = 140.0058, ft2  = 0.0
...
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000ce4 fld     ft0, 72(s2)            #; ft0  <~~ Doub[0x00100048]
; conflict (conflict.c:0)
;  in main (test_conflict.c:26)
      0x80000cf0 auipc   a0, 0x2                #; (wrb) a0  <-- 0x80002cf0
      0x80000ce8 fld     ft1, 72(s1)            #; ft1  <~~ Doub[0x00100098], (f:lsu) ft0  <-- 14.142
      0x80000cf4 addi    a0, a0, 1736           #; a0  = 0x80002cf0, (wrb) a0  <-- 0x800033b8
      0x80000cec fld     ft2, 72(s0)            #; ft2  <~~ Doub[0x001000e8], (f:lsu) ft1  <-- 15.5562000
                                                #; (f:lsu) ft2  <-- 0.0
      0x80000cf8 fld     ft3, 0(a0)             #; ft3  <~~ Doub[0x800033b8]
; conflict (conflict.c:14)
;  in main (test_conflict.c:26)
      0x80000cfc fadd.d  ft0, ft0, fs0          #; ft0  = 14.142, fs0  = 140.0058
                                                #; (f:fpu) ft0  <-- 154.1478
                                                #; (f:lsu) ft3  <-- -169.704
      0x80000d00 fadd.d  ft0, ft0, ft1          #; ft0  = 154.1478, ft1  = 15.5562000
                                                #; (f:fpu) ft0  <-- 169.7040000
      0x80000d04 fadd.d  ft0, ft0, ft2          #; ft0  = 169.7040000, ft2  = 0.0
                                                #; (f:fpu) ft0  <-- 169.7040000
; main (test_conflict.c:29)
      0x80000d08 fadd.d  ft1, ft0, ft3          #; ft0  = 169.7040000, ft3  = -169.704
; main (test_conflict.c:32)
      0x80000d14 lw      a2, 0(sp)              #; sp  = 0x0011ff40, a2  <~~ Word[0x0011ff40]
                                                #; (f:fpu) ft1  <-- -0.0000000
; main (test_conflict.c:30)
      0x80000d0c fsgnjx.d fs0, ft1, ft1         #; ft1  = -0.0000000, ft1  = -0.0000000
; main (test_conflict.c:32)
      0x80000d10 fsd     ft0, 0(sp)             #; 169.7040000 ~~> Doub[0x0011ff40], (f:fpu) fs0  <-- 0.0000000
                                                #; (lsu) a2  <-- 0
