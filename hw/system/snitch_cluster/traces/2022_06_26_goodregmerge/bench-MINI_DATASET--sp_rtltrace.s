       ...
       0     7071        M                                           #; (lsu) a0  <-- 718
       0     7072        M 0x800011b8 bnez    a0, pc + 8             #; a0  = 718, taken, goto 0x800011c0
       0     7080        M 0x800011c0 seqz    a1, a0                 #; a0  = 718, (wrb) a1  <-- 0
       ...
       0     7116        M 0x8000121c divu    a3, a0, s8             #; a0  = 718, s8  = 10
       0     7128        M 0x80001220 mul     a4, a3, s8             #; a3  = 71, s8  = 10
       0     7131        M                                           #; (acc) a4  <-- 0x40e50733
       0     7132        M 0x80001224 sub     a4, a0, a4             #; a0  = 718, a4  = 710, (wrb) a4  <-- 8
       0     7133        M 0x80001228 andi    s1, a4, 254            #; a4  = 8, (wrb) s1  <-- 8
       ...
       0     7142        M 0x800011ec add     a4, a5, a4             #; a5  = 48, a4  = 8, (wrb) a4  <-- 56
       ...
       0     7157        M 0x800011fc sltu    a0, a0, s8             #; a0  = 718, s8  = 10, (wrb) a0  <-- 0
       ...
       0     7169        M 0x8000120c sb      a4, 0(s1)              #; s1  = 0x0011febc, 56 ~~> Byte[0x0011febc]
       0     7170        M 0x80001210 mv      a2, a5                 #; a5  = 1, (wrb) a2  <-- 1
       0     7171        M 0x80001214 mv      a0, a3                 #; a3  = 71, (wrb) a0  <-- 71
       0     7172        M 0x80001218 beqz    a1, pc + 180           #; a1  = 1, not taken
       0     7173        M 0x8000121c divu    a3, a0, s8             #; a0  = 71, s8  = 10
       0     7180        M                                           #; (acc) a4  <-- 0x03868733
       0     7181        M 0x80001220 mul     a4, a3, s8             #; a3  = 7, s8  = 10
       0     7184        M                                           #; (acc) a4  <-- 0x40e50733
       0     7185        M 0x80001224 sub     a4, a0, a4             #; a0  = 71, a4  = 70, (wrb) a4  <-- 1
       0     7186        M 0x80001228 andi    s1, a4, 254            #; a4  = 1, (wrb) s1  <-- 0
       0     7187        M 0x8000122c li      a5, 48                 #; (wrb) a5  <-- 48
       0     7188        M 0x80001230 li      a1, 10                 #; (wrb) a1  <-- 10
       0     7189        M 0x80001234 bltu    s1, a1, pc - 72        #; s1  = 0, a1  = 10, taken, goto 0x800011ec
       0     7190        M 0x800011ec add     a4, a5, a4             #; a5  = 48, a4  = 1, (wrb) a4  <-- 49
       ...
       0     7194        M 0x800011fc sltu    a0, a0, s8             #; a0  = 71, s8  = 10, (wrb) a0  <-- 0
       ...
       0     7198        M 0x8000120c sb      a4, 0(s1)              #; s1  = 0x0011febd, 49 ~~> Byte[0x0011febd]
       ...
       0     7687        M                                           #; (lsu) a0  <-- 49
       0     7689        M 0x80001410 beqz    a0, pc + 168           #; a0  = 49, not taken
       ...
       0     7712        M 0x8000143c sb      a0, 72(a4)             #; a4  = 0x80002e5e, 49 ~~> Byte[0x80002ea6]
       ...
       0     7737        M 0x8000144c addi    a0, a0, -10            #; a0  = 49, (wrb) a0  <-- 39
       0     7738        M 0x80001450 snez    a0, a0                 #; a0  = 39, (wrb) a0  <-- 1
       ...
       0     7759        M                                           #; (lsu) a0  <-- 56
       0     7761        M 0x80001410 beqz    a0, pc + 168           #; a0  = 56, not taken
       ...
       0     7784        M 0x8000143c sb      a0, 72(a4)             #; a4  = 0x80002e5f, 56 ~~> Byte[0x80002ea7]
       ...
       0     7809        M 0x8000144c addi    a0, a0, -10            #; a0  = 56, (wrb) a0  <-- 46
       0     7810        M 0x80001450 snez    a0, a0                 #; a0  = 46, (wrb) a0  <-- 1
