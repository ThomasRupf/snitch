...
/home/thomas/Documents/eth/ba/code/all/snitch/hw/system/snitch_cluster/sw/build/snBLAS/test-snBLAS-simple:	file format elf32-littleriscv

Sections:
Idx Name              Size     VMA      Type
  0                   00000000 00000000 
  1 .text             00002790 80000000 TEXT
  2 .init             00000468 80002790 TEXT
  3 .rodata           00000328 80002bf8 DATA
  4 .htif             00000048 80002f40 DATA
  5 .tdata            00000000 80002f88 DATA
  6 .tbss             00000010 80002f88 BSS
  7 .tbssend          00000000 80002f98 DATA
  8 .sdata            000000a8 80002f98 DATA
  9 .data             00000000 80003040 DATA
 10 .sbss             00000004 80003040 BSS
 11 .bss              00000010 80003044 BSS
 12 .dram             00000000 80003054 DATA
 13 .debug_info       000030d6 00000000 
 14 .debug_abbrev     00000b00 00000000 
 15 .debug_aranges    00000040 00000000 
 16 .debug_line       000029db 00000000 
 17 .debug_loc        00002777 00000000 
 18 .debug_ranges     000003b0 00000000 
 19 .debug_str        00000afe 00000000 
 20 .comment          00000029 00000000 
 21 .riscv.attributes 00000037 00000000 
 22 .debug_frame      000002c0 00000000 
 23 .symtab           00002f00 00000000 
 24 .shstrtab         000000ea 00000000 
 25 .strtab           000008c7 00000000 
...
80000658: 33 0a 45 00  	add	s4, a0, tp
8000065c: 03 25 0a 00  	lw	a0, 0(s4)
80000660: 03 25 05 00  	lw	a0, 0(a0)
80000664: 83 25 85 00  	lw	a1, 8(a0)
;     asm("csrr %0, mhartid" : "=r"(hartid));
80000668: f3 29 40 f1  	csrr	s3, mhartid

8000066c <.LBB0_18>:
8000066c: 17 39 00 00  	auipc	s2, 3
80000670: 13 09 89 9d  	addi	s2, s2, -1576
;     if (snrt_global_core_idx() == 0) {
80000674: 63 9a b9 16  	bne	s3, a1, 0x800007e8 <.LBB0_23+0x94>
;     return _snrt_team_current->root->cluster_mem;
80000678: 83 25 05 03  	lw	a1, 48(a0)
8000067c: 03 26 85 03  	lw	a2, 56(a0)
;     return _snrt_team_current->root->global_mem;
80000680: 83 26 05 02  	lw	a3, 32(a0)
80000684: 03 25 85 02  	lw	a0, 40(a0)
; static inline size_t snrt_slice_len(snrt_slice_t s) { return s.end - s.start; }
80000688: b3 05 b6 40  	sub	a1, a2, a1
8000068c: 33 05 d5 40  	sub	a0, a0, a3
;                size_cluster / 1024, size_global / 1024);
80000690: 93 d5 a5 00  	srli	a1, a1, 10
80000694: 13 56 a5 00  	srli	a2, a0, 10

80000698 <.LBB0_19>:
;         printf("Available memory: %d KiB cluster, %d KiB global\n",
80000698: 17 25 00 00  	auipc	a0, 2
8000069c: 13 05 d5 56  	addi	a0, a0, 1389
800006a0: 97 00 00 00  	auipc	ra, 0
800006a4: e7 80 c0 39  	jalr	924(ra)
; uint32_t snrt_cluster_num() { return _snrt_team_current->root->cluster_num; }
800006a8: 03 25 0a 00  	lw	a0, 0(s4)
800006ac: 03 25 05 00  	lw	a0, 0(a0)
800006b0: 03 25 45 01  	lw	a0, 20(a0)
800006b4: 93 05 20 00  	addi	a1, zero, 2
;         if (snrt_cluster_num() > 1) {
800006b8: 63 6a b5 02  	bltu	a0, a1, 0x800006ec <.LBB0_21>

800006bc <.LBB0_20>:
;             printf("Preparing data in global memory\n");
800006bc: 17 25 00 00  	auipc	a0, 2
800006c0: 13 05 25 59  	addi	a0, a0, 1426
800006c4: 97 00 00 00  	auipc	ra, 0
800006c8: e7 80 80 37  	jalr	888(ra)
;     return _snrt_team_current->root->global_mem;
800006cc: 37 05 00 00  	lui	a0, 0
800006d0: b3 0a 45 00  	add	s5, a0, tp
800006d4: 03 a5 0a 00  	lw	a0, 0(s5)
800006d8: 03 25 05 00  	lw	a0, 0(a0)
800006dc: 83 25 05 02  	lw	a1, 32(a0)
;     return _snrt_team_current->root->global_core_num;
800006e0: 03 26 c5 00  	lw	a2, 12(a0)
;     return _snrt_team_current->root->global_mem;
800006e4: 03 25 85 02  	lw	a0, 40(a0)
800006e8: 6f 00 00 03  	j	0x80000718 <.LBB0_21+0x2c>

800006ec <.LBB0_21>:
;             printf("Preparing data in cluster memory\n");
800006ec: 17 25 00 00  	auipc	a0, 2
800006f0: 13 05 85 5e  	addi	a0, a0, 1512
800006f4: 97 00 00 00  	auipc	ra, 0
800006f8: e7 80 80 34  	jalr	840(ra)
;     return _snrt_team_current->root->cluster_mem;
800006fc: 37 05 00 00  	lui	a0, 0
80000700: b3 0a 45 00  	add	s5, a0, tp
80000704: 03 a5 0a 00  	lw	a0, 0(s5)
80000708: 03 25 05 00  	lw	a0, 0(a0)
8000070c: 83 25 05 03  	lw	a1, 48(a0)
;     return _snrt_team_current->root->global_core_num;
80000710: 03 26 c5 00  	lw	a2, 12(a0)
;     return _snrt_team_current->root->cluster_mem;
80000714: 03 25 85 03  	lw	a0, 56(a0)
80000718: 93 06 80 3e  	addi	a3, zero, 1000
8000071c: 33 04 d6 02  	mul	s0, a2, a3
80000720: 33 05 b5 40  	sub	a0, a0, a1
80000724: b7 b5 aa aa  	lui	a1, 699051
80000728: 93 85 b5 aa  	addi	a1, a1, -1365
8000072c: 33 35 b5 02  	mulhu	a0, a0, a1
80000730: 93 54 45 00  	srli	s1, a0, 4

80000734 <.LBB0_22>:
80000734: 17 25 00 00  	auipc	a0, 2
80000738: 13 05 25 5c  	addi	a0, a0, 1474
8000073c: 93 05 04 00  	mv	a1, s0
80000740: 13 86 04 00  	mv	a2, s1
80000744: 97 00 00 00  	auipc	ra, 0
80000748: e7 80 80 2f  	jalr	760(ra)
8000074c: 63 64 94 00  	bltu	s0, s1, 0x80000754 <.LBB0_23>
80000750: 13 84 04 00  	mv	s0, s1

80000754 <.LBB0_23>:
80000754: 17 25 00 00  	auipc	a0, 2
80000758: 13 05 25 4e  	addi	a0, a0, 1250
8000075c: 93 05 04 00  	mv	a1, s0
80000760: 97 00 00 00  	auipc	ra, 0
80000764: e7 80 c0 2d  	jalr	732(ra)
80000768: 03 a5 0a 00  	lw	a0, 0(s5)
8000076c: 83 26 05 00  	lw	a3, 0(a0)
80000770: 83 a5 86 05  	lw	a1, 88(a3)
80000774: 03 a5 06 05  	lw	a0, 80(a3)
80000778: 03 a7 46 05  	lw	a4, 84(a3)
8000077c: 93 17 34 00  	slli	a5, s0, 3
80000780: 33 86 f5 00  	add	a2, a1, a5
80000784: 33 07 a7 00  	add	a4, a4, a0
80000788: 63 76 c7 02  	bgeu	a4, a2, 0x800007b4 <.LBB0_23+0x60>
8000078c: 13 05 00 00  	mv	a0, zero
80000790: 93 04 06 00  	mv	s1, a2
80000794: 63 6a 97 02  	bltu	a4, s1, 0x800007c8 <.LBB0_23+0x74>
80000798: 13 86 05 00  	mv	a2, a1
8000079c: 23 ac 96 04  	sw	s1, 88(a3)
800007a0: b3 87 f4 00  	add	a5, s1, a5
800007a4: 93 85 04 00  	mv	a1, s1
800007a8: 63 66 f7 02  	bltu	a4, a5, 0x800007d4 <.LBB0_23+0x80>
800007ac: 23 ac f6 04  	sw	a5, 88(a3)
800007b0: 6f 00 80 02  	j	0x800007d8 <.LBB0_23+0x84>
800007b4: 13 85 05 00  	mv	a0, a1
800007b8: 23 ac c6 04  	sw	a2, 88(a3)
800007bc: b3 04 f6 00  	add	s1, a2, a5
800007c0: 93 05 06 00  	mv	a1, a2
800007c4: e3 7a 97 fc  	bgeu	a4, s1, 0x80000798 <.LBB0_23+0x44>
800007c8: 13 06 00 00  	mv	a2, zero
800007cc: 93 87 04 00  	mv	a5, s1
800007d0: e3 7e f7 fc  	bgeu	a4, a5, 0x800007ac <.LBB0_23+0x58>
800007d4: 93 05 00 00  	mv	a1, zero
800007d8: 23 20 89 00  	sw	s0, 0(s2)
800007dc: 23 22 a9 00  	sw	a0, 4(s2)
800007e0: 23 24 c9 00  	sw	a2, 8(s2)
800007e4: 23 26 b9 00  	sw	a1, 12(s2)
; void snrt_cluster_hw_barrier() { _snrt_cluster_barrier(); }
800007e8: 97 20 00 00  	auipc	ra, 2
800007ec: e7 80 80 3a  	jalr	936(ra)
;     return snrt_hartid() - _snrt_team_current->root->global_core_base_hartid;
800007f0: 03 25 0a 00  	lw	a0, 0(s4)
800007f4: 03 25 05 00  	lw	a0, 0(a0)
800007f8: 83 25 85 00  	lw	a1, 8(a0)
;     return _snrt_team_current->root->global_core_num;
800007fc: 03 26 c5 00  	lw	a2, 12(a0)
; uint32_t snrt_cluster_idx() { return _snrt_team_current->root->cluster_idx; }
80000800: 83 26 05 01  	lw	a3, 16(a0)
; uint32_t snrt_cluster_num() { return _snrt_team_current->root->cluster_num; }
80000804: 03 27 45 01  	lw	a4, 20(a0)
;            snrt_cluster_num(), data.n, data.x, data.y, data.yo);
80000808: 83 27 09 00  	lw	a5, 0(s2)
8000080c: 03 28 49 00  	lw	a6, 4(s2)
80000810: 83 28 89 00  	lw	a7, 8(s2)
80000814: 83 24 c9 00  	lw	s1, 12(s2)
;     return snrt_hartid() - _snrt_team_current->root->global_core_base_hartid;
80000818: b3 85 b9 40  	sub	a1, s3, a1

8000081c <.LBB0_24>:
;     printf("Core %d/%d (cluster %d/%d) works on %d items in %p, %p, %p\n",
8000081c: 17 25 00 00  	auipc	a0, 2
80000820: 13 05 35 45  	addi	a0, a0, 1107
80000824: 23 20 91 00  	sw	s1, 0(sp)
80000828: 97 00 00 00  	auipc	ra, 0
8000082c: e7 80 40 21  	jalr	532(ra)
;     return snrt_hartid() - _snrt_team_current->root->global_core_base_hartid;
80000830: 03 25 0a 00  	lw	a0, 0(s4)
80000834: 03 25 05 00  	lw	a0, 0(a0)
80000838: 83 25 85 00  	lw	a1, 8(a0)
;     size_t lo = (snrt_global_core_idx() + 0) * data->n / snrt_global_core_num();
8000083c: 83 26 09 00  	lw	a3, 0(s2)
;     return _snrt_team_current->root->global_core_num;
80000840: 03 26 c5 00  	lw	a2, 12(a0)
;     return snrt_hartid() - _snrt_team_current->root->global_core_base_hartid;
80000844: b3 85 b9 40  	sub	a1, s3, a1
;     size_t lo = (snrt_global_core_idx() + 0) * data->n / snrt_global_core_num();
80000848: 33 85 b6 02  	mul	a0, a3, a1
8000084c: 33 54 c5 02  	divu	s0, a0, a2
;     size_t hi = (snrt_global_core_idx() + 1) * data->n / snrt_global_core_num();
80000850: 13 85 15 00  	addi	a0, a1, 1
80000854: 33 05 d5 02  	mul	a0, a0, a3
80000858: b3 54 c5 02  	divu	s1, a0, a2

8000085c <.LBB0_25>:
;     printf("Core %d/%d populating from %d to %d\n", snrt_global_core_idx(),
8000085c: 17 25 00 00  	auipc	a0, 2
80000860: 13 05 f5 44  	addi	a0, a0, 1103
80000864: 93 06 04 00  	mv	a3, s0
80000868: 13 87 04 00  	mv	a4, s1
8000086c: 97 00 00 00  	auipc	ra, 0
80000870: e7 80 00 1d  	jalr	464(ra)
80000874: 63 7c 94 02  	bgeu	s0, s1, 0x800008ac <.LBB0_25+0x50>
80000878: 03 25 49 00  	lw	a0, 4(s2)
8000087c: 83 25 89 00  	lw	a1, 8(s2)
;         data->x[i] = i;
80000880: 53 00 14 d2  	fcvt.d.wu	ft0, s0
80000884: 13 16 34 00  	slli	a2, s0, 3
80000888: b3 06 c5 00  	add	a3, a0, a2
8000088c: 27 b0 06 00  	fsd	ft0, 0(a3)
;         data->y[i] = i * 3;
80000890: 93 16 14 00  	slli	a3, s0, 1
80000894: b3 86 86 00  	add	a3, a3, s0
80000898: 53 80 16 d2  	fcvt.d.wu	ft0, a3
8000089c: 33 86 c5 00  	add	a2, a1, a2
;     for (size_t i = lo; i < hi; i++) {
800008a0: 13 04 14 00  	addi	s0, s0, 1
;         data->y[i] = i * 3;
800008a4: 27 30 06 00  	fsd	ft0, 0(a2)
800008a8: e3 1c 94 fc  	bne	s0, s1, 0x80000880 <.LBB0_25+0x24>
;     return 0;
800008ac: 13 05 00 00  	mv	a0, zero
800008b0: 83 2a 41 00  	lw	s5, 4(sp)
800008b4: 03 2a 81 00  	lw	s4, 8(sp)
800008b8: 83 29 c1 00  	lw	s3, 12(sp)
800008bc: 03 29 01 01  	lw	s2, 16(sp)
800008c0: 83 24 41 01  	lw	s1, 20(sp)
800008c4: 03 24 81 01  	lw	s0, 24(sp)
800008c8: 83 20 c1 01  	lw	ra, 28(sp)
800008cc: 13 01 01 02  	addi	sp, sp, 32
800008d0: 67 80 00 00  	ret

800008d4 <_snrt_init_team>:
;     team->base.root = team;
800008d4: 23 a0 f7 00  	sw	a5, 0(a5)
;     team->bootdata = (void *)bootdata;
800008d8: 23 a2 e7 00  	sw	a4, 4(a5)
;     team->global_core_base_hartid = bootdata->hartid_base;
800008dc: 03 23 87 00  	lw	t1, 8(a4)
800008e0: 23 a4 67 00  	sw	t1, 8(a5)
;     team->global_core_num = bootdata->core_count * bootdata->cluster_count *
800008e4: 03 28 87 02  	lw	a6, 40(a4)
;                             bootdata->s1_quadrant_count;
800008e8: 83 28 c7 02  	lw	a7, 44(a4)
;     team->global_core_num = bootdata->core_count * bootdata->cluster_count *
800008ec: 83 22 47 00  	lw	t0, 4(a4)
800008f0: 33 88 08 03  	mul	a6, a7, a6
800008f4: 33 05 58 02  	mul	a0, a6, t0
800008f8: 23 a6 a7 00  	sw	a0, 12(a5)
;     asm("csrr %0, mhartid" : "=r"(hartid));
800008fc: f3 28 40 f1  	csrr	a7, mhartid
;         (snrt_hartid() - bootdata->hartid_base) / bootdata->core_count;
80000900: 33 85 68 40  	sub	a0, a7, t1
80000904: 33 55 55 02  	divu	a0, a0, t0
;     team->cluster_idx =
80000908: 23 a8 a7 00  	sw	a0, 16(a5)
;     team->cluster_num = bootdata->cluster_count * bootdata->s1_quadrant_count;
8000090c: 23 aa 07 01  	sw	a6, 20(a5)
;     team->cluster_core_base_hartid = bootdata->hartid_base;
80000910: 23 ac 67 00  	sw	t1, 24(a5)
;     team->cluster_core_num = cluster_core_num;
80000914: 23 ae b7 00  	sw	a1, 28(a5)
;         (uint64_t)(bootdata->global_mem_start + _snrt_cluster_global_offset);
80000918: 03 25 87 01  	lw	a0, 24(a4)
8000091c: b7 05 00 10  	lui	a1, 65536
80000920: 33 05 b5 00  	add	a0, a0, a1
;     team->global_mem.start =
80000924: 23 a2 07 02  	sw	zero, 36(a5)
80000928: 23 a0 a7 02  	sw	a0, 32(a5)
;     team->global_mem.end = (uint64_t)bootdata->global_mem_end;
8000092c: 03 25 07 02  	lw	a0, 32(a4)
80000930: 83 25 47 02  	lw	a1, 36(a4)
80000934: 23 a4 a7 02  	sw	a0, 40(a5)
80000938: 23 a6 b7 02  	sw	a1, 44(a5)
;     team->cluster_mem.start = (uint64_t)spm_start;
8000093c: 23 a8 c7 02  	sw	a2, 48(a5)
80000940: 23 aa 07 02  	sw	zero, 52(a5)
;     team->cluster_mem.end = (uint64_t)spm_end;
80000944: 23 ac d7 02  	sw	a3, 56(a5)
80000948: 23 ae 07 02  	sw	zero, 60(a5)
;     team->barrier_reg_ptr = (uint32_t)spm_start + bootdata->tcdm_size +
8000094c: 03 25 07 01  	lw	a0, 16(a4)
80000950: 33 08 a6 00  	add	a6, a2, a0
80000954: 93 05 08 19  	addi	a1, a6, 400
80000958: 23 a8 b7 06  	sw	a1, 112(a5)
;         (uint64_t)spm_start + bootdata->tcdm_size + bootdata->tcdm_size / 2;
8000095c: b3 32 a8 00  	sltu	t0, a6, a0
80000960: 93 55 15 00  	srli	a1, a0, 1
80000964: 33 03 b8 00  	add	t1, a6, a1
80000968: b3 35 03 01  	sltu	a1, t1, a6
8000096c: b3 85 b2 00  	add	a1, t0, a1
;     team->zero_mem.start =
80000970: 23 a0 67 04  	sw	t1, 64(a5)
80000974: 23 a2 b7 04  	sw	a1, 68(a5)
;     team->zero_mem.end = (uint64_t)spm_start + 2 * bootdata->tcdm_size;
80000978: 13 15 15 00  	slli	a0, a0, 1
8000097c: b3 05 c5 00  	add	a1, a0, a2
80000980: 33 b5 a5 00  	sltu	a0, a1, a0
80000984: 23 a4 b7 04  	sw	a1, 72(a5)
80000988: 23 a6 a7 04  	sw	a0, 76(a5)
;     team->cluster_barrier.barrier = 0;
8000098c: 23 a4 07 06  	sw	zero, 104(a5)
;     team->cluster_barrier.barrier_iteration = 0;
80000990: 23 a6 07 06  	sw	zero, 108(a5)
;     _snrt_team_current = &team->base;
80000994: 37 05 00 00  	lui	a0, 0
80000998: 33 05 45 00  	add	a0, a0, tp
8000099c: 23 20 f5 00  	sw	a5, 0(a0)
;         (snrt_hartid() - _snrt_team_current->root->cluster_core_base_hartid) %
800009a0: 03 a5 07 00  	lw	a0, 0(a5)
800009a4: 83 25 85 01  	lw	a1, 24(a0)
;         _snrt_team_current->root->cluster_core_num;
800009a8: 03 25 c5 01  	lw	a0, 28(a0)
;         (snrt_hartid() - _snrt_team_current->root->cluster_core_base_hartid) %
800009ac: b3 85 b8 40  	sub	a1, a7, a1
800009b0: 33 f5 a5 02  	remu	a0, a1, a0
;     _snrt_core_idx =
800009b4: b7 05 00 00  	lui	a1, 0
800009b8: b3 85 45 00  	add	a1, a1, tp
800009bc: 23 a2 a5 00  	sw	a0, 4(a1)
800009c0: 13 05 80 44  	addi	a0, zero, 1096
;     putc_buffer[snrt_hartid()].hdr.size = 0;
800009c4: 33 85 a8 02  	mul	a0, a7, a0

800009c8 <.LBB0_1>:
800009c8: 97 25 00 00  	auipc	a1, 2
800009cc: 93 85 c5 68  	addi	a1, a1, 1676
800009d0: 33 05 b5 00  	add	a0, a0, a1
800009d4: 23 20 05 00  	sw	zero, 0(a0)
;     team->peripherals.clint = (uint32_t *)bootdata->clint_base;
800009d8: 83 28 07 03  	lw	a7, 48(a4)
800009dc: 23 aa 17 07  	sw	a7, 116(a5)
;     team->peripherals.perf_counters =
800009e0: 23 ae 07 07  	sw	a6, 124(a5)
;     team->peripherals.wakeup = (uint32_t *)0;  // not supported in RTL anymore
800009e4: 23 ac 07 06  	sw	zero, 120(a5)
;         (uint32_t *)(spm_start + bootdata->tcdm_size +
800009e8: 13 07 08 18  	addi	a4, a6, 384
;     team->peripherals.cl_clint =
800009ec: 23 a0 e7 08  	sw	a4, 128(a5)
;         ALIGN_UP((uint32_t)team->cluster_mem.start, MIN_CHUNK_SIZE);
800009f0: 13 05 76 00  	addi	a0, a2, 7
800009f4: 13 75 85 ff  	andi	a0, a0, -8
;     team->allocator.l1.base =
800009f8: 23 a8 a7 04  	sw	a0, 80(a5)
;         (uint32_t)(team->cluster_mem.end - team->cluster_mem.start);
800009fc: 33 86 c6 40  	sub	a2, a3, a2
;     team->allocator.l1.size =
80000a00: 23 aa c7 04  	sw	a2, 84(a5)
;     team->allocator.l1.next = team->allocator.l1.base;
80000a04: 23 ac a7 04  	sw	a0, 88(a5)
;         ALIGN_UP((uint32_t)_edram + l3off, MIN_CHUNK_SIZE);
80000a08: 03 a5 05 00  	lw	a0, 0(a1)
80000a0c: 13 05 f5 44  	addi	a0, a0, 1103
80000a10: 13 75 85 ff  	andi	a0, a0, -8
;     team->allocator.l3.base =
80000a14: 23 ae a7 04  	sw	a0, 92(a5)
;     team->allocator.l3.size = 0;
80000a18: 23 a0 07 06  	sw	zero, 96(a5)
;     team->allocator.l3.next = team->allocator.l3.base;
80000a1c: 23 a2 a7 06  	sw	a0, 100(a5)
;     clint_p = team->peripherals.clint;
80000a20: 37 05 00 00  	lui	a0, 0
80000a24: 33 05 45 00  	add	a0, a0, tp
80000a28: 23 24 15 01  	sw	a7, 8(a0)
;     cl_clint_p = team->peripherals.cl_clint;
80000a2c: 37 05 00 00  	lui	a0, 0
80000a30: 33 05 45 00  	add	a0, a0, tp
80000a34: 23 26 e5 00  	sw	a4, 12(a0)
; }
...
80000a98 <_vsnprintf.llvm.11632292163828655644>:
; {
...
80000b88: 13 06 06 19  	addi	a2, a2, 400
...
80000cd0: 13 06 c6 08  	addi	a2, a2, 140
...
80000d3c: 13 06 86 04  	addi	a2, a2, 72
...
80001690 <_out_char.llvm.11632292163828655644>:
;   if (character) {
...
800016a4: 93 86 46 9b  	addi	a3, a3, -1612
...
80001718: 13 05 c5 82  	addi	a0, a0, -2004
8000171c: 23 20 d5 00  	sw	a3, 0(a0)

80001720 <.LBB2_8>:
80001720: 17 25 00 00  	auipc	a0, 2
80001724: 13 05 05 86  	addi	a0, a0, -1952
;         while (fromhost == 0)
...
80001784: 93 84 84 81  	addi	s1, s1, -2024
...
800018a0: 13 05 45 70  	addi	a0, a0, 1796
...
80001920: 13 0c 4c 3b  	addi	s8, s8, 948
...
80001a44: 93 85 05 49  	addi	a1, a1, 1168
...
80001a64: 13 05 85 55  	addi	a0, a0, 1368
...
80001e5c: 93 84 84 16  	addi	s1, s1, 360
80001e60: 87 b0 04 00  	fld	ft1, 0(s1)

80001e64 <.LBB5_44>:
80001e64: 97 14 00 00  	auipc	s1, 1
80001e68: 93 84 44 16  	addi	s1, s1, 356
...
80001f48: 93 85 c5 08  	addi	a1, a1, 140
80001f4c: 07 b1 05 00  	fld	ft2, 0(a1)

80001f50 <.LBB5_46>:
80001f50: 97 15 00 00  	auipc	a1, 1
80001f54: 93 85 85 08  	addi	a1, a1, 136
...
80001fa4: 13 06 86 05  	addi	a2, a2, 88
80001fa8: 87 31 06 00  	fld	ft3, 0(a2)

80001fac <.LBB5_51>:
80001fac: 17 16 00 00  	auipc	a2, 1
80001fb0: 13 06 46 05  	addi	a2, a2, 84
...
80001fe0: 13 06 46 03  	addi	a2, a2, 52
80001fe4: 87 31 06 00  	fld	ft3, 0(a2)

80001fe8 <.LBB5_53>:
80001fe8: 17 16 00 00  	auipc	a2, 1
80001fec: 13 06 06 03  	addi	a2, a2, 48
...
80001ffc: 13 06 06 01  	addi	a2, a2, 16
...
8000200c: 13 06 86 01  	addi	a2, a2, 24
...
80002040: 93 86 c6 fe  	addi	a3, a3, -20
...
80002074: 93 85 05 fc  	addi	a1, a1, -64
80002078: 07 b1 05 00  	fld	ft2, 0(a1)

8000207c <.LBB5_58>:
8000207c: 97 15 00 00  	auipc	a1, 1
80002080: 93 85 c5 fb  	addi	a1, a1, -68
...
80002690 <snrt_global_core_idx>:
;     return snrt_hartid() - _snrt_team_current->root->global_core_base_hartid;
80002690: 37 05 00 00  	lui	a0, 0
80002694: 33 05 45 00  	add	a0, a0, tp
80002698: 03 25 05 00  	lw	a0, 0(a0)
8000269c: 03 25 05 00  	lw	a0, 0(a0)
800026a0: 03 25 85 00  	lw	a0, 8(a0)
;     asm("csrr %0, mhartid" : "=r"(hartid));
800026a4: f3 25 40 f1  	csrr	a1, mhartid
;     return snrt_hartid() - _snrt_team_current->root->global_core_base_hartid;
800026a8: 33 85 a5 40  	sub	a0, a1, a0
800026ac: 67 80 00 00  	ret

800026b0 <_snrt_barrier_reg_ptr>:
;     return _snrt_team_current->root->barrier_reg_ptr;
800026b0: 37 05 00 00  	lui	a0, 0
800026b4: 33 05 45 00  	add	a0, a0, tp
800026b8: 03 25 05 00  	lw	a0, 0(a0)
800026bc: 03 25 05 00  	lw	a0, 0(a0)
800026c0: 03 25 05 07  	lw	a0, 112(a0)
800026c4: 67 80 00 00  	ret

800026c8 <__snrt_isr>:
;     uint32_t cause = read_csr(mcause);
800026c8: 73 25 20 34  	csrr	a0, mcause
;     if (cause & MCAUSE_INTERRUPT) {
800026cc: 63 44 05 00  	bltz	a0, 0x800026d4 <__snrt_isr+0xc>
;         while (1)
800026d0: 6f 00 00 00  	j	0x800026d0 <__snrt_isr+0x8>
800026d4: b7 05 00 80  	lui	a1, 524288
800026d8: 93 85 f5 ff  	addi	a1, a1, -1
;         switch (cause & ~MCAUSE_INTERRUPT) {
800026dc: 33 75 b5 00  	and	a0, a0, a1
800026e0: 13 05 d5 ff  	addi	a0, a0, -3
800026e4: 93 55 25 00  	srli	a1, a0, 2
800026e8: 13 15 e5 01  	slli	a0, a0, 30
800026ec: 33 65 b5 00  	or	a0, a0, a1
800026f0: 93 05 40 00  	addi	a1, zero, 4
800026f4: 63 0a b5 06  	beq	a0, a1, 0x80002768 <.LBB1_7+0x58>
800026f8: 63 1a 05 08  	bnez	a0, 0x8000278c <.LBB1_7+0x7c>
...
8000270c: f3 25 40 f1  	csrr	a1, mhartid

80002710 <.LBB1_7>:
;     asm volatile(
80002710: 17 16 00 00  	auipc	a2, 1
80002714: 13 06 06 93  	addi	a2, a2, -1744
80002718: 03 25 85 00  	lw	a0, 8(a0)
;     asm volatile(
8000271c: 93 06 06 00  	mv	a3, a2
80002720: 93 02 10 00  	addi	t0, zero, 1
80002724: af a2 56 0c  	amoswap.w.aq	t0, t0, (a3)
80002728: e3 9e 02 fe  	bnez	t0, 0x80002724 <.LBB1_7+0x14>
;     *(clint_p + ((hartid & ~0x1f) >> 5)) &= ~(1 << (hartid & 0x1f));
8000272c: b7 06 00 00  	lui	a3, 0
80002730: b3 86 46 00  	add	a3, a3, tp
80002734: 83 a6 86 00  	lw	a3, 8(a3)
80002738: 33 85 a5 40  	sub	a0, a1, a0
8000273c: 93 55 35 00  	srli	a1, a0, 3
80002740: 93 f5 c5 ff  	andi	a1, a1, -4
80002744: b3 85 b6 00  	add	a1, a3, a1
80002748: 83 a6 05 00  	lw	a3, 0(a1)
8000274c: 13 07 10 00  	addi	a4, zero, 1
80002750: 33 15 a7 00  	sll	a0, a4, a0
80002754: 13 45 f5 ff  	not	a0, a0
80002758: 33 f5 a6 00  	and	a0, a3, a0
8000275c: 23 a0 a5 00  	sw	a0, 0(a1)
;     asm volatile("amoswap.w.rl  x0,x0,(%0)   # Release lock by storing 0\n"
80002760: 2f 20 06 0a  	amoswap.w.rl	zero, zero, (a2)
; }
80002764: 67 80 00 00  	ret
; uint32_t snrt_cluster_core_idx() { return _snrt_core_idx; }
80002768: 37 05 00 00  	lui	a0, 0
8000276c: 33 05 45 00  	add	a0, a0, tp
80002770: 03 25 45 00  	lw	a0, 4(a0)
; void snrt_int_cluster_clr(uint32_t mask) { cl_clint_clr(mask); }
80002774: b7 05 00 00  	lui	a1, 0
80002778: b3 85 45 00  	add	a1, a1, tp
8000277c: 83 a5 c5 00  	lw	a1, 12(a1)
80002780: 13 06 10 00  	addi	a2, zero, 1
;     snrt_int_cluster_clr(1 << cluster_core_idx);
80002784: 33 15 a6 00  	sll	a0, a2, a0
; void snrt_int_cluster_clr(uint32_t mask) { cl_clint_clr(mask); }
80002788: 23 a4 a5 00  	sw	a0, 8(a1)
; }
8000278c: 67 80 00 00  	ret

Disassembly of section .init:

80002790 <snrt.crt0.init_global_pointer>:
; 1:  auipc     gp, %pcrel_hi(__global_pointer$)
80002790: 97 11 00 00  	auipc	gp, 1
;     addi      gp, gp, %pcrel_lo(1b)
80002794: 93 81 81 ff  	addi	gp, gp, -8

80002798 <snrt.crt0.init_core_info>:
;     call      _snrt_init_core_info
80002798: 97 00 00 00  	auipc	ra, 0
8000279c: e7 80 40 3c  	jalr	964(ra)

800027a0 <snrt.crt0.init_bss>:
;     mv        s0, a0 # store a0 in s0 since we dont have a stack yet
800027a0: 13 04 05 00  	mv	s0, a0
;     mv        a0, a4
800027a4: 13 05 07 00  	mv	a0, a4
;     call      _snrt_get_base_hartid
800027a8: 97 00 00 00  	auipc	ra, 0
800027ac: e7 80 c0 40  	jalr	1036(ra)
;     mv        t0, a0
800027b0: 93 02 05 00  	mv	t0, a0
;     mv        a0, s0
800027b4: 13 05 04 00  	mv	a0, s0
;     csrr      t1, mhartid
800027b8: 73 23 40 f1  	csrr	t1, mhartid
;     sub       t0, t1, t0
800027bc: b3 02 53 40  	sub	t0, t1, t0
;     bnez      t0, 2f
800027c0: 63 92 02 02  	bnez	t0, 0x800027e4 <snrt.crt0.init_registers>

800027c4 <.Lpcrel_hi0>:
;     la        t0, _edata
800027c4: 97 12 00 00  	auipc	t0, 1
800027c8: 93 82 c2 87  	addi	t0, t0, -1924

800027cc <.Lpcrel_hi1>:
;     la        t1, _end
800027cc: 17 13 00 00  	auipc	t1, 1
800027d0: 13 03 83 88  	addi	t1, t1, -1912
;     bge       t0, t1, 2f
800027d4: 63 d8 62 00  	bge	t0, t1, 0x800027e4 <snrt.crt0.init_registers>
; 1:  sw        zero, 0(t0)
800027d8: 23 a0 02 00  	sw	zero, 0(t0)
;     addi      t0, t0, 4
800027dc: 93 82 42 00  	addi	t0, t0, 4
;     blt       t0, t1, 1b
800027e0: e3 cc 62 fe  	blt	t0, t1, 0x800027d8 <.Lpcrel_hi1+0xc>

800027e4 <snrt.crt0.init_registers>:
;     csrr    t0, misa
800027e4: f3 22 10 30  	csrr	t0, misa
;     andi    t0, t0, (1 << 3) | (1 << 5) # D/F - single/double precision float extension
800027e8: 93 f2 82 02  	andi	t0, t0, 40
;     beqz    t0, 3f
800027ec: 63 82 02 08  	beqz	t0, 0x80002870 <snrt.crt0.init_stack>
;     fcvt.d.w f0, zero
800027f0: 53 00 00 d2  	fcvt.d.w	ft0, zero
;     fcvt.d.w f1, zero
800027f4: d3 00 00 d2  	fcvt.d.w	ft1, zero
;     fcvt.d.w f2, zero
800027f8: 53 01 00 d2  	fcvt.d.w	ft2, zero
;     fcvt.d.w f3, zero
800027fc: d3 01 00 d2  	fcvt.d.w	ft3, zero
;     fcvt.d.w f4, zero
80002800: 53 02 00 d2  	fcvt.d.w	ft4, zero
;     fcvt.d.w f5, zero
80002804: d3 02 00 d2  	fcvt.d.w	ft5, zero
;     fcvt.d.w f6, zero
80002808: 53 03 00 d2  	fcvt.d.w	ft6, zero
;     fcvt.d.w f7, zero
8000280c: d3 03 00 d2  	fcvt.d.w	ft7, zero
;     fcvt.d.w f8, zero
80002810: 53 04 00 d2  	fcvt.d.w	fs0, zero
;     fcvt.d.w f9, zero
80002814: d3 04 00 d2  	fcvt.d.w	fs1, zero
;     fcvt.d.w f10, zero
80002818: 53 05 00 d2  	fcvt.d.w	fa0, zero
;     fcvt.d.w f11, zero
8000281c: d3 05 00 d2  	fcvt.d.w	fa1, zero
;     fcvt.d.w f12, zero
80002820: 53 06 00 d2  	fcvt.d.w	fa2, zero
;     fcvt.d.w f13, zero
80002824: d3 06 00 d2  	fcvt.d.w	fa3, zero
;     fcvt.d.w f14, zero
80002828: 53 07 00 d2  	fcvt.d.w	fa4, zero
;     fcvt.d.w f15, zero
8000282c: d3 07 00 d2  	fcvt.d.w	fa5, zero
;     fcvt.d.w f16, zero
80002830: 53 08 00 d2  	fcvt.d.w	fa6, zero
;     fcvt.d.w f17, zero
80002834: d3 08 00 d2  	fcvt.d.w	fa7, zero
;     fcvt.d.w f18, zero
80002838: 53 09 00 d2  	fcvt.d.w	fs2, zero
;     fcvt.d.w f19, zero
8000283c: d3 09 00 d2  	fcvt.d.w	fs3, zero
;     fcvt.d.w f20, zero
80002840: 53 0a 00 d2  	fcvt.d.w	fs4, zero
;     fcvt.d.w f21, zero
80002844: d3 0a 00 d2  	fcvt.d.w	fs5, zero
;     fcvt.d.w f22, zero
80002848: 53 0b 00 d2  	fcvt.d.w	fs6, zero
;     fcvt.d.w f23, zero
8000284c: d3 0b 00 d2  	fcvt.d.w	fs7, zero
;     fcvt.d.w f24, zero
80002850: 53 0c 00 d2  	fcvt.d.w	fs8, zero
;     fcvt.d.w f25, zero
80002854: d3 0c 00 d2  	fcvt.d.w	fs9, zero
;     fcvt.d.w f26, zero
80002858: 53 0d 00 d2  	fcvt.d.w	fs10, zero
;     fcvt.d.w f27, zero
8000285c: d3 0d 00 d2  	fcvt.d.w	fs11, zero
;     fcvt.d.w f28, zero
80002860: 53 0e 00 d2  	fcvt.d.w	ft8, zero
;     fcvt.d.w f29, zero
80002864: d3 0e 00 d2  	fcvt.d.w	ft9, zero
;     fcvt.d.w f30, zero
80002868: 53 0f 00 d2  	fcvt.d.w	ft10, zero
;     fcvt.d.w f31, zero
8000286c: d3 0f 00 d2  	fcvt.d.w	ft11, zero

80002870 <snrt.crt0.init_stack>:
;     addi      a3, a3, -8
80002870: 93 86 86 ff  	addi	a3, a3, -8
;     sw        zero, 0(a3)
80002874: 23 a0 06 00  	sw	zero, 0(a3)

80002878 <.Lpcrel_hi2>:
;     lw        t0, _snrt_team_size
80002878: 97 02 00 00  	auipc	t0, 0
8000287c: 83 a2 42 38  	lw	t0, 900(t0)
;     sub       a3, a3, t0
80002880: b3 86 56 40  	sub	a3, a3, t0
;     mv        a5, a3
80002884: 93 87 06 00  	mv	a5, a3

80002888 <.Lpcrel_hi3>:
;     lw        t2, snrt_stack_size  # load stack size (overridable by binary)
80002888: 97 03 00 00  	auipc	t2, 0
8000288c: 83 a3 03 37  	lw	t2, 880(t2)
;     sll       t0, a0, t2  # this hart
80002890: b3 12 75 00  	sll	t0, a0, t2
;     sll       t1, a1, t2  # all harts
80002894: 33 93 75 00  	sll	t1, a1, t2
;     sub       sp, a3, t0
80002898: 33 81 56 40  	sub	sp, a3, t0
;     sub       a3, a3, t1
8000289c: b3 86 66 40  	sub	a3, a3, t1
;     slli      t0, a0, 3  # this hart
800028a0: 93 12 35 00  	slli	t0, a0, 3
;     slli      t1, a1, 3  # all harts
800028a4: 13 93 35 00  	slli	t1, a1, 3
;     sub       sp, sp, t0
800028a8: 33 01 51 40  	sub	sp, sp, t0
;     sub       a3, a3, t1
800028ac: b3 86 66 40  	sub	a3, a3, t1

800028b0 <snrt.crt0.init_tls>:
;     la        t0, __tdata_start
800028b0: 97 02 00 00  	auipc	t0, 0
800028b4: 93 82 82 6d  	addi	t0, t0, 1752

800028b8 <.Lpcrel_hi5>:
;     la        t1, __tdata_end
800028b8: 17 03 00 00  	auipc	t1, 0
800028bc: 13 03 03 6d  	addi	t1, t1, 1744

800028c0 <.Lpcrel_hi6>:
;     la        t2, __tbss_start
800028c0: 97 03 00 00  	auipc	t2, 0
800028c4: 93 83 83 6c  	addi	t2, t2, 1736

800028c8 <.Lpcrel_hi7>:
;     la        t3, __tbss_end
800028c8: 17 0e 00 00  	auipc	t3, 0
800028cc: 13 0e 0e 6d  	addi	t3, t3, 1744
;     add       sp, sp, t0   # subtract sp to make room for TLS and align
800028d0: 33 01 51 00  	add	sp, sp, t0
;     sub       sp, sp, t1
800028d4: 33 01 61 40  	sub	sp, sp, t1
;     add       sp, sp, t2
800028d8: 33 01 71 00  	add	sp, sp, t2
;     sub       sp, sp, t3
800028dc: 33 01 c1 41  	sub	sp, sp, t3
;     andi      sp, sp, ~0x7
800028e0: 13 71 81 ff  	andi	sp, sp, -8
;     mv        tp, sp       # palce tp at start of TLS
800028e4: 13 02 01 00  	mv	tp, sp
;     andi      sp, sp, ~0x7 # align stack to 8B
800028e8: 13 71 81 ff  	andi	sp, sp, -8
;     mv        t4, tp
800028ec: 93 0e 02 00  	mv	t4, tp
;     bge       t0, t1, 2f
800028f0: 63 dc 62 00  	bge	t0, t1, 0x80002908 <.Lpcrel_hi8>
; 1:  lw        t5, 0(t0)
800028f4: 03 af 02 00  	lw	t5, 0(t0)
;     sw        t5, 0(t4)
800028f8: 23 a0 ee 01  	sw	t5, 0(t4)
;     addi      t0, t0, 4
800028fc: 93 82 42 00  	addi	t0, t0, 4
;     addi      t4, t4, 4
80002900: 93 8e 4e 00  	addi	t4, t4, 4
;     blt       t0, t1, 1b
80002904: e3 c8 62 fe  	blt	t0, t1, 0x800028f4 <.Lpcrel_hi7+0x2c>

80002908 <.Lpcrel_hi8>:
;     la        t0, __tbss_start
80002908: 97 02 00 00  	auipc	t0, 0
8000290c: 93 82 02 68  	addi	t0, t0, 1664

80002910 <.Lpcrel_hi9>:
;     la        t1, __tbss_end
80002910: 17 03 00 00  	auipc	t1, 0
80002914: 13 03 83 68  	addi	t1, t1, 1672
;     bge       t0, t1, 2f
80002918: 63 da 62 00  	bge	t0, t1, 0x8000292c <snrt.crt0.init_team>
; 1:  sw        zero, 0(t4)
8000291c: 23 a0 0e 00  	sw	zero, 0(t4)
;     addi      t0, t0, 4
80002920: 93 82 42 00  	addi	t0, t0, 4
;     addi      t4, t4, 4
80002924: 93 8e 4e 00  	addi	t4, t4, 4
;     blt       t0, t2, 1b
80002928: e3 ca 72 fe  	blt	t0, t2, 0x8000291c <.Lpcrel_hi9+0xc>

8000292c <snrt.crt0.init_team>:
;     addi      sp, sp, -20
8000292c: 13 01 c1 fe  	addi	sp, sp, -20
;     sw        a0, 0(sp)
80002930: 23 20 a1 00  	sw	a0, 0(sp)
;     sw        a1, 4(sp)
80002934: 23 22 b1 00  	sw	a1, 4(sp)
;     sw        a2, 8(sp)
80002938: 23 24 c1 00  	sw	a2, 8(sp)
;     sw        a3, 12(sp)
8000293c: 23 26 d1 00  	sw	a3, 12(sp)
;     sw        a4, 16(sp)
80002940: 23 28 e1 00  	sw	a4, 16(sp)
;     call      _snrt_init_team
80002944: 97 e0 ff ff  	auipc	ra, 1048574
80002948: e7 80 00 f9  	jalr	-112(ra)
;     lw        a0, 0(sp)
8000294c: 03 25 01 00  	lw	a0, 0(sp)
;     lw        a1, 4(sp)
80002950: 83 25 41 00  	lw	a1, 4(sp)
;     lw        a2, 8(sp)
80002954: 03 26 81 00  	lw	a2, 8(sp)
;     lw        a3, 12(sp)
80002958: 83 26 c1 00  	lw	a3, 12(sp)
;     lw        a4, 16(sp)
8000295c: 03 27 01 01  	lw	a4, 16(sp)
;     addi      sp, sp, 20
80002960: 13 01 41 01  	addi	sp, sp, 20

80002964 <snrt.crt0.init_interrupt>:
;     la t0, __snrt_crt0_interrupt_handler
80002964: 97 02 00 00  	auipc	t0, 0
80002968: 93 82 c2 03  	addi	t0, t0, 60
;     csrw   mtvec, t0
8000296c: 73 90 52 30  	csrw	mtvec, t0

80002970 <snrt.crt0.pre_barrier>:
;     call      _snrt_cluster_barrier
80002970: 97 00 00 00  	auipc	ra, 0
80002974: e7 80 00 22  	jalr	544(ra)

80002978 <snrt.crt0.main>:
;     call      main  # main(int core_id, int core_num, void *spm_start, void *spm_end)
80002978: 97 e0 ff ff  	auipc	ra, 1048574
8000297c: e7 80 c0 cb  	jalr	-836(ra)
;     mv        s0, a0 # store return value in s0
80002980: 13 04 05 00  	mv	s0, a0

80002984 <snrt.crt0.post_barrier>:
;     call      _snrt_cluster_barrier
80002984: 97 00 00 00  	auipc	ra, 0
80002988: e7 80 c0 20  	jalr	524(ra)

8000298c <snrt.crt0.end>:
;     mv        a0, s0 # recover return value of main function in s0
8000298c: 13 05 04 00  	mv	a0, s0
;     call      _snrt_exit
80002990: 97 00 00 00  	auipc	ra, 0
80002994: e7 80 c0 22  	jalr	556(ra)
;     wfi
80002998: 73 00 50 10  	wfi	
;     j       1b
8000299c: 6f f0 df ff  	j	0x80002998 <snrt.crt0.end+0xc>

800029a0 <__snrt_crt0_interrupt_handler>:
;     addi    sp, sp, -80
800029a0: 13 01 01 fb  	addi	sp, sp, -80
;     sw  ra, 64(sp)
800029a4: 23 20 11 04  	sw	ra, 64(sp)
;     sw  t0, 60(sp)
800029a8: 23 2e 51 02  	sw	t0, 60(sp)
;     sw  t1, 56(sp)
800029ac: 23 2c 61 02  	sw	t1, 56(sp)
;     sw  t2, 52(sp)
800029b0: 23 2a 71 02  	sw	t2, 52(sp)
;     sw  s0, 48(sp)
800029b4: 23 28 81 02  	sw	s0, 48(sp)
;     sw  a0, 44(sp)
800029b8: 23 26 a1 02  	sw	a0, 44(sp)
;     sw  a1, 40(sp)
800029bc: 23 24 b1 02  	sw	a1, 40(sp)
;     sw  a2, 36(sp)
800029c0: 23 22 c1 02  	sw	a2, 36(sp)
;     sw  a3, 32(sp)
800029c4: 23 20 d1 02  	sw	a3, 32(sp)
;     sw  a4, 28(sp)
800029c8: 23 2e e1 00  	sw	a4, 28(sp)
;     sw  a5, 24(sp)
800029cc: 23 2c f1 00  	sw	a5, 24(sp)
;     sw  a6, 20(sp)
800029d0: 23 2a 01 01  	sw	a6, 20(sp)
;     sw  a7, 16(sp)
800029d4: 23 28 11 01  	sw	a7, 16(sp)
;     sw  t3, 12(sp)
800029d8: 23 26 c1 01  	sw	t3, 12(sp)
;     sw  t4,  8(sp)
800029dc: 23 24 d1 01  	sw	t4, 8(sp)
;     sw  t5,  4(sp)
800029e0: 23 22 e1 01  	sw	t5, 4(sp)
;     sw  t6,  0(sp)
800029e4: 23 20 f1 01  	sw	t6, 0(sp)
;     csrr    t0, misa
800029e8: f3 22 10 30  	csrr	t0, misa
;     andi    t0, t0, (1 << 3) # 3: D - single precision float extension
800029ec: 93 f2 82 00  	andi	t0, t0, 8
;     beqz    t0, 1f
800029f0: 63 84 02 08  	beqz	t0, 0x80002a78 <__snrt_crt0_interrupt_handler+0xd8>
;     addi    sp, sp, -256
800029f4: 13 01 01 f0  	addi	sp, sp, -256
;     fsd     f0, 248(sp)
800029f8: 27 3c 01 0e  	fsd	ft0, 248(sp)
;     fsd     f1, 240(sp)
800029fc: 27 38 11 0e  	fsd	ft1, 240(sp)
;     fsd     f2, 232(sp)
80002a00: 27 34 21 0e  	fsd	ft2, 232(sp)
;     fsd     f3, 224(sp)
80002a04: 27 30 31 0e  	fsd	ft3, 224(sp)
;     fsd     f4, 216(sp)
80002a08: 27 3c 41 0c  	fsd	ft4, 216(sp)
;     fsd     f5, 208(sp)
80002a0c: 27 38 51 0c  	fsd	ft5, 208(sp)
;     fsd     f6, 200(sp)
80002a10: 27 34 61 0c  	fsd	ft6, 200(sp)
;     fsd     f7, 192(sp)
80002a14: 27 30 71 0c  	fsd	ft7, 192(sp)
;     fsd     f8, 184(sp)
80002a18: 27 3c 81 0a  	fsd	fs0, 184(sp)
;     fsd     f9, 176(sp)
80002a1c: 27 38 91 0a  	fsd	fs1, 176(sp)
;     fsd     f10, 168(sp)
80002a20: 27 34 a1 0a  	fsd	fa0, 168(sp)
;     fsd     f11, 160(sp)
80002a24: 27 30 b1 0a  	fsd	fa1, 160(sp)
;     fsd     f12, 152(sp)
80002a28: 27 3c c1 08  	fsd	fa2, 152(sp)
;     fsd     f13, 144(sp)
80002a2c: 27 38 d1 08  	fsd	fa3, 144(sp)
;     fsd     f14, 136(sp)
80002a30: 27 34 e1 08  	fsd	fa4, 136(sp)
;     fsd     f15, 128(sp)
80002a34: 27 30 f1 08  	fsd	fa5, 128(sp)
;     fsd     f16, 120(sp)
80002a38: 27 3c 01 07  	fsd	fa6, 120(sp)
;     fsd     f17, 112(sp)
80002a3c: 27 38 11 07  	fsd	fa7, 112(sp)
;     fsd     f18, 104(sp)
80002a40: 27 34 21 07  	fsd	fs2, 104(sp)
;     fsd     f19, 96(sp)
80002a44: 27 30 31 07  	fsd	fs3, 96(sp)
;     fsd     f20, 88(sp)
80002a48: 27 3c 41 05  	fsd	fs4, 88(sp)
;     fsd     f21, 80(sp)
80002a4c: 27 38 51 05  	fsd	fs5, 80(sp)
;     fsd     f22, 72(sp)
80002a50: 27 34 61 05  	fsd	fs6, 72(sp)
;     fsd     f23, 64(sp)
80002a54: 27 30 71 05  	fsd	fs7, 64(sp)
;     fsd     f24, 56(sp)
80002a58: 27 3c 81 03  	fsd	fs8, 56(sp)
;     fsd     f25, 48(sp)
80002a5c: 27 38 91 03  	fsd	fs9, 48(sp)
;     fsd     f26, 40(sp)
80002a60: 27 34 a1 03  	fsd	fs10, 40(sp)
;     fsd     f27, 32(sp)
80002a64: 27 30 b1 03  	fsd	fs11, 32(sp)
;     fsd     f28, 24(sp)
80002a68: 27 3c c1 01  	fsd	ft8, 24(sp)
;     fsd     f29, 16(sp)
80002a6c: 27 38 d1 01  	fsd	ft9, 16(sp)
;     fsd     f30, 8(sp)
80002a70: 27 34 e1 01  	fsd	ft10, 8(sp)
;     fsd     f31, 0(sp)
80002a74: 27 30 f1 01  	fsd	ft11, 0(sp)
;     call    __snrt_isr
80002a78: 97 00 00 00  	auipc	ra, 0
80002a7c: e7 80 00 c5  	jalr	-944(ra)
;     csrr    t0, misa
80002a80: f3 22 10 30  	csrr	t0, misa
;     andi    t0, t0, (1 << 3) # 3: D - single precision float extension
80002a84: 93 f2 82 00  	andi	t0, t0, 8
;     beqz    t0, 1f
80002a88: 63 84 02 08  	beqz	t0, 0x80002b10 <__snrt_crt0_interrupt_handler+0x170>
;     fld     f0, 248(sp)
80002a8c: 07 30 81 0f  	fld	ft0, 248(sp)
;     fld     f1, 240(sp)
80002a90: 87 30 01 0f  	fld	ft1, 240(sp)
;     fld     f2, 232(sp)
80002a94: 07 31 81 0e  	fld	ft2, 232(sp)
;     fld     f3, 224(sp)
80002a98: 87 31 01 0e  	fld	ft3, 224(sp)
;     fld     f4, 216(sp)
80002a9c: 07 32 81 0d  	fld	ft4, 216(sp)
;     fld     f5, 208(sp)
80002aa0: 87 32 01 0d  	fld	ft5, 208(sp)
;     fld     f6, 200(sp)
80002aa4: 07 33 81 0c  	fld	ft6, 200(sp)
;     fld     f7, 192(sp)
80002aa8: 87 33 01 0c  	fld	ft7, 192(sp)
;     fld     f8, 184(sp)
80002aac: 07 34 81 0b  	fld	fs0, 184(sp)
;     fld     f9, 176(sp)
80002ab0: 87 34 01 0b  	fld	fs1, 176(sp)
;     fld     f10, 168(sp)
80002ab4: 07 35 81 0a  	fld	fa0, 168(sp)
;     fld     f11, 160(sp)
80002ab8: 87 35 01 0a  	fld	fa1, 160(sp)
;     fld     f12, 152(sp)
80002abc: 07 36 81 09  	fld	fa2, 152(sp)
;     fld     f13, 144(sp)
80002ac0: 87 36 01 09  	fld	fa3, 144(sp)
;     fld     f14, 136(sp)
80002ac4: 07 37 81 08  	fld	fa4, 136(sp)
;     fld     f15, 128(sp)
80002ac8: 87 37 01 08  	fld	fa5, 128(sp)
;     fld     f16, 120(sp)
80002acc: 07 38 81 07  	fld	fa6, 120(sp)
;     fld     f17, 112(sp)
80002ad0: 87 38 01 07  	fld	fa7, 112(sp)
;     fld     f18, 104(sp)
80002ad4: 07 39 81 06  	fld	fs2, 104(sp)
;     fld     f19, 96(sp)
80002ad8: 87 39 01 06  	fld	fs3, 96(sp)
;     fld     f20, 88(sp)
80002adc: 07 3a 81 05  	fld	fs4, 88(sp)
;     fld     f21, 80(sp)
80002ae0: 87 3a 01 05  	fld	fs5, 80(sp)
;     fld     f22, 72(sp)
80002ae4: 07 3b 81 04  	fld	fs6, 72(sp)
;     fld     f23, 64(sp)
80002ae8: 87 3b 01 04  	fld	fs7, 64(sp)
;     fld     f24, 56(sp)
80002aec: 07 3c 81 03  	fld	fs8, 56(sp)
;     fld     f25, 48(sp)
80002af0: 87 3c 01 03  	fld	fs9, 48(sp)
;     fld     f26, 40(sp)
80002af4: 07 3d 81 02  	fld	fs10, 40(sp)
;     fld     f27, 32(sp)
80002af8: 87 3d 01 02  	fld	fs11, 32(sp)
;     fld     f28, 24(sp)
80002afc: 07 3e 81 01  	fld	ft8, 24(sp)
;     fld     f29, 16(sp)
80002b00: 87 3e 01 01  	fld	ft9, 16(sp)
;     fld     f30, 8(sp)
80002b04: 07 3f 81 00  	fld	ft10, 8(sp)
;     fld     f31, 0(sp)
80002b08: 87 3f 01 00  	fld	ft11, 0(sp)
;     addi    sp, sp, 256
80002b0c: 13 01 01 10  	addi	sp, sp, 256
;     lw  t6,  0(sp)
80002b10: 83 2f 01 00  	lw	t6, 0(sp)
;     lw  t5,  4(sp)
80002b14: 03 2f 41 00  	lw	t5, 4(sp)
;     lw  t4,  8(sp)
80002b18: 83 2e 81 00  	lw	t4, 8(sp)
;     lw  t3, 12(sp)
80002b1c: 03 2e c1 00  	lw	t3, 12(sp)
;     lw  a7, 16(sp)
80002b20: 83 28 01 01  	lw	a7, 16(sp)
;     lw  a6, 20(sp)
80002b24: 03 28 41 01  	lw	a6, 20(sp)
;     lw  a5, 24(sp)
80002b28: 83 27 81 01  	lw	a5, 24(sp)
;     lw  a4, 28(sp)
80002b2c: 03 27 c1 01  	lw	a4, 28(sp)
;     lw  a3, 32(sp)
80002b30: 83 26 01 02  	lw	a3, 32(sp)
;     lw  a2, 36(sp)
80002b34: 03 26 41 02  	lw	a2, 36(sp)
;     lw  a1, 40(sp)
80002b38: 83 25 81 02  	lw	a1, 40(sp)
;     lw  a0, 44(sp)
80002b3c: 03 25 c1 02  	lw	a0, 44(sp)
;     lw  s0, 48(sp)
80002b40: 03 24 01 03  	lw	s0, 48(sp)
;     lw  t2, 52(sp)
80002b44: 83 23 41 03  	lw	t2, 52(sp)
;     lw  t1, 56(sp)
80002b48: 03 23 81 03  	lw	t1, 56(sp)
;     lw  t0, 60(sp)
80002b4c: 83 22 c1 03  	lw	t0, 60(sp)
;     lw  ra, 64(sp)
80002b50: 83 20 01 04  	lw	ra, 64(sp)
;     addi    sp, sp, 80
80002b54: 13 01 01 05  	addi	sp, sp, 80
;     mret
80002b58: 73 00 20 30  	mret	

80002b5c <_snrt_init_core_info>:
;     mv        a4, a1
80002b5c: 13 87 05 00  	mv	a4, a1
;     lw        a1, 4(a4)  # load the number of cores per cluster
80002b60: 83 25 47 00  	lw	a1, 4(a4)
;     lw        t0, 8(a4)  # load cluster's hartid offset
80002b64: 83 22 87 00  	lw	t0, 8(a4)
;     lw        a2, 12(a4) # start address of the TCDM
80002b68: 03 26 c7 00  	lw	a2, 12(a4)
;     lw        t1, 16(a4) # size of TCDM address space
80002b6c: 03 23 07 01  	lw	t1, 16(a4)
;     lw        t2, 20(a4) # offset between cluster TCDMs
80002b70: 83 23 47 01  	lw	t2, 20(a4)
;     sub       a0, a0, t0
80002b74: 33 05 55 40  	sub	a0, a0, t0
;     div       t3, a0, a1 # calculate cluster index
80002b78: 33 4e b5 02  	div	t3, a0, a1
;     mul       t4, t3, t2 # calculate cluster TCDM offset
80002b7c: b3 0e 7e 02  	mul	t4, t3, t2
;     add       a2, a2, t4 # start address of current cluster TCDM
80002b80: 33 06 d6 01  	add	a2, a2, t4
;     add       a3, a2, t1 # end address of current cluster TCDM
80002b84: b3 06 66 00  	add	a3, a2, t1
;     remu      a0, a0, a1 # calculate cluster-local core id
80002b88: 33 75 b5 02  	remu	a0, a0, a1
;     ret
80002b8c: 67 80 00 00  	ret

80002b90 <_snrt_cluster_barrier>:
;     addi      sp, sp, -4
80002b90: 13 01 c1 ff  	addi	sp, sp, -4
;     sw        ra, 0(sp)
80002b94: 23 20 11 00  	sw	ra, 0(sp)
;     call      _snrt_barrier_reg_ptr
80002b98: 97 00 00 00  	auipc	ra, 0
80002b9c: e7 80 80 b1  	jalr	-1256(ra)
;     lw        a0, 0(a0)
80002ba0: 03 25 05 00  	lw	a0, 0(a0)
;     mv        zero, a0
80002ba4: 13 00 05 00  	mv	zero, a0
;     lw        ra, 0(sp)
80002ba8: 83 20 01 00  	lw	ra, 0(sp)
;     addi      sp, sp, 4
80002bac: 13 01 41 00  	addi	sp, sp, 4
;     ret
80002bb0: 67 80 00 00  	ret

80002bb4 <_snrt_get_base_hartid>:
;     lw        a0, 8(a0)  # load cluster's hartid offset
80002bb4: 03 25 85 00  	lw	a0, 8(a0)
;     ret
80002bb8: 67 80 00 00  	ret

80002bbc <_snrt_exit>:
;     addi      sp, sp, -8
80002bbc: 13 01 81 ff  	addi	sp, sp, -8
;     sw        a0, 0(sp)
80002bc0: 23 20 a1 00  	sw	a0, 0(sp)
;     sw        ra, 4(sp)
80002bc4: 23 22 11 00  	sw	ra, 4(sp)
;     call      snrt_global_core_idx
80002bc8: 97 00 00 00  	auipc	ra, 0
80002bcc: e7 80 80 ac  	jalr	-1336(ra)
;     lw        t0, 0(sp)
80002bd0: 83 22 01 00  	lw	t0, 0(sp)
;     lw        ra, 4(sp)
80002bd4: 83 20 41 00  	lw	ra, 4(sp)
;     addi      sp, sp, 8
80002bd8: 13 01 81 00  	addi	sp, sp, 8
;     bnez      a0, 1f
80002bdc: 63 1c 05 00  	bnez	a0, 0x80002bf4 <.Lpcrel_hi11+0xc>
;     slli      t0, t0, 1
80002be0: 93 92 12 00  	slli	t0, t0, 1
;     ori       t0, t0, 1
80002be4: 93 e2 12 00  	ori	t0, t0, 1

80002be8 <.Lpcrel_hi11>:
;     la        t1, tohost
80002be8: 17 03 00 00  	auipc	t1, 0
80002bec: 13 03 83 35  	addi	t1, t1, 856
;     sw        t0, 0(t1)
80002bf0: 23 20 53 00  	sw	t0, 0(t1)
; 1:  ret
