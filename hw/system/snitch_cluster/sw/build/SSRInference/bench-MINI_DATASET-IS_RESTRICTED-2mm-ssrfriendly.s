...
/home/thomas/Documents/eth/ba/code/all/snitch/hw/system/snitch_cluster/sw/build/SSRInference/bench-MINI_DATASET-IS_RESTRICTED-2mm-ssrfriendly:	file format elf32-littleriscv
...
Idx Name              Size     VMA      Type
 ...
 13 .debug_info       00003735 00000000 
 14 .debug_abbrev     00000c06 00000000 
 15 .debug_aranges    00000040 00000000 
 16 .debug_line       00002ffb 00000000 
 17 .debug_loc        000039a0 00000000 
...
800014dc: 07 b3 84 07  	fld	ft6, 120(s1)
800014e0: 87 b3 04 00  	fld	ft7, 0(s1)
800014e4: 07 b5 84 00  	fld	fa0, 8(s1)
800014e8: 87 b5 04 01  	fld	fa1, 16(s1)
800014ec: 07 b6 84 01  	fld	fa2, 24(s1)
800014f0: 87 b6 04 02  	fld	fa3, 32(s1)
800014f4: 07 b7 84 02  	fld	fa4, 40(s1)
800014f8: 87 b7 04 03  	fld	fa5, 48(s1)
800014fc: 07 b8 84 03  	fld	fa6, 56(s1)
80001500: 87 b8 04 04  	fld	fa7, 64(s1)
...
80001528: 53 79 79 12  	fmul.d	fs2, fs2, ft7
...
8000153c: 43 f9 a9 92  	fmadd.d	fs2, fs3, fa0, fs2
;         x += alpha * A[i][k] * B[k][j];
80001540: 87 39 04 2d  	fld	fs3, 720(s0)
80001544: 43 79 ba 92  	fmadd.d	fs2, fs4, fa1, fs2
;         x += alpha * A[i][k] * B[k][j];
80001548: 07 3a 04 36  	fld	fs4, 864(s0)
8000154c: 43 f9 ca 92  	fmadd.d	fs2, fs5, fa2, fs2
;         x += alpha * A[i][k] * B[k][j];
80001550: 87 3a 04 3f  	fld	fs5, 1008(s0)
80001554: 43 79 db 92  	fmadd.d	fs2, fs6, fa3, fs2
;         x += alpha * A[i][k] * B[k][j];
80001558: 07 3b 04 48  	fld	fs6, 1152(s0)
8000155c: 43 f9 e9 92  	fmadd.d	fs2, fs3, fa4, fs2
;         x += alpha * A[i][k] * B[k][j];
80001560: 87 39 04 51  	fld	fs3, 1296(s0)
80001564: 43 79 fa 92  	fmadd.d	fs2, fs4, fa5, fs2
;         x += alpha * A[i][k] * B[k][j];
80001568: 07 3a 04 5a  	fld	fs4, 1440(s0)
8000156c: 43 f9 0a 93  	fmadd.d	fs2, fs5, fa6, fs2
;         x += alpha * A[i][k] * B[k][j];
80001570: 87 3a 04 63  	fld	fs5, 1584(s0)
80001574: 43 79 1b 93  	fmadd.d	fs2, fs6, fa7, fs2
;         x += alpha * A[i][k] * B[k][j];
...
800015c0: 43 f9 6a 92  	fmadd.d	fs2, fs5, ft6, fs2
...
80001948 <_vsnprintf.llvm.11632292163828655644>:
; {
...
80002540 <_out_char.llvm.11632292163828655644>:
;   if (character) {
