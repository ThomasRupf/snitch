...
800026fc: 93 03 85 2f  	addi	t2, a0, 760
80002700: 33 b5 a3 00  	sltu	a0, t2, a0
80002704: 33 84 a5 00  	add	s0, a1, a0
...
80002724: 63 06 04 00  	beqz	s0, 0x80002730 <.LBB0_180+0xda0>
80002728: 13 05 00 00  	mv	a0, zero
8000272c: 6f 00 80 00  	j	0x80002734 <.LBB0_180+0xda4>
80002730: 33 b5 93 00  	sltu	a0, t2, s1
...
80002748: 63 12 04 02  	bnez	s0, 0x8000276c <.LBB0_180+0xddc>
8000274c: 33 b6 13 01  	sltu	a2, t2, a7
;   for (i = 0; i < nj; i++)
...
80002768: e3 02 04 fe  	beqz	s0, 0x8000274c <.LBB0_180+0xdbc>
...
800027b4: 23 20 71 00  	sw	t2, 0(sp)
800027b8: 23 2c 81 00  	sw	s0, 24(sp)
...
80002958: 63 06 04 02  	beqz	s0, 0x80002984 <.LBB0_180+0xff4>
...
80002970: 63 16 04 02  	bnez	s0, 0x8000299c <.LBB0_180+0x100c>
80002974: 33 b7 d3 01  	sltu	a4, t2, t4
;   for (i = 0; i < nj; i++)
...
80002984: 33 b5 63 00  	sltu	a0, t2, t1
;   for (i = 0; i < nj; i++)
...
80002998: e3 0e 04 fc  	beqz	s0, 0x80002974 <.LBB0_180+0xfe4>
...
800029b0: 63 06 04 00  	beqz	s0, 0x800029bc <.LBB0_180+0x102c>
800029b4: 93 07 00 00  	mv	a5, zero
800029b8: 6f 00 80 00  	j	0x800029c0 <.LBB0_180+0x1030>
800029bc: b3 b7 03 01  	sltu	a5, t2, a6
;   for (i = 0; i < nj; i++)
...
80002e98: 63 0a 07 00  	beqz	a4, 0x80002eac <.LBB0_180+0x151c>
80002e9c: 13 05 00 00  	mv	a0, zero
80002ea0: 83 20 81 02  	lw	ra, 40(sp)
80002ea4: 83 2d 41 03  	lw	s11, 52(sp)
80002ea8: 6f 00 00 01  	j	0x80002eb8 <.LBB0_180+0x1528>
80002eac: 83 2d 41 03  	lw	s11, 52(sp)
80002eb0: 33 b5 b6 01  	sltu	a0, a3, s11
80002eb4: 83 20 81 02  	lw	ra, 40(sp)
80002eb8: 83 27 41 01  	lw	a5, 20(sp)
80002ebc: 83 25 81 01  	lw	a1, 24(sp)
;   for (i = 0; i < ni; i++)
80002ec0: 63 82 05 02  	beqz	a1, 0x80002ee4 <.LBB0_180+0x1554>
80002ec4: 13 06 00 00  	mv	a2, zero
80002ec8: 63 14 07 02  	bnez	a4, 0x80002ef0 <.LBB0_180+0x1560>
80002ecc: b3 b5 16 00  	sltu	a1, a3, ra
;   for (i = 0; i < ni; i++)
80002ed0: 33 65 a6 00  	or	a0, a2, a0
80002ed4: 63 94 07 02  	bnez	a5, 0x80002efc <.LBB0_180+0x156c>
80002ed8: 03 26 41 00  	lw	a2, 4(sp)
80002edc: 33 36 c6 01  	sltu	a2, a2, t3
80002ee0: 6f 00 00 02  	j	0x80002f00 <.LBB0_180+0x1570>
80002ee4: 83 25 01 00  	lw	a1, 0(sp)
80002ee8: 33 b6 c5 01  	sltu	a2, a1, t3
;   for (i = 0; i < ni; i++)
80002eec: e3 00 07 fe  	beqz	a4, 0x80002ecc <.LBB0_180+0x153c>
80002ef0: 93 05 00 00  	mv	a1, zero
80002ef4: 33 65 a6 00  	or	a0, a2, a0
80002ef8: e3 80 07 fe  	beqz	a5, 0x80002ed8 <.LBB0_180+0x1548>
