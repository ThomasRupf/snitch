...
Idx Name              Size     VMA      Type
 ...
 16 .debug_line       00002dd6 00000000 
...
8000066c: e3 94 05 44  	bnez	a1, 0x800012b4 <.LBB0_120+0x10>
...
80000f8c: 63 02 05 1c  	beqz	a0, 0x80001150 <.LBB0_116+0x658>
...
;         x += E[i][k] * F[k][j];
8000106c: d3 71 11 12  	fmul.d	ft3, ft2, ft1
80001070: c3 71 11 1a  	fmadd.d	ft3, ft2, ft1, ft3
...
;       G[i][j] = x;
80001134: 53 80 31 22  	fmv.d	ft0, ft3
;     for (j = 0; j < nl; j++)
80001138: 93 85 f5 ff  	addi	a1, a1, -1
8000113c: e3 98 05 f2  	bnez	a1, 0x8000106c <.LBB0_116+0x574>
;   for (i = 0; i < ni; i++)
80001140: 13 06 16 00  	addi	a2, a2, 1
80001144: e3 12 a6 f2  	bne	a2, a0, 0x80001068 <.LBB0_116+0x570>
80001148: 73 f5 00 7c  	csrrci	a0, 1984, 1
8000114c: 6f 00 40 07  	j	0x800011c0 <.LBB0_116+0x6c8>
80001150: d3 01 00 d2  	fcvt.d.w	ft3, zero
80001154: 93 06 00 19  	addi	a3, zero, 400
80001158: 93 02 00 23  	addi	t0, zero, 560
8000115c: 93 07 60 04  	addi	a5, zero, 70
80001160: 93 08 80 02  	addi	a7, zero, 40
80001164: 93 05 00 00  	mv	a1, zero
80001168: 13 07 0f 00  	mv	a4, t5
8000116c: 93 04 00 00  	mv	s1, zero
80001170: 13 04 07 00  	mv	s0, a4
80001174: 53 82 31 22  	fmv.d	ft4, ft3
;         x += E[i][k] * F[k][j];
80001178: 33 05 9b 00  	add	a0, s6, s1
8000117c: 87 32 05 00  	fld	ft5, 0(a0)
80001180: 07 33 04 00  	fld	ft6, 0(s0)
80001184: 43 72 53 22  	fmadd.d	ft4, ft6, ft5, ft4
;       for (k = 0; k < nj; ++k)
80001188: 93 84 84 00  	addi	s1, s1, 8
8000118c: 13 04 04 23  	addi	s0, s0, 560
80001190: e3 94 d4 fe  	bne	s1, a3, 0x80001178 <.LBB0_116+0x680>
;       G[i][j] = x;
80001194: 33 05 56 02  	mul	a0, a2, t0
80001198: 33 85 a9 00  	add	a0, s3, a0
8000119c: 93 94 35 00  	slli	s1, a1, 3
800011a0: 33 05 95 00  	add	a0, a0, s1
800011a4: 27 30 45 00  	fsd	ft4, 0(a0)
;     for (j = 0; j < nl; j++)
800011a8: 93 85 15 00  	addi	a1, a1, 1
800011ac: 13 07 87 00  	addi	a4, a4, 8
800011b0: e3 9e f5 fa  	bne	a1, a5, 0x8000116c <.LBB0_116+0x674>
;   for (i = 0; i < ni; i++)
800011b4: 13 06 16 00  	addi	a2, a2, 1
800011b8: 13 0b 0b 19  	addi	s6, s6, 400
800011bc: e3 14 16 fb  	bne	a2, a7, 0x80001164 <.LBB0_116+0x66c>
; size_t benchmark_get_cycle() { return read_csr(mcycle); }
800011c0: 73 25 00 b0  	csrr	a0, mcycle
;   printf("cycles = %lu\n", end - start);
800011c4: b3 05 05 41  	sub	a1, a0, a6

800011c8 <.LBB0_117>:
800011c8: 17 25 00 00  	auipc	a0, 2
800011cc: 13 05 95 45  	addi	a0, a0, 1113
800011d0: 97 00 00 00  	auipc	ra, 0
800011d4: e7 80 00 11  	jalr	272(ra)
800011d8: 13 05 00 00  	mv	a0, zero
800011dc: 63 04 09 06  	beqz	s2, 0x80001244 <.LBB0_117+0x7c>
800011e0: 93 05 80 00  	addi	a1, zero, 8
800011e4: 13 06 50 04  	addi	a2, zero, 69
;     for (int i = 0; i < n; i++){
800011e8: 93 06 00 04  	addi	a3, zero, 64
800011ec: ab 20 d6 00  	scfgw	a2, a3
800011f0: 13 06 00 0c  	addi	a2, zero, 192
800011f4: ab a0 c5 00  	scfgw	a1, a2
800011f8: 13 06 70 02  	addi	a2, zero, 39
800011fc: 93 06 00 06  	addi	a3, zero, 96
80001200: ab 20 d6 00  	scfgw	a2, a3
80001204: 13 06 00 0e  	addi	a2, zero, 224
80001208: ab a0 c5 00  	scfgw	a1, a2
8000120c: 93 05 00 02  	addi	a1, zero, 32
80001210: ab 20 b0 00  	scfgw	zero, a1
80001214: 2b a0 09 32  	scfgwi	s3, 800
80001218: f3 e5 00 7c  	csrrsi	a1, 1984, 1
8000121c: d3 01 00 d2  	fcvt.d.w	ft3, zero
80001220: 93 05 80 02  	addi	a1, zero, 40
80001224: 13 06 60 04  	addi	a2, zero, 70
;         for (int j = 0; j < m; j++){
80001228: 13 06 f6 ff  	addi	a2, a2, -1
;             r += A[i * m + j];
8000122c: d3 71 30 02  	fadd.d	ft3, ft0, ft3
;         for (int j = 0; j < m; j++){
80001230: e3 1c 06 fe  	bnez	a2, 0x80001228 <.LBB0_117+0x60>
;     for (int i = 0; i < n; i++){
80001234: 13 05 15 00  	addi	a0, a0, 1
80001238: e3 16 b5 fe  	bne	a0, a1, 0x80001224 <.LBB0_117+0x5c>
8000123c: 73 f5 00 7c  	csrrci	a0, 1984, 1
80001240: 6f 00 40 03  	j	0x80001274 <.LBB0_118>
80001244: d3 01 00 d2  	fcvt.d.w	ft3, zero
80001248: 93 05 00 23  	addi	a1, zero, 560
8000124c: 13 06 80 02  	addi	a2, zero, 40
80001250: 93 06 00 00  	mv	a3, zero
;             r += A[i * m + j];
80001254: 33 87 d9 00  	add	a4, s3, a3
80001258: 07 32 07 00  	fld	ft4, 0(a4)
;         for (int j = 0; j < m; j++){
8000125c: 93 86 86 00  	addi	a3, a3, 8
;             r += A[i * m + j];
80001260: d3 71 32 02  	fadd.d	ft3, ft4, ft3
;         for (int j = 0; j < m; j++){
80001264: e3 98 b6 fe  	bne	a3, a1, 0x80001254 <.LBB0_117+0x8c>
;     for (int i = 0; i < n; i++){
80001268: 13 05 15 00  	addi	a0, a0, 1
8000126c: 93 89 09 23  	addi	s3, s3, 560
80001270: e3 10 c5 fe  	bne	a0, a2, 0x80001250 <.LBB0_117+0x88>

80001274 <.LBB0_118>:
80001274: 17 25 00 00  	auipc	a0, 2
80001278: 13 05 45 64  	addi	a0, a0, 1604
8000127c: 07 32 05 00  	fld	ft4, 0(a0)
;   double error = r - r_true;
80001280: d3 f1 41 02  	fadd.d	ft3, ft3, ft4
;   error = error < 0.0 ? -error : error;
80001284: 53 a4 31 22  	fabs.d	fs0, ft3
;   printf("error = %f\n", error);
80001288: 27 30 81 00  	fsd	fs0, 0(sp)
8000128c: 03 26 01 00  	lw	a2, 0(sp)
80001290: 83 26 41 00  	lw	a3, 4(sp)

80001294 <.LBB0_119>:
80001294: 17 25 00 00  	auipc	a0, 2
80001298: 13 05 15 38  	addi	a0, a0, 897
8000129c: 97 00 00 00  	auipc	ra, 0
800012a0: e7 80 40 04  	jalr	68(ra)

800012a4 <.LBB0_120>:
800012a4: 17 25 00 00  	auipc	a0, 2
800012a8: 13 05 c5 61  	addi	a0, a0, 1564
800012ac: 87 31 05 00  	fld	ft3, 0(a0)
;   return error > 0.0001;
800012b0: 53 95 81 a2  	flt.d	a0, ft3, fs0
; }
800012b4: 07 34 81 00  	fld	fs0, 8(sp)
800012b8: 03 2b 01 01  	lw	s6, 16(sp)
800012bc: 83 2a 41 01  	lw	s5, 20(sp)
800012c0: 03 2a 81 01  	lw	s4, 24(sp)
800012c4: 83 29 c1 01  	lw	s3, 28(sp)
800012c8: 03 29 01 02  	lw	s2, 32(sp)
800012cc: 83 24 41 02  	lw	s1, 36(sp)
800012d0: 03 24 81 02  	lw	s0, 40(sp)
800012d4: 83 20 c1 02  	lw	ra, 44(sp)
800012d8: 13 01 01 03  	addi	sp, sp, 48
...
8000133c <_vsnprintf.llvm.17592004524093383706>:
; {
...
80001f34 <_out_char.llvm.17592004524093383706>:
;   if (character) {
