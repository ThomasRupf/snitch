...
/home/thomas/Documents/eth/ba/code/all/snitch/hw/system/snitch_cluster/sw/build/SSRInference/bench-SMALL_DATASET--3mm:	file format elf32-littleriscv
...
Idx Name              Size     VMA      Type
 ...
 13 .debug_info       000037a8 00000000 
 14 .debug_abbrev     00000c1f 00000000 
 15 .debug_aranges    00000040 00000000 
 16 .debug_line       00002c19 00000000 
...
80000984: 27 30 17 00  	fsd	ft1, 0(a4)
;  for (k = 0; k < nk; ++k)
80000988: 13 04 84 00  	addi	s0, s0, 8
8000098c: 93 87 07 19  	addi	a5, a5, 400
80000990: e3 12 b4 fe  	bne	s0, a1, 0x80000974 <.LBB0_64+0xa8>
;     for (j = 0; j < nj; j++)
...
80000a00: 27 b0 17 00  	fsd	ft1, 0(a5)
;  for (k = 0; k < nm; ++k)
80000a04: 13 07 87 00  	addi	a4, a4, 8
80000a08: 13 05 05 23  	addi	a0, a0, 560
80000a0c: e3 12 b7 fe  	bne	a4, a1, 0x800009f0 <.LBB0_64+0x124>
;     for (j = 0; j < nl; j++)
...
80000a7c: 27 b0 16 00  	fsd	ft1, 0(a3)
;  for (k = 0; k < nj; ++k)
80000a80: 93 87 87 00  	addi	a5, a5, 8
80000a84: 13 05 05 23  	addi	a0, a0, 560
80000a88: e3 92 b7 fe  	bne	a5, a1, 0x80000a6c <.LBB0_64+0x1a0>
;     for (j = 0; j < nl; j++)
...
80000bac <_vsnprintf.llvm.17592004524093383706>:
; {
...
800017a4 <_out_char.llvm.17592004524093383706>:
;   if (character) {
