...
Idx Name              Size     VMA      Type
 ...
 16 .debug_line       00002d6f 00000000 
 17 .debug_loc        00003911 00000000 
...
80000668: e3 94 05 28  	bnez	a1, 0x800010f0 <.LBB0_105+0x10>
;     return _snrt_team_current->root;
8000066c: 37 05 00 00  	lui	a0, 0
80000670: 33 05 45 00  	add	a0, a0, tp
80000674: 03 25 05 00  	lw	a0, 0(a0)
80000678: 83 24 05 00  	lw	s1, 0(a0)
8000067c: 37 45 00 00  	lui	a0, 4
;     if (alloc->next + size > alloc->base + alloc->size) {
80000680: 83 a9 84 05  	lw	s3, 88(s1)
80000684: 03 a6 04 05  	lw	a2, 80(s1)
80000688: 83 a6 44 05  	lw	a3, 84(s1)
8000068c: 13 08 85 e7  	addi	a6, a0, -392
80000690: 33 85 09 01  	add	a0, s3, a6
80000694: 93 05 85 00  	addi	a1, a0, 8
80000698: 33 86 c6 00  	add	a2, a3, a2
8000069c: 63 76 b6 00  	bgeu	a2, a1, 0x800006a8 <main+0x74>
800006a0: 93 0a 00 00  	mv	s5, zero
800006a4: 6f 00 00 01  	j	0x800006b4 <main+0x80>
;     void *ret = (void *)alloc->next;
800006a8: 93 8a 09 00  	mv	s5, s3
;     alloc->next += size;
800006ac: 23 ac b4 04  	sw	a1, 88(s1)
;     if (alloc->next + size > alloc->base + alloc->size) {
800006b0: 93 89 05 00  	mv	s3, a1
800006b4: b7 55 00 00  	lui	a1, 5
800006b8: 93 87 85 77  	addi	a5, a1, 1912
;     if (alloc->next + size > alloc->base + alloc->size) {
800006bc: b3 85 f9 00  	add	a1, s3, a5
800006c0: 93 85 85 00  	addi	a1, a1, 8
800006c4: 63 76 b6 00  	bgeu	a2, a1, 0x800006d0 <main+0x9c>
800006c8: 93 06 00 00  	mv	a3, zero
800006cc: 6f 00 00 01  	j	0x800006dc <main+0xa8>
;     void *ret = (void *)alloc->next;
800006d0: 93 86 09 00  	mv	a3, s3
;     alloc->next += size;
800006d4: 23 ac b4 04  	sw	a1, 88(s1)
;     if (alloc->next + size > alloc->base + alloc->size) {
800006d8: 93 89 05 00  	mv	s3, a1
800006dc: b7 75 00 00  	lui	a1, 7
800006e0: 93 83 85 d5  	addi	t2, a1, -680
;     if (alloc->next + size > alloc->base + alloc->size) {
800006e4: b3 85 79 00  	add	a1, s3, t2
800006e8: 93 85 85 00  	addi	a1, a1, 8
800006ec: 63 76 b6 00  	bgeu	a2, a1, 0x800006f8 <main+0xc4>
800006f0: 93 0e 00 00  	mv	t4, zero
800006f4: 6f 00 00 01  	j	0x80000704 <main+0xd0>
;     void *ret = (void *)alloc->next;
800006f8: 93 8e 09 00  	mv	t4, s3
;     alloc->next += size;
800006fc: 23 ac b4 04  	sw	a1, 88(s1)
;     if (alloc->next + size > alloc->base + alloc->size) {
80000700: 93 89 05 00  	mv	s3, a1
80000704: b7 85 00 00  	lui	a1, 8
80000708: 13 83 85 cf  	addi	t1, a1, -776
;     if (alloc->next + size > alloc->base + alloc->size) {
8000070c: b3 85 69 00  	add	a1, s3, t1
80000710: 93 85 85 00  	addi	a1, a1, 8
80000714: 63 76 b6 00  	bgeu	a2, a1, 0x80000720 <main+0xec>
80000718: 13 0e 00 00  	mv	t3, zero
8000071c: 6f 00 00 01  	j	0x8000072c <main+0xf8>
;     void *ret = (void *)alloc->next;
80000720: 13 8e 09 00  	mv	t3, s3
;     alloc->next += size;
80000724: 23 ac b4 04  	sw	a1, 88(s1)
;     if (alloc->next + size > alloc->base + alloc->size) {
80000728: 93 89 05 00  	mv	s3, a1
8000072c: b7 65 00 00  	lui	a1, 6
80000730: 93 82 85 3f  	addi	t0, a1, 1016
;     if (alloc->next + size > alloc->base + alloc->size) {
80000734: b3 85 59 00  	add	a1, s3, t0
80000738: 93 85 85 00  	addi	a1, a1, 8
8000073c: 63 76 b6 00  	bgeu	a2, a1, 0x80000748 <main+0x114>
80000740: 93 09 00 00  	mv	s3, zero
80000744: 6f 00 80 00  	j	0x8000074c <main+0x118>
;     alloc->next += size;
80000748: 23 ac b4 04  	sw	a1, 88(s1)
;   for (i = 0; i < ni; i++)
8000074c: b3 85 f6 00  	add	a1, a3, a5
80000750: 13 d6 46 01  	srli	a2, a3, 20
80000754: 33 36 c0 00  	snez	a2, a2
80000758: 37 07 12 00  	lui	a4, 288
8000075c: 13 07 17 00  	addi	a4, a4, 1
80000760: b3 b5 e5 00  	sltu	a1, a1, a4
80000764: b3 78 b6 00  	and	a7, a2, a1

80000768 <.LBB0_94>:
80000768: 97 35 00 00  	auipc	a1, 3
8000076c: 93 85 05 f7  	addi	a1, a1, -144
80000770: 13 06 00 00  	mv	a2, zero
80000774: 63 88 08 08  	beqz	a7, 0x80000804 <.LBB0_94+0x9c>
80000778: 13 07 80 00  	addi	a4, zero, 8
8000077c: 93 07 50 04  	addi	a5, zero, 69
;   for (i = 0; i < ni; i++)
80000780: 93 04 00 04  	addi	s1, zero, 64
80000784: ab a0 97 00  	scfgw	a5, s1
80000788: 93 07 00 0c  	addi	a5, zero, 192
8000078c: ab 20 f7 00  	scfgw	a4, a5
80000790: 93 07 70 02  	addi	a5, zero, 39
80000794: 93 04 00 06  	addi	s1, zero, 96
80000798: ab a0 97 00  	scfgw	a5, s1
8000079c: 93 07 00 0e  	addi	a5, zero, 224
800007a0: ab 20 f7 00  	scfgw	a4, a5
800007a4: 13 07 00 02  	addi	a4, zero, 32
800007a8: ab 20 e0 00  	scfgw	zero, a4
800007ac: 2b a0 06 3a  	scfgwi	a3, 928
800007b0: 73 e7 00 7c  	csrrsi	a4, 1984, 1
800007b4: 87 b1 05 00  	fld	ft3, 0(a1)
800007b8: b7 d5 cc cc  	lui	a1, 838861
800007bc: 93 85 d5 cc  	addi	a1, a1, -819
800007c0: 13 07 80 02  	addi	a4, zero, 40
800007c4: 93 07 60 04  	addi	a5, zero, 70
800007c8: 93 04 10 00  	addi	s1, zero, 1
;       A[i][j] = (double) ((i*j+1) % ni) / ni;
800007cc: 33 b4 b4 02  	mulhu	s0, s1, a1
800007d0: 13 54 54 00  	srli	s0, s0, 5
800007d4: 33 04 e4 02  	mul	s0, s0, a4
800007d8: 33 84 84 40  	sub	s0, s1, s0
800007dc: 53 02 04 d2  	fcvt.d.w	ft4, s0
800007e0: 53 72 32 12  	fmul.d	ft4, ft4, ft3
800007e4: 53 00 42 22  	fmv.d	ft0, ft4
;     for (j = 0; j < nk; j++)
800007e8: 93 87 f7 ff  	addi	a5, a5, -1
800007ec: b3 84 c4 00  	add	s1, s1, a2
800007f0: e3 9e 07 fc  	bnez	a5, 0x800007cc <.LBB0_94+0x64>
;   for (i = 0; i < ni; i++)
800007f4: 13 06 16 00  	addi	a2, a2, 1
800007f8: e3 16 e6 fc  	bne	a2, a4, 0x800007c4 <.LBB0_94+0x5c>
800007fc: f3 f5 00 7c  	csrrci	a1, 1984, 1
80000800: 6f 00 c0 05  	j	0x8000085c <.LBB0_94+0xf4>
80000804: 37 d7 cc cc  	lui	a4, 838861
80000808: 87 b1 05 00  	fld	ft3, 0(a1)
8000080c: 93 05 d7 cc  	addi	a1, a4, -819
80000810: 93 0f 80 02  	addi	t6, zero, 40
80000814: 13 0f 00 23  	addi	t5, zero, 560
80000818: 93 84 06 00  	mv	s1, a3
8000081c: 13 04 00 00  	mv	s0, zero
80000820: 93 07 10 00  	addi	a5, zero, 1
;       A[i][j] = (double) ((i*j+1) % ni) / ni;
80000824: 33 b7 b7 02  	mulhu	a4, a5, a1
80000828: 13 57 57 00  	srli	a4, a4, 5
8000082c: 33 07 f7 03  	mul	a4, a4, t6
80000830: 33 87 e7 40  	sub	a4, a5, a4
80000834: 53 02 07 d2  	fcvt.d.w	ft4, a4
80000838: 53 72 32 12  	fmul.d	ft4, ft4, ft3
8000083c: 33 87 84 00  	add	a4, s1, s0
80000840: 27 30 47 00  	fsd	ft4, 0(a4)
;     for (j = 0; j < nk; j++)
80000844: 13 04 84 00  	addi	s0, s0, 8
80000848: b3 87 c7 00  	add	a5, a5, a2
8000084c: e3 1c e4 fd  	bne	s0, t5, 0x80000824 <.LBB0_94+0xbc>
;   for (i = 0; i < ni; i++)
80000850: 13 06 16 00  	addi	a2, a2, 1
80000854: 93 84 04 23  	addi	s1, s1, 560
80000858: e3 12 f6 fd  	bne	a2, t6, 0x8000081c <.LBB0_94+0xb4>
;   for (i = 0; i < nk; i++)
8000085c: b3 85 7e 00  	add	a1, t4, t2
80000860: 13 d6 4e 01  	srli	a2, t4, 20
80000864: 33 36 c0 00  	snez	a2, a2
80000868: 37 07 12 00  	lui	a4, 288
8000086c: 13 07 17 00  	addi	a4, a4, 1
80000870: b3 b5 e5 00  	sltu	a1, a1, a4
80000874: b3 73 b6 00  	and	t2, a2, a1

80000878 <.LBB0_95>:
80000878: 17 36 00 00  	auipc	a2, 3
8000087c: 13 06 86 e6  	addi	a2, a2, -408
80000880: 63 8c 03 08  	beqz	t2, 0x80000918 <.LBB0_95+0xa0>
80000884: 93 04 00 00  	mv	s1, zero
80000888: 93 05 80 00  	addi	a1, zero, 8
8000088c: 13 07 10 03  	addi	a4, zero, 49
;   for (i = 0; i < nk; i++)
80000890: 93 07 00 04  	addi	a5, zero, 64
80000894: ab 20 f7 00  	scfgw	a4, a5
80000898: 13 07 00 0c  	addi	a4, zero, 192
8000089c: ab a0 e5 00  	scfgw	a1, a4
800008a0: 13 07 50 04  	addi	a4, zero, 69
800008a4: 93 07 00 06  	addi	a5, zero, 96
800008a8: ab 20 f7 00  	scfgw	a4, a5
800008ac: 13 07 00 0e  	addi	a4, zero, 224
800008b0: ab a0 e5 00  	scfgw	a1, a4
800008b4: 93 05 00 02  	addi	a1, zero, 32
800008b8: ab 20 b0 00  	scfgw	zero, a1
800008bc: 2b a0 0e 3a  	scfgwi	t4, 928
800008c0: f3 e5 00 7c  	csrrsi	a1, 1984, 1
800008c4: b7 85 eb 51  	lui	a1, 335544
800008c8: 87 31 06 00  	fld	ft3, 0(a2)
800008cc: 93 85 f5 51  	addi	a1, a1, 1311
800008d0: 13 07 20 03  	addi	a4, zero, 50
800008d4: 13 0f 60 04  	addi	t5, zero, 70
800008d8: 13 86 04 00  	mv	a2, s1
800008dc: 13 04 20 03  	addi	s0, zero, 50
;       B[i][j] = (double) (i*(j+1) % nj) / nj;
800008e0: b3 37 b6 02  	mulhu	a5, a2, a1
800008e4: 93 d7 47 00  	srli	a5, a5, 4
800008e8: b3 87 e7 02  	mul	a5, a5, a4
800008ec: b3 07 f6 40  	sub	a5, a2, a5
800008f0: 53 82 07 d2  	fcvt.d.w	ft4, a5
800008f4: 53 72 32 12  	fmul.d	ft4, ft4, ft3
800008f8: 53 00 42 22  	fmv.d	ft0, ft4
;     for (j = 0; j < nj; j++)
800008fc: 13 04 f4 ff  	addi	s0, s0, -1
80000900: 33 06 96 00  	add	a2, a2, s1
80000904: e3 1e 04 fc  	bnez	s0, 0x800008e0 <.LBB0_95+0x68>
;   for (i = 0; i < nk; i++)
80000908: 93 84 14 00  	addi	s1, s1, 1
8000090c: e3 96 e4 fd  	bne	s1, t5, 0x800008d8 <.LBB0_95+0x60>
80000910: f3 f5 00 7c  	csrrci	a1, 1984, 1
80000914: 6f 00 40 06  	j	0x80000978 <.LBB0_95+0x100>
80000918: 93 05 00 00  	mv	a1, zero
8000091c: 37 87 eb 51  	lui	a4, 335544
80000920: 13 07 f7 51  	addi	a4, a4, 1311
80000924: 87 31 06 00  	fld	ft3, 0(a2)
80000928: 93 0f 20 03  	addi	t6, zero, 50
8000092c: 13 09 00 19  	addi	s2, zero, 400
80000930: 13 0f 60 04  	addi	t5, zero, 70
80000934: 13 84 0e 00  	mv	s0, t4
80000938: 93 04 00 00  	mv	s1, zero
8000093c: 13 86 05 00  	mv	a2, a1
;       B[i][j] = (double) (i*(j+1) % nj) / nj;
80000940: b3 37 e6 02  	mulhu	a5, a2, a4
80000944: 93 d7 47 00  	srli	a5, a5, 4
80000948: b3 87 f7 03  	mul	a5, a5, t6
8000094c: b3 07 f6 40  	sub	a5, a2, a5
80000950: 53 82 07 d2  	fcvt.d.w	ft4, a5
80000954: 53 72 32 12  	fmul.d	ft4, ft4, ft3
80000958: b3 07 94 00  	add	a5, s0, s1
8000095c: 27 b0 47 00  	fsd	ft4, 0(a5)
;     for (j = 0; j < nj; j++)
80000960: 93 84 84 00  	addi	s1, s1, 8
80000964: 33 06 b6 00  	add	a2, a2, a1
80000968: e3 9c 24 fd  	bne	s1, s2, 0x80000940 <.LBB0_95+0xc8>
;   for (i = 0; i < nk; i++)
8000096c: 93 85 15 00  	addi	a1, a1, 1
80000970: 13 04 04 19  	addi	s0, s0, 400
80000974: e3 92 e5 fd  	bne	a1, t5, 0x80000938 <.LBB0_95+0xc0>
;   for (i = 0; i < nj; i++)
80000978: b3 05 6e 00  	add	a1, t3, t1
8000097c: 13 56 4e 01  	srli	a2, t3, 20
80000980: 33 36 c0 00  	snez	a2, a2
80000984: 37 07 12 00  	lui	a4, 288
80000988: 13 07 17 00  	addi	a4, a4, 1
8000098c: b3 b5 e5 00  	sltu	a1, a1, a4
80000990: 33 73 b6 00  	and	t1, a2, a1

80000994 <.LBB0_96>:
80000994: 97 34 00 00  	auipc	s1, 3
80000998: 93 84 44 d5  	addi	s1, s1, -684
8000099c: 93 05 00 00  	mv	a1, zero
800009a0: 63 0e 03 08  	beqz	t1, 0x80000a3c <.LBB0_96+0xa8>
800009a4: 13 06 80 00  	addi	a2, zero, 8
800009a8: 13 07 f0 04  	addi	a4, zero, 79
;   for (i = 0; i < nj; i++)
800009ac: 93 07 00 04  	addi	a5, zero, 64
800009b0: ab 20 f7 00  	scfgw	a4, a5
800009b4: 13 07 00 0c  	addi	a4, zero, 192
800009b8: ab 20 e6 00  	scfgw	a2, a4
800009bc: 13 07 10 03  	addi	a4, zero, 49
800009c0: 93 07 00 06  	addi	a5, zero, 96
800009c4: ab 20 f7 00  	scfgw	a4, a5
800009c8: 13 07 00 0e  	addi	a4, zero, 224
800009cc: ab 20 e6 00  	scfgw	a2, a4
800009d0: 13 06 00 02  	addi	a2, zero, 32
800009d4: ab 20 c0 00  	scfgw	zero, a2
800009d8: 2b 20 0e 3a  	scfgwi	t3, 928
800009dc: 73 e6 00 7c  	csrrsi	a2, 1984, 1
800009e0: 93 0f 10 00  	addi	t6, zero, 1
800009e4: 37 d6 cc cc  	lui	a2, 838861
800009e8: 87 b1 04 00  	fld	ft3, 0(s1)
800009ec: 13 07 d6 cc  	addi	a4, a2, -819
800009f0: 93 07 00 05  	addi	a5, zero, 80
800009f4: 13 0f 20 03  	addi	t5, zero, 50
800009f8: 13 86 0f 00  	mv	a2, t6
800009fc: 93 04 00 05  	addi	s1, zero, 80
;       C[i][j] = (double) ((i*(j+3)+1) % nl) / nl;
80000a00: 33 34 e6 02  	mulhu	s0, a2, a4
80000a04: 13 54 64 00  	srli	s0, s0, 6
80000a08: 33 04 f4 02  	mul	s0, s0, a5
80000a0c: 33 04 86 40  	sub	s0, a2, s0
80000a10: 53 02 04 d2  	fcvt.d.w	ft4, s0
80000a14: 53 72 32 12  	fmul.d	ft4, ft4, ft3
80000a18: 53 00 42 22  	fmv.d	ft0, ft4
;     for (j = 0; j < nl; j++)
80000a1c: 93 84 f4 ff  	addi	s1, s1, -1
80000a20: 33 06 b6 00  	add	a2, a2, a1
80000a24: e3 9e 04 fc  	bnez	s1, 0x80000a00 <.LBB0_96+0x6c>
;   for (i = 0; i < nj; i++)
80000a28: 93 85 15 00  	addi	a1, a1, 1
80000a2c: 93 8f 3f 00  	addi	t6, t6, 3
80000a30: e3 94 e5 fd  	bne	a1, t5, 0x800009f8 <.LBB0_96+0x64>
80000a34: f3 f5 00 7c  	csrrci	a1, 1984, 1
80000a38: 6f 00 80 06  	j	0x80000aa0 <.LBB0_96+0x10c>
80000a3c: 93 0f 10 00  	addi	t6, zero, 1
80000a40: 37 d6 cc cc  	lui	a2, 838861
80000a44: 13 07 d6 cc  	addi	a4, a2, -819
80000a48: 87 b1 04 00  	fld	ft3, 0(s1)
80000a4c: 13 09 00 05  	addi	s2, zero, 80
80000a50: 13 0a 00 28  	addi	s4, zero, 640
80000a54: 13 0f 20 03  	addi	t5, zero, 50
80000a58: 13 04 0e 00  	mv	s0, t3
80000a5c: 13 06 00 00  	mv	a2, zero
80000a60: 93 87 0f 00  	mv	a5, t6
;       C[i][j] = (double) ((i*(j+3)+1) % nl) / nl;
80000a64: b3 b4 e7 02  	mulhu	s1, a5, a4
80000a68: 93 d4 64 00  	srli	s1, s1, 6
80000a6c: b3 84 24 03  	mul	s1, s1, s2
80000a70: b3 84 97 40  	sub	s1, a5, s1
80000a74: 53 82 04 d2  	fcvt.d.w	ft4, s1
80000a78: 53 72 32 12  	fmul.d	ft4, ft4, ft3
80000a7c: b3 04 c4 00  	add	s1, s0, a2
80000a80: 27 b0 44 00  	fsd	ft4, 0(s1)
;     for (j = 0; j < nl; j++)
80000a84: 13 06 86 00  	addi	a2, a2, 8
80000a88: b3 87 b7 00  	add	a5, a5, a1
80000a8c: e3 1c 46 fd  	bne	a2, s4, 0x80000a64 <.LBB0_96+0xd0>
;   for (i = 0; i < nj; i++)
80000a90: 93 85 15 00  	addi	a1, a1, 1
80000a94: 13 04 04 28  	addi	s0, s0, 640
80000a98: 93 8f 3f 00  	addi	t6, t6, 3
80000a9c: e3 90 e5 fd  	bne	a1, t5, 0x80000a5c <.LBB0_96+0xc8>
;   for (i = 0; i < ni; i++)
80000aa0: b3 85 59 00  	add	a1, s3, t0
80000aa4: 13 d6 49 01  	srli	a2, s3, 20
80000aa8: 33 36 c0 00  	snez	a2, a2
80000aac: 37 07 12 00  	lui	a4, 288
80000ab0: 13 07 17 00  	addi	a4, a4, 1
80000ab4: b3 b5 e5 00  	sltu	a1, a1, a4
80000ab8: 33 79 b6 00  	and	s2, a2, a1

80000abc <.LBB0_97>:
80000abc: 97 37 00 00  	auipc	a5, 3
80000ac0: 93 87 47 c3  	addi	a5, a5, -972
80000ac4: 13 0f 00 00  	mv	t5, zero
80000ac8: 13 06 00 00  	mv	a2, zero
80000acc: 63 0e 09 08  	beqz	s2, 0x80000b68 <.LBB0_97+0xac>
80000ad0: 93 05 80 00  	addi	a1, zero, 8
80000ad4: 13 07 f0 04  	addi	a4, zero, 79
;   for (i = 0; i < ni; i++)
80000ad8: 13 04 00 04  	addi	s0, zero, 64
80000adc: ab 20 87 00  	scfgw	a4, s0
80000ae0: 13 07 00 0c  	addi	a4, zero, 192
80000ae4: ab a0 e5 00  	scfgw	a1, a4
80000ae8: 13 07 70 02  	addi	a4, zero, 39
80000aec: 13 04 00 06  	addi	s0, zero, 96
80000af0: ab 20 87 00  	scfgw	a4, s0
80000af4: 13 07 00 0e  	addi	a4, zero, 224
80000af8: ab a0 e5 00  	scfgw	a1, a4
80000afc: 93 05 00 02  	addi	a1, zero, 32
80000b00: ab 20 b0 00  	scfgw	zero, a1
80000b04: 2b a0 09 3a  	scfgwi	s3, 928
80000b08: f3 e5 00 7c  	csrrsi	a1, 1984, 1
80000b0c: b7 a5 0e ea  	lui	a1, 958698
80000b10: 87 b1 07 00  	fld	ft3, 0(a5)
80000b14: 13 87 b5 0e  	addi	a4, a1, 235
80000b18: 93 07 60 04  	addi	a5, zero, 70
80000b1c: 93 02 80 02  	addi	t0, zero, 40
80000b20: 13 04 00 05  	addi	s0, zero, 80
80000b24: 93 05 0f 00  	mv	a1, t5
;       D[i][j] = (double) (i*(j+2) % nk) / nk;
80000b28: 93 d4 15 00  	srli	s1, a1, 1
80000b2c: b3 b4 e4 02  	mulhu	s1, s1, a4
80000b30: 93 d4 54 00  	srli	s1, s1, 5
80000b34: b3 84 f4 02  	mul	s1, s1, a5
80000b38: b3 84 95 40  	sub	s1, a1, s1
80000b3c: 53 82 04 d2  	fcvt.d.w	ft4, s1
80000b40: 53 72 32 12  	fmul.d	ft4, ft4, ft3
80000b44: 53 00 42 22  	fmv.d	ft0, ft4
;     for (j = 0; j < nl; j++)
80000b48: 13 04 f4 ff  	addi	s0, s0, -1
80000b4c: b3 85 c5 00  	add	a1, a1, a2
80000b50: e3 1c 04 fc  	bnez	s0, 0x80000b28 <.LBB0_97+0x6c>
;   for (i = 0; i < ni; i++)
80000b54: 13 06 16 00  	addi	a2, a2, 1
80000b58: 13 0f 2f 00  	addi	t5, t5, 2
80000b5c: e3 12 56 fc  	bne	a2, t0, 0x80000b20 <.LBB0_97+0x64>
80000b60: f3 f5 00 7c  	csrrci	a1, 1984, 1
80000b64: 6f 00 80 06  	j	0x80000bcc <.LBB0_97+0x110>
80000b68: b7 a5 0e ea  	lui	a1, 958698
80000b6c: 13 87 b5 0e  	addi	a4, a1, 235
80000b70: 87 b1 07 00  	fld	ft3, 0(a5)
80000b74: 93 0f 60 04  	addi	t6, zero, 70
80000b78: 13 0a 00 28  	addi	s4, zero, 640
80000b7c: 93 02 80 02  	addi	t0, zero, 40
80000b80: 13 84 09 00  	mv	s0, s3
80000b84: 93 05 00 00  	mv	a1, zero
80000b88: 93 04 0f 00  	mv	s1, t5
;       D[i][j] = (double) (i*(j+2) % nk) / nk;
80000b8c: 93 d7 14 00  	srli	a5, s1, 1
80000b90: b3 b7 e7 02  	mulhu	a5, a5, a4
80000b94: 93 d7 57 00  	srli	a5, a5, 5
80000b98: b3 87 f7 03  	mul	a5, a5, t6
80000b9c: b3 87 f4 40  	sub	a5, s1, a5
80000ba0: 53 82 07 d2  	fcvt.d.w	ft4, a5
80000ba4: 53 72 32 12  	fmul.d	ft4, ft4, ft3
80000ba8: b3 07 b4 00  	add	a5, s0, a1
80000bac: 27 b0 47 00  	fsd	ft4, 0(a5)
;     for (j = 0; j < nl; j++)
80000bb0: 93 85 85 00  	addi	a1, a1, 8
80000bb4: b3 84 c4 00  	add	s1, s1, a2
80000bb8: e3 9a 45 fd  	bne	a1, s4, 0x80000b8c <.LBB0_97+0xd0>
;   for (i = 0; i < ni; i++)
80000bbc: 13 06 16 00  	addi	a2, a2, 1
80000bc0: 13 04 04 28  	addi	s0, s0, 640
80000bc4: 13 0f 2f 00  	addi	t5, t5, 2
80000bc8: e3 1e 56 fa  	bne	a2, t0, 0x80000b84 <.LBB0_97+0xc8>
;   for (i = 0; i < ni; i++) {
80000bcc: b3 f5 78 00  	and	a1, a7, t2
; size_t benchmark_get_cycle() { return read_csr(mcycle); }
80000bd0: f3 28 00 b0  	csrr	a7, mcycle
80000bd4: 63 8a 05 10  	beqz	a1, 0x80000ce8 <.LBB0_98+0x68>
80000bd8: 93 07 00 00  	mv	a5, zero
80000bdc: 93 05 80 00  	addi	a1, zero, 8
80000be0: 93 03 50 04  	addi	t2, zero, 69
;   for (i = 0; i < ni; i++) {
80000be4: 13 07 00 04  	addi	a4, zero, 64
80000be8: 93 04 00 0c  	addi	s1, zero, 192
80000bec: ab a0 e3 00  	scfgw	t2, a4
80000bf0: ab a0 95 00  	scfgw	a1, s1
80000bf4: 93 02 80 dd  	addi	t0, zero, -552
80000bf8: 93 04 10 03  	addi	s1, zero, 49
80000bfc: 13 04 00 06  	addi	s0, zero, 96
80000c00: 13 07 00 0e  	addi	a4, zero, 224
80000c04: ab a0 84 00  	scfgw	s1, s0
80000c08: ab a0 e2 00  	scfgw	t0, a4
80000c0c: 13 0f 70 02  	addi	t5, zero, 39
80000c10: 13 04 00 08  	addi	s0, zero, 128
80000c14: 93 02 00 10  	addi	t0, zero, 256
80000c18: ab 20 8f 00  	scfgw	t5, s0
80000c1c: ab a0 55 00  	scfgw	a1, t0
80000c20: 93 05 00 02  	addi	a1, zero, 32
80000c24: ab 20 b0 00  	scfgw	zero, a1
80000c28: 2b a0 06 34  	scfgwi	a3, 832
80000c2c: 93 06 00 19  	addi	a3, zero, 400
80000c30: 93 05 10 00  	addi	a1, zero, 1
;   for (i = 0; i < ni; i++) {
80000c34: 13 84 05 04  	addi	s0, a1, 64
80000c38: 13 86 05 0c  	addi	a2, a1, 192
80000c3c: ab a0 83 00  	scfgw	t2, s0
80000c40: ab a0 c6 00  	scfgw	a3, a2
80000c44: 37 96 ff ff  	lui	a2, 1048569
80000c48: 13 04 86 43  	addi	s0, a2, 1080
80000c4c: 13 87 05 06  	addi	a4, a1, 96
80000c50: ab a0 e4 00  	scfgw	s1, a4
80000c54: 13 87 05 0e  	addi	a4, a1, 224
80000c58: ab 20 e4 00  	scfgw	s0, a4
80000c5c: 13 06 86 2a  	addi	a2, a2, 680
80000c60: 13 87 05 08  	addi	a4, a1, 128
80000c64: 93 84 05 10  	addi	s1, a1, 256
80000c68: ab 20 ef 00  	scfgw	t5, a4
80000c6c: ab 20 96 00  	scfgw	a2, s1
80000c70: 93 85 05 02  	addi	a1, a1, 32
80000c74: ab 20 b0 00  	scfgw	zero, a1
80000c78: 2b a0 1e 34  	scfgwi	t4, 833
80000c7c: f3 e5 00 7c  	csrrsi	a1, 1984, 1

80000c80 <.LBB0_98>:
80000c80: 97 35 00 00  	auipc	a1, 3
80000c84: 93 85 85 a7  	addi	a1, a1, -1416
80000c88: 87 b1 05 00  	fld	ft3, 0(a1)
80000c8c: 53 02 00 d2  	fcvt.d.w	ft4, zero
80000c90: 93 05 20 03  	addi	a1, zero, 50
80000c94: 13 06 80 02  	addi	a2, zero, 40
80000c98: 13 07 00 00  	mv	a4, zero
;       tmp[i][j] = 0.0;
80000c9c: b3 84 d7 02  	mul	s1, a5, a3
80000ca0: b3 84 9a 00  	add	s1, s5, s1
80000ca4: 13 14 37 00  	slli	s0, a4, 3
80000ca8: b3 84 84 00  	add	s1, s1, s0
80000cac: 23 a2 04 00  	sw	zero, 4(s1)
80000cb0: 23 a0 04 00  	sw	zero, 0(s1)
80000cb4: 13 04 60 04  	addi	s0, zero, 70
80000cb8: d3 02 42 22  	fmv.d	ft5, ft4
;         tmp[i][j] += alpha * A[i][k] * B[k][j];
80000cbc: 53 73 30 12  	fmul.d	ft6, ft0, ft3
;       for (k = 0; k < nk; ++k) {
80000cc0: 13 04 f4 ff  	addi	s0, s0, -1
;         tmp[i][j] += alpha * A[i][k] * B[k][j];
80000cc4: c3 72 13 2a  	fmadd.d	ft5, ft6, ft1, ft5
;       for (k = 0; k < nk; ++k) {
80000cc8: e3 1a 04 fe  	bnez	s0, 0x80000cbc <.LBB0_98+0x3c>
;     for (j = 0; j < nj; j++) {
80000ccc: 13 07 17 00  	addi	a4, a4, 1
;         tmp[i][j] += alpha * A[i][k] * B[k][j];
80000cd0: 27 b0 54 00  	fsd	ft5, 0(s1)
;     for (j = 0; j < nj; j++) {
80000cd4: e3 14 b7 fc  	bne	a4, a1, 0x80000c9c <.LBB0_98+0x1c>
;   for (i = 0; i < ni; i++) {
80000cd8: 93 87 17 00  	addi	a5, a5, 1
80000cdc: e3 9e c7 fa  	bne	a5, a2, 0x80000c98 <.LBB0_98+0x18>
80000ce0: 73 f5 00 7c  	csrrci	a0, 1984, 1
80000ce4: 6f 00 00 09  	j	0x80000d74 <.LBB0_99+0x80>
80000ce8: 93 0f 00 00  	mv	t6, zero
80000cec: 93 03 00 19  	addi	t2, zero, 400
80000cf0: d3 01 00 d2  	fcvt.d.w	ft3, zero

80000cf4 <.LBB0_99>:
80000cf4: 97 35 00 00  	auipc	a1, 3
80000cf8: 93 85 45 a0  	addi	a1, a1, -1532
80000cfc: 07 b2 05 00  	fld	ft4, 0(a1)
80000d00: 13 06 00 23  	addi	a2, zero, 560
80000d04: 13 0f 20 03  	addi	t5, zero, 50
80000d08: 93 02 80 02  	addi	t0, zero, 40
80000d0c: 13 04 00 00  	mv	s0, zero
80000d10: 93 87 0e 00  	mv	a5, t4
80000d14: 93 04 00 00  	mv	s1, zero
;       tmp[i][j] = 0.0;
80000d18: b3 85 7f 02  	mul	a1, t6, t2
80000d1c: b3 85 ba 00  	add	a1, s5, a1
80000d20: 13 17 34 00  	slli	a4, s0, 3
80000d24: b3 85 e5 00  	add	a1, a1, a4
80000d28: 23 a2 05 00  	sw	zero, 4(a1)
80000d2c: 23 a0 05 00  	sw	zero, 0(a1)
80000d30: 13 87 07 00  	mv	a4, a5
80000d34: d3 82 31 22  	fmv.d	ft5, ft3
;         tmp[i][j] += alpha * A[i][k] * B[k][j];
80000d38: 33 85 96 00  	add	a0, a3, s1
80000d3c: 07 33 05 00  	fld	ft6, 0(a0)
80000d40: 87 33 07 00  	fld	ft7, 0(a4)
80000d44: 53 73 43 12  	fmul.d	ft6, ft6, ft4
80000d48: c3 72 73 2a  	fmadd.d	ft5, ft6, ft7, ft5
;       for (k = 0; k < nk; ++k) {
80000d4c: 93 84 84 00  	addi	s1, s1, 8
80000d50: 13 07 07 19  	addi	a4, a4, 400
80000d54: e3 92 c4 fe  	bne	s1, a2, 0x80000d38 <.LBB0_99+0x44>
;         tmp[i][j] += alpha * A[i][k] * B[k][j];
80000d58: 27 b0 55 00  	fsd	ft5, 0(a1)
;     for (j = 0; j < nj; j++) {
80000d5c: 13 04 14 00  	addi	s0, s0, 1
80000d60: 93 87 87 00  	addi	a5, a5, 8
80000d64: e3 18 e4 fb  	bne	s0, t5, 0x80000d14 <.LBB0_99+0x20>
;   for (i = 0; i < ni; i++) {
80000d68: 93 8f 1f 00  	addi	t6, t6, 1
80000d6c: 93 86 06 23  	addi	a3, a3, 560
80000d70: e3 9e 5f f8  	bne	t6, t0, 0x80000d0c <.LBB0_99+0x18>
;   for (i = 0; i < ni; i++) {
80000d74: 33 85 0a 01  	add	a0, s5, a6
80000d78: 93 d5 4a 01  	srli	a1, s5, 20
80000d7c: b3 35 b0 00  	snez	a1, a1
80000d80: 37 06 12 00  	lui	a2, 288
80000d84: 13 06 16 00  	addi	a2, a2, 1
80000d88: 33 35 c5 00  	sltu	a0, a0, a2
80000d8c: 33 f5 a5 00  	and	a0, a1, a0
80000d90: 33 75 25 01  	and	a0, a0, s2
80000d94: 13 06 00 00  	mv	a2, zero
80000d98: 33 75 a3 00  	and	a0, t1, a0
80000d9c: 63 00 05 1e  	beqz	a0, 0x80000f7c <.LBB0_100+0x110>
80000da0: 13 05 80 00  	addi	a0, zero, 8
80000da4: 13 08 f0 04  	addi	a6, zero, 79
;   for (i = 0; i < ni; i++) {
80000da8: 93 06 00 04  	addi	a3, zero, 64
80000dac: 13 07 00 0c  	addi	a4, zero, 192
80000db0: ab 20 d8 00  	scfgw	a6, a3
80000db4: ab 20 e5 00  	scfgw	a0, a4
80000db8: 93 06 70 02  	addi	a3, zero, 39
80000dbc: 13 07 00 06  	addi	a4, zero, 96
80000dc0: 93 07 00 0e  	addi	a5, zero, 224
80000dc4: ab a0 e6 00  	scfgw	a3, a4
80000dc8: ab 20 f5 00  	scfgw	a0, a5
80000dcc: 13 07 00 02  	addi	a4, zero, 32
80000dd0: ab 20 e0 00  	scfgw	zero, a4
80000dd4: 2b a0 09 32  	scfgwi	s3, 800
80000dd8: 13 07 10 03  	addi	a4, zero, 49
80000ddc: 93 07 10 00  	addi	a5, zero, 1
80000de0: 93 84 07 04  	addi	s1, a5, 64
80000de4: 13 84 07 0c  	addi	s0, a5, 192
80000de8: ab 20 97 00  	scfgw	a4, s1
80000dec: ab 20 85 00  	scfgw	a0, s0
80000df0: 93 04 80 e7  	addi	s1, zero, -392
80000df4: 13 84 07 06  	addi	s0, a5, 96
80000df8: ab 20 88 00  	scfgw	a6, s0
80000dfc: 13 84 07 0e  	addi	s0, a5, 224
80000e00: ab a0 84 00  	scfgw	s1, s0
80000e04: 93 84 07 08  	addi	s1, a5, 128
80000e08: 13 84 07 10  	addi	s0, a5, 256
80000e0c: ab a0 96 00  	scfgw	a3, s1
80000e10: ab 20 85 00  	scfgw	a0, s0
80000e14: 13 85 07 02  	addi	a0, a5, 32
80000e18: ab 20 a0 00  	scfgw	zero, a0
80000e1c: 2b a0 1a 34  	scfgwi	s5, 833
80000e20: 13 05 00 28  	addi	a0, zero, 640
80000e24: 93 07 20 00  	addi	a5, zero, 2
80000e28: 93 84 07 04  	addi	s1, a5, 64
80000e2c: 13 84 07 0c  	addi	s0, a5, 192
80000e30: ab 20 97 00  	scfgw	a4, s1
80000e34: ab 20 85 00  	scfgw	a0, s0
80000e38: 37 87 ff ff  	lui	a4, 1048568
80000e3c: 93 04 87 58  	addi	s1, a4, 1416
80000e40: 13 84 07 06  	addi	s0, a5, 96
80000e44: 93 85 07 0e  	addi	a1, a5, 224
80000e48: ab 20 88 00  	scfgw	a6, s0
80000e4c: ab a0 b4 00  	scfgw	s1, a1
80000e50: 93 05 87 30  	addi	a1, a4, 776
80000e54: 13 87 07 08  	addi	a4, a5, 128
80000e58: 93 84 07 10  	addi	s1, a5, 256
80000e5c: ab a0 e6 00  	scfgw	a3, a4
80000e60: ab a0 95 00  	scfgw	a1, s1
80000e64: 93 85 07 02  	addi	a1, a5, 32
80000e68: ab 20 b0 00  	scfgw	zero, a1

80000e6c <.LBB0_100>:
80000e6c: 97 35 00 00  	auipc	a1, 3
80000e70: 93 85 45 89  	addi	a1, a1, -1900
80000e74: 87 b1 05 00  	fld	ft3, 0(a1)
;   for (i = 0; i < ni; i++) {
80000e78: 2b 20 2e 34  	scfgwi	t3, 834
80000e7c: f3 e5 00 7c  	csrrsi	a1, 1984, 1
80000e80: 93 05 80 02  	addi	a1, zero, 40
80000e84: 93 86 09 00  	mv	a3, s3
80000e88: 13 07 00 00  	mv	a4, zero
;       D[i][j] *= beta;
80000e8c: 53 72 30 12  	fmul.d	ft4, ft0, ft3
;         D[i][j] += tmp[i][k] * C[k][j];
...
80000f3c: 43 72 11 22  	fmadd.d	ft4, ft2, ft1, ft4
80000f40: 43 72 11 22  	fmadd.d	ft4, ft2, ft1, ft4
80000f44: 43 72 11 22  	fmadd.d	ft4, ft2, ft1, ft4
80000f48: 43 72 11 22  	fmadd.d	ft4, ft2, ft1, ft4
80000f4c: 43 72 11 22  	fmadd.d	ft4, ft2, ft1, ft4
80000f50: 43 72 11 22  	fmadd.d	ft4, ft2, ft1, ft4
;       D[i][j] *= beta;
80000f54: b3 87 e6 00  	add	a5, a3, a4
;         D[i][j] += tmp[i][k] * C[k][j];
80000f58: 43 72 11 22  	fmadd.d	ft4, ft2, ft1, ft4
;     for (j = 0; j < nl; j++) {
80000f5c: 13 07 87 00  	addi	a4, a4, 8
;         D[i][j] += tmp[i][k] * C[k][j];
80000f60: 27 b0 47 00  	fsd	ft4, 0(a5)
;     for (j = 0; j < nl; j++) {
80000f64: e3 14 a7 f2  	bne	a4, a0, 0x80000e8c <.LBB0_100+0x20>
;   for (i = 0; i < ni; i++) {
80000f68: 13 06 16 00  	addi	a2, a2, 1
80000f6c: 93 86 06 28  	addi	a3, a3, 640
80000f70: e3 1c b6 f0  	bne	a2, a1, 0x80000e88 <.LBB0_100+0x1c>
80000f74: 73 f5 00 7c  	csrrci	a0, 1984, 1
80000f78: 6f 00 40 08  	j	0x80000ffc <.LBB0_101+0x7c>
80000f7c: 93 02 00 28  	addi	t0, zero, 640

80000f80 <.LBB0_101>:
80000f80: 17 25 00 00  	auipc	a0, 2
80000f84: 13 05 05 78  	addi	a0, a0, 1920
80000f88: 87 31 05 00  	fld	ft3, 0(a0)
80000f8c: 13 07 00 19  	addi	a4, zero, 400
80000f90: 13 03 00 05  	addi	t1, zero, 80
80000f94: 13 08 80 02  	addi	a6, zero, 40
80000f98: 93 05 00 00  	mv	a1, zero
80000f9c: 93 07 0e 00  	mv	a5, t3
;       D[i][j] *= beta;
80000fa0: 33 05 56 02  	mul	a0, a2, t0
80000fa4: 33 85 a9 00  	add	a0, s3, a0
80000fa8: 93 96 35 00  	slli	a3, a1, 3
80000fac: 33 04 d5 00  	add	s0, a0, a3
80000fb0: 07 32 04 00  	fld	ft4, 0(s0)
80000fb4: 93 06 00 00  	mv	a3, zero
;       D[i][j] *= beta;
80000fb8: 53 72 32 12  	fmul.d	ft4, ft4, ft3
80000fbc: 27 30 44 00  	fsd	ft4, 0(s0)
80000fc0: 93 84 07 00  	mv	s1, a5
;         D[i][j] += tmp[i][k] * C[k][j];
80000fc4: 33 85 da 00  	add	a0, s5, a3
80000fc8: 87 32 05 00  	fld	ft5, 0(a0)
80000fcc: 07 b3 04 00  	fld	ft6, 0(s1)
80000fd0: 43 72 53 22  	fmadd.d	ft4, ft6, ft5, ft4
;       for (k = 0; k < nj; ++k) {
80000fd4: 93 86 86 00  	addi	a3, a3, 8
80000fd8: 93 84 04 28  	addi	s1, s1, 640
80000fdc: e3 94 e6 fe  	bne	a3, a4, 0x80000fc4 <.LBB0_101+0x44>
;         D[i][j] += tmp[i][k] * C[k][j];
80000fe0: 27 30 44 00  	fsd	ft4, 0(s0)
;     for (j = 0; j < nl; j++) {
80000fe4: 93 85 15 00  	addi	a1, a1, 1
80000fe8: 93 87 87 00  	addi	a5, a5, 8
80000fec: e3 9a 65 fa  	bne	a1, t1, 0x80000fa0 <.LBB0_101+0x20>
;   for (i = 0; i < ni; i++) {
80000ff0: 13 06 16 00  	addi	a2, a2, 1
80000ff4: 93 8a 0a 19  	addi	s5, s5, 400
80000ff8: e3 10 06 fb  	bne	a2, a6, 0x80000f98 <.LBB0_101+0x18>
; size_t benchmark_get_cycle() { return read_csr(mcycle); }
80000ffc: 73 25 00 b0  	csrr	a0, mcycle
;   printf("cycles = %lu\n", end - start);
80001000: b3 05 15 41  	sub	a1, a0, a7

80001004 <.LBB0_102>:
80001004: 17 25 00 00  	auipc	a0, 2
80001008: 13 05 d5 45  	addi	a0, a0, 1117
8000100c: 97 00 00 00  	auipc	ra, 0
80001010: e7 80 c0 10  	jalr	268(ra)
80001014: 13 05 00 00  	mv	a0, zero
80001018: 63 04 09 06  	beqz	s2, 0x80001080 <.LBB0_102+0x7c>
8000101c: 93 05 80 00  	addi	a1, zero, 8
80001020: 13 06 f0 04  	addi	a2, zero, 79
;     for (int i = 0; i < n; i++){
80001024: 93 06 00 04  	addi	a3, zero, 64
80001028: ab 20 d6 00  	scfgw	a2, a3
8000102c: 13 06 00 0c  	addi	a2, zero, 192
80001030: ab a0 c5 00  	scfgw	a1, a2
80001034: 13 06 70 02  	addi	a2, zero, 39
80001038: 93 06 00 06  	addi	a3, zero, 96
8000103c: ab 20 d6 00  	scfgw	a2, a3
80001040: 13 06 00 0e  	addi	a2, zero, 224
80001044: ab a0 c5 00  	scfgw	a1, a2
80001048: 93 05 00 02  	addi	a1, zero, 32
8000104c: ab 20 b0 00  	scfgw	zero, a1
80001050: 2b a0 09 32  	scfgwi	s3, 800
80001054: f3 e5 00 7c  	csrrsi	a1, 1984, 1
80001058: d3 01 00 d2  	fcvt.d.w	ft3, zero
8000105c: 93 05 80 02  	addi	a1, zero, 40
80001060: 13 06 00 05  	addi	a2, zero, 80
;         for (int j = 0; j < m; j++){
80001064: 13 06 f6 ff  	addi	a2, a2, -1
;             r += A[i * m + j];
80001068: d3 71 30 02  	fadd.d	ft3, ft0, ft3
;         for (int j = 0; j < m; j++){
8000106c: e3 1c 06 fe  	bnez	a2, 0x80001064 <.LBB0_102+0x60>
;     for (int i = 0; i < n; i++){
80001070: 13 05 15 00  	addi	a0, a0, 1
80001074: e3 16 b5 fe  	bne	a0, a1, 0x80001060 <.LBB0_102+0x5c>
80001078: 73 f5 00 7c  	csrrci	a0, 1984, 1
8000107c: 6f 00 40 03  	j	0x800010b0 <.LBB0_103>
80001080: d3 01 00 d2  	fcvt.d.w	ft3, zero
80001084: 93 05 00 28  	addi	a1, zero, 640
80001088: 13 06 80 02  	addi	a2, zero, 40
8000108c: 93 06 00 00  	mv	a3, zero
;             r += A[i * m + j];
80001090: 33 87 d9 00  	add	a4, s3, a3
80001094: 07 32 07 00  	fld	ft4, 0(a4)
;         for (int j = 0; j < m; j++){
80001098: 93 86 86 00  	addi	a3, a3, 8
;             r += A[i * m + j];
8000109c: d3 71 32 02  	fadd.d	ft3, ft4, ft3
;         for (int j = 0; j < m; j++){
800010a0: e3 98 b6 fe  	bne	a3, a1, 0x80001090 <.LBB0_102+0x8c>
;     for (int i = 0; i < n; i++){
800010a4: 13 05 15 00  	addi	a0, a0, 1
800010a8: 93 89 09 28  	addi	s3, s3, 640
800010ac: e3 10 c5 fe  	bne	a0, a2, 0x8000108c <.LBB0_102+0x88>

800010b0 <.LBB0_103>:
800010b0: 17 25 00 00  	auipc	a0, 2
800010b4: 13 05 85 65  	addi	a0, a0, 1624
800010b8: 07 32 05 00  	fld	ft4, 0(a0)
;   double error = r - r_true;
800010bc: d3 f1 41 02  	fadd.d	ft3, ft3, ft4
;   error = error < 0.0 ? -error : error;
800010c0: 53 a4 31 22  	fabs.d	fs0, ft3
;   printf("error = %f\n", error);
800010c4: 27 30 81 00  	fsd	fs0, 0(sp)
800010c8: 03 26 01 00  	lw	a2, 0(sp)
800010cc: 83 26 41 00  	lw	a3, 4(sp)

800010d0 <.LBB0_104>:
800010d0: 17 25 00 00  	auipc	a0, 2
800010d4: 13 05 55 38  	addi	a0, a0, 901
800010d8: 97 00 00 00  	auipc	ra, 0
800010dc: e7 80 00 04  	jalr	64(ra)

800010e0 <.LBB0_105>:
800010e0: 17 25 00 00  	auipc	a0, 2
800010e4: 13 05 05 63  	addi	a0, a0, 1584
800010e8: 87 31 05 00  	fld	ft3, 0(a0)
;   return error > 0.0001;
800010ec: 53 95 81 a2  	flt.d	a0, ft3, fs0
; }
800010f0: 07 34 81 00  	fld	fs0, 8(sp)
800010f4: 83 2a 41 01  	lw	s5, 20(sp)
800010f8: 03 2a 81 01  	lw	s4, 24(sp)
...
80001174 <_vsnprintf.llvm.11632292163828655644>:
; {
...
80001d6c <_out_char.llvm.11632292163828655644>:
;   if (character) {
