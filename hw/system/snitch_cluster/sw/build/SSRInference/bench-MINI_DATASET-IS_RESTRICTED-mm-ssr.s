...
/home/thomas/Documents/eth/ba/code/all/snitch/hw/system/snitch_cluster/sw/build/SSRInference/bench-MINI_DATASET-IS_RESTRICTED-mm-ssr:	file format elf32-littleriscv

Sections:
Idx Name              Size     VMA      Type
  0                   00000000 00000000 
  1 .text             00002c50 80000000 TEXT
 ...
 13 .debug_info       0000346b 00000000 
 14 .debug_abbrev     00000c80 00000000 
 15 .debug_aranges    00000040 00000000 
 16 .debug_line       00002ca8 00000000 
...
800008dc: 13 05 95 7f  	addi	a0, a0, 2041
...
80000a14: 13 05 05 95  	addi	a0, a0, -1712
...
80000bb8: 13 06 06 53  	addi	a2, a2, 1328
...
80000d00: 13 06 c6 42  	addi	a2, a2, 1068
...
80000d6c: 13 06 86 3e  	addi	a2, a2, 1000
...
800016d4: 93 86 c6 d4  	addi	a3, a3, -692
...
80001748: 13 05 c5 bb  	addi	a0, a0, -1092
8000174c: 23 20 d5 00  	sw	a3, 0(a0)

80001750 <.LBB2_8>:
80001750: 17 25 00 00  	auipc	a0, 2
80001754: 13 05 05 bf  	addi	a0, a0, -1040
;         while (fromhost == 0)
...
800017b4: 93 84 04 bc  	addi	s1, s1, -1088
...
800018d0: 13 05 c5 aa  	addi	a0, a0, -1364
...
8000194c <.LBB4_88>:
8000194c: 17 1c 00 00  	auipc	s8, 1
80001950: 13 0c 3c 79  	addi	s8, s8, 1939
...
80001a74: 93 85 05 83  	addi	a1, a1, -2000
...
80001a94: 13 05 05 90  	addi	a0, a0, -1792
...
80001e8c: 93 84 04 51  	addi	s1, s1, 1296
80001e90: 87 b0 04 00  	fld	ft1, 0(s1)

80001e94 <.LBB5_44>:
80001e94: 97 14 00 00  	auipc	s1, 1
80001e98: 93 84 c4 50  	addi	s1, s1, 1292
...
80001f78: 93 85 45 43  	addi	a1, a1, 1076
80001f7c: 07 b1 05 00  	fld	ft2, 0(a1)

80001f80 <.LBB5_46>:
80001f80: 97 15 00 00  	auipc	a1, 1
80001f84: 93 85 05 43  	addi	a1, a1, 1072
...
80001fd4: 13 06 06 40  	addi	a2, a2, 1024
80001fd8: 87 31 06 00  	fld	ft3, 0(a2)

80001fdc <.LBB5_51>:
80001fdc: 17 16 00 00  	auipc	a2, 1
80001fe0: 13 06 c6 3f  	addi	a2, a2, 1020
...
80002010: 13 06 c6 3d  	addi	a2, a2, 988
80002014: 87 31 06 00  	fld	ft3, 0(a2)

80002018 <.LBB5_53>:
80002018: 17 16 00 00  	auipc	a2, 1
8000201c: 13 06 86 3d  	addi	a2, a2, 984
...
8000202c: 13 06 86 3b  	addi	a2, a2, 952
...
8000203c: 13 06 06 3c  	addi	a2, a2, 960
...
80002070: 93 86 46 39  	addi	a3, a3, 916
...
800020a4: 93 85 85 36  	addi	a1, a1, 872
800020a8: 07 b1 05 00  	fld	ft2, 0(a1)

800020ac <.LBB5_58>:
800020ac: 97 15 00 00  	auipc	a1, 1
800020b0: 93 85 45 36  	addi	a1, a1, 868
...
800027b8: 93 85 85 c6  	addi	a1, a1, -920
...
800028ac: 13 06 06 b7  	addi	a2, a2, -1168
...
80002928 <matmul_restricted>:
; void matmul_restricted(double *restrict C, double *restrict A, double *restrict B, int n, int p, int m){
80002928: 13 01 01 fe  	addi	sp, sp, -32
8000292c: 23 2e 11 00  	sw	ra, 28(sp)
80002930: 23 2c 81 00  	sw	s0, 24(sp)
80002934: 23 2a 91 00  	sw	s1, 20(sp)
80002938: 23 28 21 01  	sw	s2, 16(sp)
8000293c: 23 26 31 01  	sw	s3, 12(sp)
80002940: 23 24 41 01  	sw	s4, 8(sp)
80002944: 23 22 51 01  	sw	s5, 4(sp)
80002948: 23 20 61 01  	sw	s6, 0(sp)
8000294c: 93 89 06 00  	mv	s3, a3
;     for (int i = 0; i < n; i++){
80002950: 93 a6 16 00  	slti	a3, a3, 1
80002954: 93 a4 17 00  	slti	s1, a5, 1
80002958: b3 e6 96 00  	or	a3, a3, s1
8000295c: 63 96 06 2c  	bnez	a3, 0x80002c28 <matmul_restricted+0x300>
80002960: 13 0a 05 00  	mv	s4, a0
;     for (int i = 0; i < n; i++){
80002964: 13 88 f7 ff  	addi	a6, a5, -1
80002968: 93 1e 38 00  	slli	t4, a6, 3
8000296c: 13 8e f9 ff  	addi	t3, s3, -1
80002970: 13 99 37 00  	slli	s2, a5, 3
80002974: 33 05 c9 03  	mul	a0, s2, t3
80002978: 33 85 ae 00  	add	a0, t4, a0
8000297c: b3 06 45 01  	add	a3, a0, s4
80002980: 33 b5 a6 00  	sltu	a0, a3, a0
;             for (int k = 0; k < p; k++){
80002984: 63 50 e0 04  	blez	a4, 0x800029c4 <matmul_restricted+0x9c>
;     for (int i = 0; i < n; i++){
80002988: 93 03 f7 ff  	addi	t2, a4, -1
8000298c: 13 93 33 00  	slli	t1, t2, 3
80002990: 13 1f 37 00  	slli	t5, a4, 3
80002994: b3 04 cf 03  	mul	s1, t5, t3
80002998: 33 04 93 00  	add	s0, t1, s1
8000299c: 33 0b b4 00  	add	s6, s0, a1
800029a0: b3 02 79 02  	mul	t0, s2, t2
800029a4: b3 88 d2 01  	add	a7, t0, t4
800029a8: 93 54 4a 01  	srli	s1, s4, 20
800029ac: b3 3a 90 00  	snez	s5, s1
800029b0: b7 04 12 00  	lui	s1, 288
800029b4: 93 8f 14 00  	addi	t6, s1, 1
800029b8: 63 06 05 04  	beqz	a0, 0x80002a04 <matmul_restricted+0xdc>
800029bc: 13 05 00 00  	mv	a0, zero
800029c0: 6f 00 80 04  	j	0x80002a08 <matmul_restricted+0xe0>
800029c4: 93 55 4a 01  	srli	a1, s4, 20
800029c8: b3 35 b0 00  	snez	a1, a1
800029cc: 63 08 05 1e  	beqz	a0, 0x80002bbc <matmul_restricted+0x294>
800029d0: 13 05 00 00  	mv	a0, zero
800029d4: 33 f5 a5 00  	and	a0, a1, a0
800029d8: 63 1c 05 1e  	bnez	a0, 0x80002bd0 <matmul_restricted+0x2a8>
800029dc: 13 84 8e 00  	addi	s0, t4, 8
;             C[m*i + j] = c;
800029e0: 13 05 0a 00  	mv	a0, s4
800029e4: 93 05 00 00  	mv	a1, zero
800029e8: 13 06 09 00  	mv	a2, s2
800029ec: 97 e0 ff ff  	auipc	ra, 1048574
800029f0: e7 80 c0 b6  	jalr	-1172(ra)
;     for (int i = 0; i < n; i++){
800029f4: 93 89 f9 ff  	addi	s3, s3, -1
800029f8: 33 0a 8a 00  	add	s4, s4, s0
800029fc: e3 92 09 fe  	bnez	s3, 0x800029e0 <matmul_restricted+0xb8>
80002a00: 6f 00 80 22  	j	0x80002c28 <matmul_restricted+0x300>
80002a04: 33 b5 f6 01  	sltu	a0, a3, t6
;     for (int i = 0; i < n; i++){
80002a08: b3 86 c8 00  	add	a3, a7, a2
80002a0c: b3 fa aa 00  	and	s5, s5, a0
80002a10: 13 d5 45 01  	srli	a0, a1, 20
80002a14: 33 35 a0 00  	snez	a0, a0
80002a18: 63 76 8b 00  	bgeu	s6, s0, 0x80002a24 <matmul_restricted+0xfc>
80002a1c: 13 04 00 00  	mv	s0, zero
80002a20: 6f 00 80 00  	j	0x80002a28 <matmul_restricted+0x100>
80002a24: 33 34 fb 01  	sltu	s0, s6, t6
;     for (int i = 0; i < n; i++){
80002a28: 33 75 85 00  	and	a0, a0, s0
80002a2c: 33 75 55 01  	and	a0, a0, s5
80002a30: 13 54 46 01  	srli	s0, a2, 20
80002a34: 33 34 80 00  	snez	s0, s0
80002a38: 63 f6 16 01  	bgeu	a3, a7, 0x80002a44 <matmul_restricted+0x11c>
80002a3c: 93 06 00 00  	mv	a3, zero
80002a40: 6f 00 80 00  	j	0x80002a48 <matmul_restricted+0x120>
80002a44: b3 b6 f6 01  	sltu	a3, a3, t6
;     for (int i = 0; i < n; i++){
80002a48: b3 76 d4 00  	and	a3, s0, a3
80002a4c: 33 f5 a6 00  	and	a0, a3, a0
80002a50: 63 0e 05 0e  	beqz	a0, 0x80002b4c <matmul_restricted+0x224>
80002a54: 13 05 00 00  	mv	a0, zero
80002a58: 93 0e 80 00  	addi	t4, zero, 8
;     for (int i = 0; i < n; i++){
80002a5c: 93 04 00 04  	addi	s1, zero, 64
80002a60: ab 20 98 00  	scfgw	a6, s1
80002a64: 93 04 00 0c  	addi	s1, zero, 192
80002a68: ab a0 9e 00  	scfgw	t4, s1
80002a6c: 93 04 00 06  	addi	s1, zero, 96
80002a70: ab 20 9e 00  	scfgw	t3, s1
80002a74: 93 04 00 0e  	addi	s1, zero, 224
80002a78: ab a0 9e 00  	scfgw	t4, s1
80002a7c: 93 04 00 02  	addi	s1, zero, 32
80002a80: ab 20 90 00  	scfgw	zero, s1
80002a84: 2b 20 0a 3a  	scfgwi	s4, 928
80002a88: 93 04 10 00  	addi	s1, zero, 1
80002a8c: 13 84 04 04  	addi	s0, s1, 64
80002a90: ab a0 83 00  	scfgw	t2, s0
80002a94: 13 84 04 0c  	addi	s0, s1, 192
80002a98: ab a0 8e 00  	scfgw	t4, s0
80002a9c: 33 04 60 40  	neg	s0, t1
80002aa0: 93 86 04 06  	addi	a3, s1, 96
80002aa4: ab 20 d8 00  	scfgw	a6, a3
80002aa8: 93 86 04 0e  	addi	a3, s1, 224
80002aac: ab 20 d4 00  	scfgw	s0, a3
80002ab0: 93 86 04 08  	addi	a3, s1, 128
80002ab4: 13 84 04 10  	addi	s0, s1, 256
80002ab8: ab 20 de 00  	scfgw	t3, a3
80002abc: ab a0 8e 00  	scfgw	t4, s0
80002ac0: 93 86 04 02  	addi	a3, s1, 32
80002ac4: ab 20 d0 00  	scfgw	zero, a3
80002ac8: 2b a0 15 34  	scfgwi	a1, 833
80002acc: 93 05 20 00  	addi	a1, zero, 2
80002ad0: 93 86 05 04  	addi	a3, a1, 64
80002ad4: 93 84 05 0c  	addi	s1, a1, 192
80002ad8: ab a0 d3 00  	scfgw	t2, a3
80002adc: ab 20 99 00  	scfgw	s2, s1
80002ae0: b3 86 5e 40  	sub	a3, t4, t0
80002ae4: 93 84 05 06  	addi	s1, a1, 96
80002ae8: 13 84 05 0e  	addi	s0, a1, 224
80002aec: ab 20 98 00  	scfgw	a6, s1
80002af0: ab a0 86 00  	scfgw	a3, s0
80002af4: b3 06 10 41  	neg	a3, a7
80002af8: 93 84 05 08  	addi	s1, a1, 128
80002afc: 13 84 05 10  	addi	s0, a1, 256
80002b00: ab 20 9e 00  	scfgw	t3, s1
80002b04: ab a0 86 00  	scfgw	a3, s0
80002b08: 93 85 05 02  	addi	a1, a1, 32
80002b0c: ab 20 b0 00  	scfgw	zero, a1
80002b10: 2b 20 26 34  	scfgwi	a2, 834
80002b14: f3 e5 00 7c  	csrrsi	a1, 1984, 1
80002b18: d3 01 00 d2  	fcvt.d.w	ft3, zero
80002b1c: 93 05 00 00  	mv	a1, zero
80002b20: 13 06 07 00  	mv	a2, a4
80002b24: 53 82 31 22  	fmv.d	ft4, ft3
;             for (int k = 0; k < p; k++){
80002b28: 13 06 f6 ff  	addi	a2, a2, -1
;                 c += A[p*i + k] * B[k*m + j];
80002b2c: 43 72 11 22  	fmadd.d	ft4, ft2, ft1, ft4
;             for (int k = 0; k < p; k++){
80002b30: e3 1c 06 fe  	bnez	a2, 0x80002b28 <matmul_restricted+0x200>
;             C[m*i + j] = c;
80002b34: 53 00 42 22  	fmv.d	ft0, ft4
;         for (int j = 0; j < m; j++){
80002b38: 93 85 15 00  	addi	a1, a1, 1
80002b3c: e3 92 f5 fe  	bne	a1, a5, 0x80002b20 <matmul_restricted+0x1f8>
;     for (int i = 0; i < n; i++){
80002b40: 13 05 15 00  	addi	a0, a0, 1
80002b44: e3 1c 35 fd  	bne	a0, s3, 0x80002b1c <matmul_restricted+0x1f4>
80002b48: 6f 00 c0 0d  	j	0x80002c24 <matmul_restricted+0x2fc>
80002b4c: 13 08 00 00  	mv	a6, zero
;     for (int i = 0; i < n; i++){
80002b50: 93 86 8e 00  	addi	a3, t4, 8
...
80002b84: b3 84 d4 00  	add	s1, s1, a3
80002b88: 13 05 85 00  	addi	a0, a0, 8
80002b8c: e3 14 04 fe  	bnez	s0, 0x80002b74 <matmul_restricted+0x24c>
;             C[m*i + j] = c;
80002b90: 33 05 13 01  	add	a0, t1, a7
80002b94: 13 15 35 00  	slli	a0, a0, 3
80002b98: 33 05 aa 00  	add	a0, s4, a0
80002b9c: 27 30 45 00  	fsd	ft4, 0(a0)
;         for (int j = 0; j < m; j++){
80002ba0: 13 03 13 00  	addi	t1, t1, 1
80002ba4: 93 82 82 00  	addi	t0, t0, 8
80002ba8: e3 1e f3 fa  	bne	t1, a5, 0x80002b64 <matmul_restricted+0x23c>
;     for (int i = 0; i < n; i++){
80002bac: 13 08 18 00  	addi	a6, a6, 1
80002bb0: b3 85 e5 01  	add	a1, a1, t5
80002bb4: e3 12 38 fb  	bne	a6, s3, 0x80002b58 <matmul_restricted+0x230>
80002bb8: 6f 00 00 07  	j	0x80002c28 <matmul_restricted+0x300>
80002bbc: 37 05 12 00  	lui	a0, 288
80002bc0: 13 05 15 00  	addi	a0, a0, 1
80002bc4: 33 b5 a6 00  	sltu	a0, a3, a0
;     for (int i = 0; i < n; i++){
80002bc8: 33 f5 a5 00  	and	a0, a1, a0
80002bcc: e3 08 05 e0  	beqz	a0, 0x800029dc <matmul_restricted+0xb4>
80002bd0: 13 05 00 00  	mv	a0, zero
80002bd4: 93 05 80 00  	addi	a1, zero, 8
;     for (int i = 0; i < n; i++){
80002bd8: 13 06 00 04  	addi	a2, zero, 64
80002bdc: ab 20 c8 00  	scfgw	a6, a2
80002be0: 13 06 00 0c  	addi	a2, zero, 192
80002be4: ab a0 c5 00  	scfgw	a1, a2
80002be8: 13 06 00 06  	addi	a2, zero, 96
80002bec: 93 06 00 0e  	addi	a3, zero, 224
80002bf0: ab 20 ce 00  	scfgw	t3, a2
80002bf4: ab a0 d5 00  	scfgw	a1, a3
80002bf8: 93 05 00 02  	addi	a1, zero, 32
80002bfc: ab 20 b0 00  	scfgw	zero, a1
80002c00: 2b 20 0a 3a  	scfgwi	s4, 928
80002c04: f3 e5 00 7c  	csrrsi	a1, 1984, 1
80002c08: d3 01 00 d2  	fcvt.d.w	ft3, zero
80002c0c: 93 85 07 00  	mv	a1, a5
;             C[m*i + j] = c;
80002c10: 53 80 31 22  	fmv.d	ft0, ft3
;         for (int j = 0; j < m; j++){
80002c14: 93 85 f5 ff  	addi	a1, a1, -1
80002c18: e3 9c 05 fe  	bnez	a1, 0x80002c10 <matmul_restricted+0x2e8>
;     for (int i = 0; i < n; i++){
80002c1c: 13 05 15 00  	addi	a0, a0, 1
80002c20: e3 16 35 ff  	bne	a0, s3, 0x80002c0c <matmul_restricted+0x2e4>
80002c24: 73 f5 00 7c  	csrrci	a0, 1984, 1
;     return;
80002c28: 03 2b 01 00  	lw	s6, 0(sp)
80002c2c: 83 2a 41 00  	lw	s5, 4(sp)
80002c30: 03 2a 81 00  	lw	s4, 8(sp)
80002c34: 83 29 c1 00  	lw	s3, 12(sp)
80002c38: 03 29 01 01  	lw	s2, 16(sp)
80002c3c: 83 24 41 01  	lw	s1, 20(sp)
80002c40: 03 24 81 01  	lw	s0, 24(sp)
80002c44: 83 20 c1 01  	lw	ra, 28(sp)
80002c48: 13 01 01 02  	addi	sp, sp, 32
80002c4c: 67 80 00 00  	ret
...
80002e08: e7 80 c0 8b  	jalr	-1860(ra)
;     lw        a0, 0(sp)
...
80002f3c: e7 80 80 92  	jalr	-1752(ra)
;     csrr    t0, misa
...
8000305c: e7 80 00 7f  	jalr	2032(ra)
;     lw        a0, 0(a0)
...
8000308c: e7 80 00 7a  	jalr	1952(ra)
;     lw        t0, 0(sp)
