...
Idx Name              Size     VMA      Type
 ...
 16 .debug_line       0000395b 00000000 
...
80002070: 63 06 08 00  	beqz	a6, 0x8000207c <.LBB0_180+0x6ec>
...
80002088: 63 82 06 02  	beqz	a3, 0x800020ac <.LBB0_180+0x71c>
8000208c: 13 06 00 00  	mv	a2, zero
80002090: 33 87 e7 00  	add	a4, a5, a4
80002094: 63 12 08 02  	bnez	a6, 0x800020b8 <.LBB0_180+0x728>
...
800020b4: e3 02 08 fe  	beqz	a6, 0x80002098 <.LBB0_180+0x708>
...
8000225c: b3 05 95 00  	add	a1, a0, s1
...
;  for (i = 0; i < ni; i++)
80002270: 93 88 00 5a  	addi	a7, ra, 1440
80002274: 93 87 80 62  	addi	a5, ra, 1576
80002278: 63 06 08 02  	beqz	a6, 0x800022a4 <.LBB0_180+0x914>
8000227c: 13 07 00 00  	mv	a4, zero
80002280: 13 86 8d 05  	addi	a2, s11, 88
80002284: 63 e6 17 03  	bltu	a5, a7, 0x800022b0 <.LBB0_180+0x920>
80002288: b3 b7 77 00  	sltu	a5, a5, t2
;  for (i = 0; i < ni; i++)
8000228c: b3 04 96 00  	add	s1, a2, s1
80002290: 63 16 08 02  	bnez	a6, 0x800022bc <.LBB0_180+0x92c>
80002294: b3 35 14 01  	sltu	a1, s0, a7
;  for (i = 0; i < ni; i++)
...
800022a4: 33 37 a4 00  	sltu	a4, s0, a0
;  for (i = 0; i < ni; i++)
800022a8: 13 86 8d 05  	addi	a2, s11, 88
800022ac: e3 fe 17 fd  	bgeu	a5, a7, 0x80002288 <.LBB0_180+0x8f8>
800022b0: 93 07 00 00  	mv	a5, zero
800022b4: b3 04 96 00  	add	s1, a2, s1
800022b8: e3 0e 08 fc  	beqz	a6, 0x80002294 <.LBB0_180+0x904>
800022bc: 93 05 00 00  	mv	a1, zero
800022c0: e3 fe c4 fc  	bgeu	s1, a2, 0x8000229c <.LBB0_180+0x90c>
800022c4: 93 04 00 00  	mv	s1, zero
800022c8: b3 66 d7 00  	or	a3, a4, a3
800022cc: 33 e7 f5 00  	or	a4, a1, a5
800022d0: 63 06 08 00  	beqz	a6, 0x800022dc <.LBB0_180+0x94c>
800022d4: 93 07 00 00  	mv	a5, zero
800022d8: 6f 00 80 00  	j	0x800022e0 <.LBB0_180+0x950>
800022dc: b3 37 c4 00  	sltu	a5, s0, a2
;  for (i = 0; i < ni; i++)
...
800023ac: 2b a0 18 32  	scfgwi	a7, 801
...
800026f0: 03 24 41 02  	lw	s0, 36(sp)
;   for (i = 0; i < nj; i++)
800026f4: 33 05 c4 01  	add	a0, s0, t3
800026f8: b3 35 85 00  	sltu	a1, a0, s0
800026fc: 93 02 85 2f  	addi	t0, a0, 760
80002700: 33 b5 a2 00  	sltu	a0, t0, a0
80002704: 33 83 a5 00  	add	t1, a1, a0
80002708: 83 24 c1 03  	lw	s1, 60(sp)
8000270c: 33 06 94 00  	add	a2, s0, s1
80002710: 13 05 86 41  	addi	a0, a2, 1048
80002714: b7 15 00 00  	lui	a1, 1
80002718: 93 85 85 07  	addi	a1, a1, 120
8000271c: 83 28 c1 04  	lw	a7, 76(sp)
80002720: b3 86 b8 00  	add	a3, a7, a1
80002724: 63 06 03 00  	beqz	t1, 0x80002730 <.LBB0_180+0xda0>
80002728: 93 05 00 00  	mv	a1, zero
8000272c: 6f 00 80 00  	j	0x80002734 <.LBB0_180+0xda4>
80002730: b3 b5 12 01  	sltu	a1, t0, a7
;   for (i = 0; i < nj; i++)
80002734: 33 37 86 00  	sltu	a4, a2, s0
80002738: b3 37 c5 00  	sltu	a5, a0, a2
8000273c: 63 f2 16 03  	bgeu	a3, a7, 0x80002760 <.LBB0_180+0xdd0>
80002740: 13 06 00 00  	mv	a2, zero
80002744: 33 07 f7 00  	add	a4, a4, a5
80002748: 63 12 03 02  	bnez	t1, 0x8000276c <.LBB0_180+0xddc>
8000274c: b3 b6 92 00  	sltu	a3, t0, s1
;   for (i = 0; i < nj; i++)
80002750: b3 e5 c5 00  	or	a1, a1, a2
80002754: 63 12 07 02  	bnez	a4, 0x80002778 <.LBB0_180+0xde8>
80002758: 33 35 c5 01  	sltu	a0, a0, t3
8000275c: 6f 00 00 02  	j	0x8000277c <.LBB0_180+0xdec>
80002760: 33 b6 c6 01  	sltu	a2, a3, t3
;   for (i = 0; i < nj; i++)
80002764: 33 07 f7 00  	add	a4, a4, a5
80002768: e3 02 03 fe  	beqz	t1, 0x8000274c <.LBB0_180+0xdbc>
8000276c: 93 06 00 00  	mv	a3, zero
80002770: b3 e5 c5 00  	or	a1, a1, a2
80002774: e3 02 07 fe  	beqz	a4, 0x80002758 <.LBB0_180+0xdc8>
80002778: 13 05 00 00  	mv	a0, zero
8000277c: 33 e5 a6 00  	or	a0, a3, a0
...
800027b4: 23 20 51 00  	sw	t0, 0(sp)
800027b8: 23 2c 61 00  	sw	t1, 24(sp)
...
80002918: 13 86 04 09  	addi	a2, s1, 144
8000291c: 13 07 04 36  	addi	a4, s0, 864
80002920: b3 36 87 00  	sltu	a3, a4, s0
80002924: 33 05 e6 00  	add	a0, a2, a4
80002928: b3 35 c5 00  	sltu	a1, a0, a2
8000292c: b3 87 b6 00  	add	a5, a3, a1
80002930: 93 85 08 42  	addi	a1, a7, 1056
80002934: 13 84 48 47  	addi	s0, a7, 1140
...
80002948: 33 35 c5 01  	sltu	a0, a0, t3
;   for (i = 0; i < nj; i++)
8000294c: b3 07 e8 00  	add	a5, a6, a4
80002950: 93 83 05 42  	addi	t2, a1, 1056
80002954: 93 05 44 47  	addi	a1, s0, 1140
80002958: 63 06 03 02  	beqz	t1, 0x80002984 <.LBB0_180+0xff4>
8000295c: 13 07 00 00  	mv	a4, zero
80002960: 33 b4 07 01  	sltu	s0, a5, a6
80002964: 63 e6 75 02  	bltu	a1, t2, 0x80002990 <.LBB0_180+0x1000>
80002968: b3 b5 c5 01  	sltu	a1, a1, t3
;   for (i = 0; i < nj; i++)
8000296c: b3 86 86 00  	add	a3, a3, s0
80002970: 63 16 03 02  	bnez	t1, 0x8000299c <.LBB0_180+0x100c>
80002974: 33 b4 72 00  	sltu	s0, t0, t2
;   for (i = 0; i < nj; i++)
...
80002a54: 2b 20 06 32  	scfgwi	a2, 800
...
80002a8c: 2b a0 13 32  	scfgwi	t2, 801
...
80002c8c: 23 28 71 02  	sw	t2, 48(sp)
