...
/home/thomas/Documents/eth/ba/code/all/snitch/hw/system/snitch_cluster/sw/build/snRuntime/test-snRuntime-fp8alt_comparison_scalar:	file format elf32-littleriscv

Sections:
Idx Name              Size     VMA      Type
  0                   00000000 00000000 
  1 .text             00000560 80000000 TEXT
...
80000028: 63 f6 c5 2c  	bgeu	a1, a2, 0x800002f4 <main+0x2f4>
;         asm volatile(
...
80000040: 13 08 50 f4  	addi	a6, zero, -187
80000044: 93 08 50 fc  	addi	a7, zero, -59
80000048: 13 07 d0 f3  	addi	a4, zero, -195
8000004c: 93 07 d0 fb  	addi	a5, zero, -67
;         asm volatile(
80000050: d3 01 08 f0  	fmv.w.x	ft3, a6
80000054: 53 82 08 f0  	fmv.w.x	ft4, a7
80000058: d3 02 07 f0  	fmv.w.x	ft5, a4
8000005c: 53 83 07 f0  	fmv.w.x	ft6, a5
;         asm volatile(
80000060: d3 a5 31 a6  	feq.b	a1, ft3, ft3
80000064: 53 25 42 a6  	feq.b	a0, ft4, ft4
80000068: d3 a6 52 a6  	feq.b	a3, ft5, ft5
8000006c: 53 26 63 a6  	feq.b	a2, ft6, ft6
;         errs -= (cmp0 == 0x1);
80000070: 13 87 f5 ff  	addi	a4, a1, -1
80000074: 13 37 17 00  	seqz	a4, a4
;         errs -= (cmp1 == 0x1);
80000078: 93 07 f5 ff  	addi	a5, a0, -1
8000007c: 93 b7 17 00  	seqz	a5, a5
80000080: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp2 == 0x1);
80000084: 93 87 f6 ff  	addi	a5, a3, -1
80000088: 93 b7 17 00  	seqz	a5, a5
8000008c: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp3 == 0x1);
80000090: 93 07 f6 ff  	addi	a5, a2, -1
80000094: 93 b7 17 00  	seqz	a5, a5
80000098: 33 07 f7 00  	add	a4, a4, a5
;         asm volatile(
8000009c: d3 a5 41 a6  	feq.b	a1, ft3, ft4
800000a0: 53 25 52 a6  	feq.b	a0, ft4, ft5
800000a4: d3 a6 62 a6  	feq.b	a3, ft5, ft6
800000a8: 53 a6 61 a6  	feq.b	a2, ft3, ft6
;         errs -= (cmp0 == 0x0);
800000ac: 93 b7 15 00  	seqz	a5, a1
800000b0: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp1 == 0x0);
800000b4: 93 37 15 00  	seqz	a5, a0
800000b8: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp2 == 0x0);
800000bc: 93 b7 16 00  	seqz	a5, a3
800000c0: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp3 == 0x0);
800000c4: 93 37 16 00  	seqz	a5, a2
800000c8: 33 07 f7 00  	add	a4, a4, a5
;         asm volatile(
800000cc: d3 85 31 a6  	fle.b	a1, ft3, ft3
800000d0: 53 05 42 a6  	fle.b	a0, ft4, ft4
800000d4: d3 86 52 a6  	fle.b	a3, ft5, ft5
800000d8: 53 06 63 a6  	fle.b	a2, ft6, ft6
;         errs -= (cmp0 == 0x1);
800000dc: 93 87 f5 ff  	addi	a5, a1, -1
...
;         errs -= (cmp2 == 0x1);
800000f4: 93 87 f6 ff  	addi	a5, a3, -1
800000f8: 93 b7 17 00  	seqz	a5, a5
800000fc: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp3 == 0x1);
80000100: 93 07 f6 ff  	addi	a5, a2, -1
80000104: 93 b7 17 00  	seqz	a5, a5
80000108: 33 07 f7 00  	add	a4, a4, a5
;         asm volatile(
8000010c: d3 85 41 a6  	fle.b	a1, ft3, ft4
80000110: 53 05 52 a6  	fle.b	a0, ft4, ft5
80000114: d3 86 62 a6  	fle.b	a3, ft5, ft6
80000118: 53 86 61 a6  	fle.b	a2, ft3, ft6
;         errs -= (cmp0 == 0x0);
8000011c: 93 b7 15 00  	seqz	a5, a1
...
;         errs -= (cmp2 == 0x0);
80000130: 93 b7 16 00  	seqz	a5, a3
80000134: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp3 == 0x0);
80000138: 93 37 16 00  	seqz	a5, a2
8000013c: 33 07 f7 00  	add	a4, a4, a5
;         asm volatile(
80000140: d3 95 31 a6  	flt.b	a1, ft3, ft3
80000144: 53 15 42 a6  	flt.b	a0, ft4, ft4
80000148: d3 96 52 a6  	flt.b	a3, ft5, ft5
8000014c: 53 16 63 a6  	flt.b	a2, ft6, ft6
;         errs -= (cmp0 == 0x0);
80000150: 93 b7 15 00  	seqz	a5, a1
80000154: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp1 == 0x0);
80000158: 93 37 15 00  	seqz	a5, a0
8000015c: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp2 == 0x0);
80000160: 93 b7 16 00  	seqz	a5, a3
80000164: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp3 == 0x0);
80000168: 93 37 16 00  	seqz	a5, a2
8000016c: 33 07 f7 00  	add	a4, a4, a5
;         asm volatile(
80000170: d3 95 41 a6  	flt.b	a1, ft3, ft4
80000174: 53 15 52 a6  	flt.b	a0, ft4, ft5
80000178: d3 96 62 a6  	flt.b	a3, ft5, ft6
8000017c: 53 96 61 a6  	flt.b	a2, ft3, ft6
;         errs -= (cmp0 == 0x0);
80000180: 93 b7 15 00  	seqz	a5, a1
80000184: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp1 == 0x1);
80000188: 93 07 f5 ff  	addi	a5, a0, -1
8000018c: 93 b7 17 00  	seqz	a5, a5
80000190: 33 07 f7 00  	add	a4, a4, a5
;         errs -= (cmp2 == 0x0);
80000194: 93 b6 16 00  	seqz	a3, a3
80000198: b3 06 d7 00  	add	a3, a4, a3
;         errs -= (cmp3 == 0x0);
8000019c: 13 36 16 00  	seqz	a2, a2
800001a0: 53 00 00 f0  	fmv.w.x	ft0, zero
;         errs -= (cmp3 == 0x0);
800001a4: 33 86 c6 00  	add	a2, a3, a2
;         asm volatile(
800001a8: d3 00 00 20  	fmv.s	ft1, ft0
800001ac: d3 80 31 2e  	fmin.b	ft1, ft3, ft3
800001b0: 53 00 42 2e  	fmin.b	ft0, ft4, ft4
;         asm volatile(
800001b4: d3 a5 30 a6  	feq.b	a1, ft1, ft3
800001b8: 53 25 40 a6  	feq.b	a0, ft0, ft4
;         errs -= (cmp0 == 0x1);
800001bc: 93 86 f5 ff  	addi	a3, a1, -1
800001c0: 93 b6 16 00  	seqz	a3, a3
800001c4: 33 06 d6 00  	add	a2, a2, a3
;         errs -= (cmp1 == 0x1);
800001c8: 93 06 f5 ff  	addi	a3, a0, -1
800001cc: 93 b6 16 00  	seqz	a3, a3
800001d0: 33 06 d6 00  	add	a2, a2, a3
;         asm volatile(
800001d4: d3 80 52 2e  	fmin.b	ft1, ft5, ft5
800001d8: 53 00 63 2e  	fmin.b	ft0, ft6, ft6
;         asm volatile(
800001dc: d3 a5 50 a6  	feq.b	a1, ft1, ft5
800001e0: 53 25 60 a6  	feq.b	a0, ft0, ft6
;         errs -= (cmp0 == 0x1);
800001e4: 93 86 f5 ff  	addi	a3, a1, -1
800001e8: 93 b6 16 00  	seqz	a3, a3
800001ec: 33 06 d6 00  	add	a2, a2, a3
;         errs -= (cmp1 == 0x1);
800001f0: 93 06 f5 ff  	addi	a3, a0, -1
800001f4: 93 b6 16 00  	seqz	a3, a3
800001f8: 33 06 d6 00  	add	a2, a2, a3
;         asm volatile(
800001fc: d3 80 41 2e  	fmin.b	ft1, ft3, ft4
80000200: 53 00 52 2e  	fmin.b	ft0, ft4, ft5
;         asm volatile(
80000204: d3 a5 40 a6  	feq.b	a1, ft1, ft4
80000208: 53 25 40 a6  	feq.b	a0, ft0, ft4
;         errs -= (cmp0 == 0x1);
8000020c: 93 86 f5 ff  	addi	a3, a1, -1
80000210: 93 b6 16 00  	seqz	a3, a3
80000214: 33 06 d6 00  	add	a2, a2, a3
;         errs -= (cmp1 == 0x1);
80000218: 93 06 f5 ff  	addi	a3, a0, -1
8000021c: 93 b6 16 00  	seqz	a3, a3
80000220: 33 06 d6 00  	add	a2, a2, a3
;         asm volatile(
80000224: d3 80 62 2e  	fmin.b	ft1, ft5, ft6
80000228: 53 80 61 2e  	fmin.b	ft0, ft3, ft6
;         asm volatile(
8000022c: d3 a5 60 a6  	feq.b	a1, ft1, ft6
80000230: 53 25 60 a6  	feq.b	a0, ft0, ft6
;         errs -= (cmp0 == 0x1);
80000234: 93 86 f5 ff  	addi	a3, a1, -1
80000238: 93 b6 16 00  	seqz	a3, a3
8000023c: 33 06 d6 00  	add	a2, a2, a3
;         errs -= (cmp1 == 0x1);
80000240: 93 06 f5 ff  	addi	a3, a0, -1
80000244: 93 b6 16 00  	seqz	a3, a3
80000248: 33 06 d6 00  	add	a2, a2, a3
;         asm volatile(
8000024c: d3 90 31 2e  	fmax.b	ft1, ft3, ft3
80000250: 53 10 42 2e  	fmax.b	ft0, ft4, ft4
;         asm volatile(
80000254: d3 a5 30 a6  	feq.b	a1, ft1, ft3
80000258: 53 25 40 a6  	feq.b	a0, ft0, ft4
;         errs -= (cmp0 == 0x1);
8000025c: 93 86 f5 ff  	addi	a3, a1, -1
80000260: 93 b6 16 00  	seqz	a3, a3
80000264: 33 06 d6 00  	add	a2, a2, a3
;         errs -= (cmp1 == 0x1);
80000268: 93 06 f5 ff  	addi	a3, a0, -1
8000026c: 93 b6 16 00  	seqz	a3, a3
80000270: 33 06 d6 00  	add	a2, a2, a3
;         asm volatile(
80000274: d3 90 52 2e  	fmax.b	ft1, ft5, ft5
80000278: 53 10 63 2e  	fmax.b	ft0, ft6, ft6
;         asm volatile(
8000027c: d3 a5 50 a6  	feq.b	a1, ft1, ft5
80000280: 53 25 60 a6  	feq.b	a0, ft0, ft6
;         errs -= (cmp0 == 0x1);
80000284: 93 86 f5 ff  	addi	a3, a1, -1
80000288: 93 b6 16 00  	seqz	a3, a3
8000028c: 33 06 d6 00  	add	a2, a2, a3
;         errs -= (cmp1 == 0x1);
80000290: 93 06 f5 ff  	addi	a3, a0, -1
80000294: 93 b6 16 00  	seqz	a3, a3
80000298: 33 06 d6 00  	add	a2, a2, a3
;         asm volatile(
8000029c: d3 90 41 2e  	fmax.b	ft1, ft3, ft4
800002a0: 53 10 52 2e  	fmax.b	ft0, ft4, ft5
;         asm volatile(
800002a4: d3 a5 30 a6  	feq.b	a1, ft1, ft3
800002a8: 53 25 50 a6  	feq.b	a0, ft0, ft5
;         errs -= (cmp0 == 0x1);
800002ac: 93 86 f5 ff  	addi	a3, a1, -1
800002b0: 93 b6 16 00  	seqz	a3, a3
800002b4: 33 06 d6 00  	add	a2, a2, a3
;         errs -= (cmp1 == 0x1);
800002b8: 93 06 f5 ff  	addi	a3, a0, -1
800002bc: 93 b6 16 00  	seqz	a3, a3
800002c0: 33 06 d6 00  	add	a2, a2, a3
;         asm volatile(
800002c4: d3 90 62 2e  	fmax.b	ft1, ft5, ft6
800002c8: 53 90 61 2e  	fmax.b	ft0, ft3, ft6
;         asm volatile(
800002cc: d3 a5 50 a6  	feq.b	a1, ft1, ft5
800002d0: 53 25 30 a6  	feq.b	a0, ft0, ft3
;         errs -= (cmp0 == 0x1);
800002d4: 93 85 f5 ff  	addi	a1, a1, -1
800002d8: 93 b5 15 00  	seqz	a1, a1
800002dc: b3 05 b6 00  	add	a1, a2, a1
;         errs -= (cmp1 == 0x1);
800002e0: 13 05 f5 ff  	addi	a0, a0, -1
800002e4: 13 35 15 00  	seqz	a0, a0
800002e8: 33 85 a5 00  	add	a0, a1, a0
800002ec: 93 05 80 02  	addi	a1, zero, 40
800002f0: 33 85 a5 40  	sub	a0, a1, a0
;     return errs;
800002f4: 67 80 00 00  	ret

800002f8 <snrt_global_core_idx>:
...
80000308: 03 25 85 00  	lw	a0, 8(a0)
;     asm("csrr %0, mhartid" : "=r"(hartid));
8000030c: f3 25 40 f1  	csrr	a1, mhartid
;     return snrt_hartid() - _snrt_team_current->root->global_core_base_hartid;
80000310: 33 85 a5 40  	sub	a0, a1, a0
80000314: 67 80 00 00  	ret

80000318 <_snrt_barrier_reg_ptr>:
;     return _snrt_team_current->root->barrier_reg_ptr;
80000318: 37 05 00 00  	lui	a0, 0
8000031c: 33 05 45 00  	add	a0, a0, tp
80000320: 03 25 05 00  	lw	a0, 0(a0)
80000324: 03 25 05 00  	lw	a0, 0(a0)
80000328: 03 25 05 07  	lw	a0, 112(a0)
8000032c: 67 80 00 00  	ret

80000330 <__snrt_isr>:
;     uint32_t cause = read_csr(mcause);
80000330: 73 25 20 34  	csrr	a0, mcause
;     if (cause & MCAUSE_INTERRUPT) {
80000334: 63 44 05 00  	bltz	a0, 0x8000033c <__snrt_isr+0xc>
;         while (1)
80000338: 6f 00 00 00  	j	0x80000338 <__snrt_isr+0x8>
8000033c: b7 05 00 80  	lui	a1, 524288
80000340: 93 85 f5 ff  	addi	a1, a1, -1
;         switch (cause & ~MCAUSE_INTERRUPT) {
80000344: 33 75 b5 00  	and	a0, a0, a1
80000348: 13 05 d5 ff  	addi	a0, a0, -3
8000034c: 93 55 25 00  	srli	a1, a0, 2
80000350: 13 15 e5 01  	slli	a0, a0, 30
80000354: 33 65 b5 00  	or	a0, a0, a1
80000358: 93 05 40 00  	addi	a1, zero, 4
8000035c: 63 0a b5 06  	beq	a0, a1, 0x800003d0 <.LBB1_7+0x58>
80000360: 63 1a 05 08  	bnez	a0, 0x800003f4 <.LBB1_7+0x7c>
80000364: 37 05 00 00  	lui	a0, 0
80000368: 33 05 45 00  	add	a0, a0, tp
8000036c: 03 25 05 00  	lw	a0, 0(a0)
80000370: 03 25 05 00  	lw	a0, 0(a0)
80000374: f3 25 40 f1  	csrr	a1, mhartid

80000378 <.LBB1_7>:
;     asm volatile(
80000378: 17 06 00 00  	auipc	a2, 0
8000037c: 13 06 06 6e  	addi	a2, a2, 1760
80000380: 03 25 85 00  	lw	a0, 8(a0)
;     asm volatile(
80000384: 93 06 06 00  	mv	a3, a2
80000388: 93 02 10 00  	addi	t0, zero, 1
8000038c: af a2 56 0c  	amoswap.w.aq	t0, t0, (a3)
80000390: e3 9e 02 fe  	bnez	t0, 0x8000038c <.LBB1_7+0x14>
;     *(clint_p + ((hartid & ~0x1f) >> 5)) &= ~(1 << (hartid & 0x1f));
80000394: b7 06 00 00  	lui	a3, 0
80000398: b3 86 46 00  	add	a3, a3, tp
8000039c: 83 a6 86 00  	lw	a3, 8(a3)
800003a0: 33 85 a5 40  	sub	a0, a1, a0
800003a4: 93 55 35 00  	srli	a1, a0, 3
800003a8: 93 f5 c5 ff  	andi	a1, a1, -4
800003ac: b3 85 b6 00  	add	a1, a3, a1
800003b0: 83 a6 05 00  	lw	a3, 0(a1)
800003b4: 13 07 10 00  	addi	a4, zero, 1
800003b8: 33 15 a7 00  	sll	a0, a4, a0
800003bc: 13 45 f5 ff  	not	a0, a0
800003c0: 33 f5 a6 00  	and	a0, a3, a0
800003c4: 23 a0 a5 00  	sw	a0, 0(a1)
;     asm volatile("amoswap.w.rl  x0,x0,(%0)   # Release lock by storing 0\n"
800003c8: 2f 20 06 0a  	amoswap.w.rl	zero, zero, (a2)
; }
800003cc: 67 80 00 00  	ret
; uint32_t snrt_cluster_core_idx() { return _snrt_core_idx; }
800003d0: 37 05 00 00  	lui	a0, 0
800003d4: 33 05 45 00  	add	a0, a0, tp
800003d8: 03 25 45 00  	lw	a0, 4(a0)
; void snrt_int_cluster_clr(uint32_t mask) { cl_clint_clr(mask); }
800003dc: b7 05 00 00  	lui	a1, 0
800003e0: b3 85 45 00  	add	a1, a1, tp
800003e4: 83 a5 c5 00  	lw	a1, 12(a1)
800003e8: 13 06 10 00  	addi	a2, zero, 1
;     snrt_int_cluster_clr(1 << cluster_core_idx);
800003ec: 33 15 a6 00  	sll	a0, a2, a0
; void snrt_int_cluster_clr(uint32_t mask) { cl_clint_clr(mask); }
800003f0: 23 a4 a5 00  	sw	a0, 8(a1)
; }
800003f4: 67 80 00 00  	ret

800003f8 <_snrt_init_team>:
;     team->base.root = team;
800003f8: 23 a0 f7 00  	sw	a5, 0(a5)
;     team->bootdata = (void *)bootdata;
800003fc: 23 a2 e7 00  	sw	a4, 4(a5)
;     team->global_core_base_hartid = bootdata->hartid_base;
80000400: 03 23 87 00  	lw	t1, 8(a4)
80000404: 23 a4 67 00  	sw	t1, 8(a5)
;     team->global_core_num = bootdata->core_count * bootdata->cluster_count *
80000408: 03 28 87 02  	lw	a6, 40(a4)
;                             bootdata->s1_quadrant_count;
8000040c: 83 28 c7 02  	lw	a7, 44(a4)
;     team->global_core_num = bootdata->core_count * bootdata->cluster_count *
80000410: 83 22 47 00  	lw	t0, 4(a4)
80000414: 33 88 08 03  	mul	a6, a7, a6
80000418: 33 05 58 02  	mul	a0, a6, t0
8000041c: 23 a6 a7 00  	sw	a0, 12(a5)
;     asm("csrr %0, mhartid" : "=r"(hartid));
80000420: f3 28 40 f1  	csrr	a7, mhartid
;         (snrt_hartid() - bootdata->hartid_base) / bootdata->core_count;
80000424: 33 85 68 40  	sub	a0, a7, t1
80000428: 33 55 55 02  	divu	a0, a0, t0
;     team->cluster_idx =
8000042c: 23 a8 a7 00  	sw	a0, 16(a5)
;     team->cluster_num = bootdata->cluster_count * bootdata->s1_quadrant_count;
80000430: 23 aa 07 01  	sw	a6, 20(a5)
;     team->cluster_core_base_hartid = bootdata->hartid_base;
80000434: 23 ac 67 00  	sw	t1, 24(a5)
;     team->cluster_core_num = cluster_core_num;
80000438: 23 ae b7 00  	sw	a1, 28(a5)
;         (uint64_t)(bootdata->global_mem_start + _snrt_cluster_global_offset);
8000043c: 03 25 87 01  	lw	a0, 24(a4)
80000440: b7 05 00 10  	lui	a1, 65536
80000444: 33 05 b5 00  	add	a0, a0, a1
;     team->global_mem.start =
80000448: 23 a2 07 02  	sw	zero, 36(a5)
8000044c: 23 a0 a7 02  	sw	a0, 32(a5)
;     team->global_mem.end = (uint64_t)bootdata->global_mem_end;
80000450: 03 25 07 02  	lw	a0, 32(a4)
80000454: 83 25 47 02  	lw	a1, 36(a4)
80000458: 23 a4 a7 02  	sw	a0, 40(a5)
8000045c: 23 a6 b7 02  	sw	a1, 44(a5)
;     team->cluster_mem.start = (uint64_t)spm_start;
80000460: 23 a8 c7 02  	sw	a2, 48(a5)
80000464: 23 aa 07 02  	sw	zero, 52(a5)
;     team->cluster_mem.end = (uint64_t)spm_end;
80000468: 23 ac d7 02  	sw	a3, 56(a5)
8000046c: 23 ae 07 02  	sw	zero, 60(a5)
;     team->barrier_reg_ptr = (uint32_t)spm_start + bootdata->tcdm_size +
80000470: 03 25 07 01  	lw	a0, 16(a4)
80000474: 33 08 a6 00  	add	a6, a2, a0
80000478: 93 05 08 19  	addi	a1, a6, 400
8000047c: 23 a8 b7 06  	sw	a1, 112(a5)
;         (uint64_t)spm_start + bootdata->tcdm_size + bootdata->tcdm_size / 2;
80000480: b3 32 a8 00  	sltu	t0, a6, a0
80000484: 93 55 15 00  	srli	a1, a0, 1
80000488: 33 03 b8 00  	add	t1, a6, a1
8000048c: b3 35 03 01  	sltu	a1, t1, a6
80000490: b3 85 b2 00  	add	a1, t0, a1
;     team->zero_mem.start =
80000494: 23 a0 67 04  	sw	t1, 64(a5)
80000498: 23 a2 b7 04  	sw	a1, 68(a5)
;     team->zero_mem.end = (uint64_t)spm_start + 2 * bootdata->tcdm_size;
8000049c: 13 15 15 00  	slli	a0, a0, 1
800004a0: b3 05 c5 00  	add	a1, a0, a2
800004a4: 33 b5 a5 00  	sltu	a0, a1, a0
800004a8: 23 a4 b7 04  	sw	a1, 72(a5)
800004ac: 23 a6 a7 04  	sw	a0, 76(a5)
;     team->cluster_barrier.barrier = 0;
800004b0: 23 a4 07 06  	sw	zero, 104(a5)
;     team->cluster_barrier.barrier_iteration = 0;
800004b4: 23 a6 07 06  	sw	zero, 108(a5)
;     _snrt_team_current = &team->base;
800004b8: 37 05 00 00  	lui	a0, 0
800004bc: 33 05 45 00  	add	a0, a0, tp
800004c0: 23 20 f5 00  	sw	a5, 0(a0)
;         (snrt_hartid() - _snrt_team_current->root->cluster_core_base_hartid) %
800004c4: 03 a5 07 00  	lw	a0, 0(a5)
800004c8: 83 25 85 01  	lw	a1, 24(a0)
;         _snrt_team_current->root->cluster_core_num;
800004cc: 03 25 c5 01  	lw	a0, 28(a0)
;         (snrt_hartid() - _snrt_team_current->root->cluster_core_base_hartid) %
800004d0: b3 85 b8 40  	sub	a1, a7, a1
800004d4: 33 f5 a5 02  	remu	a0, a1, a0
;     _snrt_core_idx =
800004d8: b7 05 00 00  	lui	a1, 0
800004dc: b3 85 45 00  	add	a1, a1, tp
800004e0: 23 a2 a5 00  	sw	a0, 4(a1)
800004e4: 13 05 80 44  	addi	a0, zero, 1096
;     putc_buffer[snrt_hartid()].hdr.size = 0;
800004e8: 33 85 a8 02  	mul	a0, a7, a0

800004ec <.LBB0_1>:
800004ec: 97 05 00 00  	auipc	a1, 0
800004f0: 93 85 05 57  	addi	a1, a1, 1392
800004f4: 33 05 b5 00  	add	a0, a0, a1
800004f8: 23 20 05 00  	sw	zero, 0(a0)
;     team->peripherals.clint = (uint32_t *)bootdata->clint_base;
800004fc: 83 28 07 03  	lw	a7, 48(a4)
80000500: 23 aa 17 07  	sw	a7, 116(a5)
;     team->peripherals.perf_counters =
80000504: 23 ae 07 07  	sw	a6, 124(a5)
;     team->peripherals.wakeup = (uint32_t *)0;  // not supported in RTL anymore
80000508: 23 ac 07 06  	sw	zero, 120(a5)
;         (uint32_t *)(spm_start + bootdata->tcdm_size +
8000050c: 13 07 08 18  	addi	a4, a6, 384
;     team->peripherals.cl_clint =
80000510: 23 a0 e7 08  	sw	a4, 128(a5)
;         ALIGN_UP((uint32_t)team->cluster_mem.start, MIN_CHUNK_SIZE);
80000514: 13 05 76 00  	addi	a0, a2, 7
80000518: 13 75 85 ff  	andi	a0, a0, -8
;     team->allocator.l1.base =
8000051c: 23 a8 a7 04  	sw	a0, 80(a5)
;         (uint32_t)(team->cluster_mem.end - team->cluster_mem.start);
80000520: 33 86 c6 40  	sub	a2, a3, a2
;     team->allocator.l1.size =
80000524: 23 aa c7 04  	sw	a2, 84(a5)
;     team->allocator.l1.next = team->allocator.l1.base;
80000528: 23 ac a7 04  	sw	a0, 88(a5)
;         ALIGN_UP((uint32_t)_edram + l3off, MIN_CHUNK_SIZE);
8000052c: 03 a5 05 00  	lw	a0, 0(a1)
80000530: 13 05 f5 44  	addi	a0, a0, 1103
80000534: 13 75 85 ff  	andi	a0, a0, -8
;     team->allocator.l3.base =
80000538: 23 ae a7 04  	sw	a0, 92(a5)
;     team->allocator.l3.size = 0;
8000053c: 23 a0 07 06  	sw	zero, 96(a5)
;     team->allocator.l3.next = team->allocator.l3.base;
80000540: 23 a2 a7 06  	sw	a0, 100(a5)
;     clint_p = team->peripherals.clint;
80000544: 37 05 00 00  	lui	a0, 0
80000548: 33 05 45 00  	add	a0, a0, tp
8000054c: 23 24 15 01  	sw	a7, 8(a0)
;     cl_clint_p = team->peripherals.cl_clint;
80000550: 37 05 00 00  	lui	a0, 0
80000554: 33 05 45 00  	add	a0, a0, tp
80000558: 23 26 e5 00  	sw	a4, 12(a0)
; }
...
80000718: e7 80 40 ce  	jalr	-796(ra)
;     lw        a0, 0(sp)
...
8000084c: e7 80 80 ae  	jalr	-1304(ra)
;     csrr    t0, misa
...
8000096c: e7 80 00 9b  	jalr	-1616(ra)
;     lw        a0, 0(a0)
...
8000099c: e7 80 00 96  	jalr	-1696(ra)
;     lw        t0, 0(sp)
