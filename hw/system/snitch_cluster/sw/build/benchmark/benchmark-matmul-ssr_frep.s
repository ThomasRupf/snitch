...
/home/thomas/Documents/eth/ba/code/all/snitch/hw/system/snitch_cluster/sw/build/benchmark/benchmark-matmul-ssr_frep:	file format elf32-littleriscv

Sections:
Idx Name              Size     VMA      Type
  0                   00000000 00000000 
  1 .text             000029e0 80000000 TEXT
  2 .init             00000468 800029e0 TEXT
  3 .rodata           000002c0 80002e48 DATA
 ...
 13 .debug_info       00003fd3 00000000 
 14 .debug_abbrev     00000ea1 00000000 
 15 .debug_aranges    00000040 00000000 
 16 .debug_line       000031fc 00000000 
 17 .debug_str        00000e3c 00000000 
 18 .comment          00000029 00000000 
 19 .riscv.attributes 00000037 00000000 
 20 .debug_frame      00000398 00000000 
 21 .debug_loc        00003533 00000000 
 22 .debug_ranges     00000588 00000000 
 23 .symtab           00003a50 00000000 
 24 .shstrtab         000000ea 00000000 
 25 .strtab           00000983 00000000 
...
80000674: 13 05 85 86  	addi	a0, a0, -1944
...
800007e4: 13 06 86 71  	addi	a2, a2, 1816
...
8000092c: 13 06 46 61  	addi	a2, a2, 1556
...
80000998: 13 06 06 5d  	addi	a2, a2, 1488
...
8000151c: 13 0c 7c 9d  	addi	s8, s8, -1577
...
8000157c: 13 0c cc 97  	addi	s8, s8, -1668
...
800016a0: 93 85 c5 a1  	addi	a1, a1, -1508
...
80002598: e7 80 c0 84  	jalr	-1972(ra)
...
800025c8: 93 8d 4d 88  	addi	s11, s11, -1916
...
80002648: e7 80 c0 79  	jalr	1948(ra)
8000264c: 97 00 00 00  	auipc	ra, 0
80002650: e7 80 40 79  	jalr	1940(ra)
...
800026f0: e7 80 40 6f  	jalr	1780(ra)
; size_t benchmark_get_cycle() { return read_csr(mcycle); }
...
8000272c: e7 80 80 6b  	jalr	1720(ra)
; size_t benchmark_get_cycle() { return read_csr(mcycle); }
...
80002778: 13 04 c4 6d  	addi	s0, s0, 1756
...
80002848: 93 d6 25 00  	srli	a3, a1, 2
;     --b0;
8000284c: 13 06 f6 ff  	addi	a2, a2, -1
;     --b1;
80002850: 93 87 f6 ff  	addi	a5, a3, -1
;     --b2;
80002854: 13 0f f5 ff  	addi	t5, a0, -1
;     asm volatile(
80002858: 93 02 00 04  	addi	t0, zero, 64
8000285c: 13 03 06 00  	mv	t1, a2
80002860: ab 20 53 00  	scfgw	t1, t0
80002864: 93 02 00 06  	addi	t0, zero, 96
80002868: 13 83 07 00  	mv	t1, a5
8000286c: ab 20 53 00  	scfgw	t1, t0
80002870: 93 02 00 08  	addi	t0, zero, 128
80002874: 13 03 0f 00  	mv	t1, t5
80002878: ab 20 53 00  	scfgw	t1, t0
8000287c: 93 0e 80 00  	addi	t4, zero, 8
80002880: 93 02 00 0c  	addi	t0, zero, 192
80002884: 13 03 80 00  	addi	t1, zero, 8
80002888: ab 20 53 00  	scfgw	t1, t0
;     a += i0 * b0;
8000288c: 93 16 36 00  	slli	a3, a2, 3
80002890: 33 03 d0 40  	neg	t1, a3
;     asm volatile(
80002894: 93 02 00 0e  	addi	t0, zero, 224
80002898: ab 20 53 00  	scfgw	t1, t0
;     a += i1 * b1;
8000289c: b3 06 c7 40  	sub	a3, a4, a2
800028a0: 13 93 36 00  	slli	t1, a3, 3
;     asm volatile(
...
800028b8: 93 16 38 00  	slli	a3, a6, 3
;     asm volatile(
...
80002950: 73 e7 00 7c  	csrrsi	a4, 1984, 1
;     for (uint32_t n = 0; n < N; n++) {
80002954: 63 96 06 06  	bnez	a3, 0x800029c0 <gemm_seq_ssr_frep+0x194>
80002958: 03 27 01 01  	lw	a4, 16(sp)
8000295c: 13 03 00 00  	mv	t1, zero
;     for (uint32_t n = 0; n < N; n++) {
80002960: 93 86 08 01  	addi	a3, a7, 16
80002964: 13 18 37 00  	slli	a6, a4, 3
80002968: 93 07 00 00  	mv	a5, zero
8000296c: 13 87 06 00  	mv	a4, a3
;             register double c0 = C[n * ldC + m + 0];
80002970: 87 31 07 ff  	fld	ft3, -16(a4)
;             register double c1 = C[n * ldC + m + 1];
80002974: 07 32 87 ff  	fld	ft4, -8(a4)
;             register double c2 = C[n * ldC + m + 2];
80002978: 87 32 07 00  	fld	ft5, 0(a4)
;             register double c3 = C[n * ldC + m + 3];
8000297c: 07 33 87 00  	fld	ft6, 8(a4)
;             asm volatile(
80002980: 93 02 06 00  	mv	t0, a2
80002984: 8b 80 32 00  	frep.o	t0, 4, 0, 0
80002988: c3 71 10 1a  	fmadd.d	ft3, ft0, ft1, ft3
8000298c: 43 72 10 22  	fmadd.d	ft4, ft0, ft1, ft4
80002990: c3 72 10 2a  	fmadd.d	ft5, ft0, ft1, ft5
80002994: 43 73 10 32  	fmadd.d	ft6, ft0, ft1, ft6
;             C[n * ldC + m + 0] = c0;
80002998: 27 38 37 fe  	fsd	ft3, -16(a4)
;             C[n * ldC + m + 1] = c1;
8000299c: 27 3c 47 fe  	fsd	ft4, -8(a4)
;             C[n * ldC + m + 2] = c2;
800029a0: 27 30 57 00  	fsd	ft5, 0(a4)
;             C[n * ldC + m + 3] = c3;
800029a4: 27 34 67 00  	fsd	ft6, 8(a4)
;         for (uint32_t m = 0; m < M; m += 4) {
800029a8: 93 87 47 00  	addi	a5, a5, 4
800029ac: 13 07 07 02  	addi	a4, a4, 32
800029b0: e3 e0 b7 fc  	bltu	a5, a1, 0x80002970 <gemm_seq_ssr_frep+0x144>
;     for (uint32_t n = 0; n < N; n++) {
800029b4: 13 03 13 00  	addi	t1, t1, 1
800029b8: b3 86 06 01  	add	a3, a3, a6
800029bc: e3 16 a3 fa  	bne	t1, a0, 0x80002968 <gemm_seq_ssr_frep+0x13c>
; void snrt_fpu_fence() { asm volatile("fmv.x.w zero, fa0"); }
800029c0: 53 00 05 e0  	fmv.x.w	zero, fa0
;     __builtin_ssr_disable();
800029c4: 73 f5 00 7c  	csrrci	a0, 1984, 1
;     asm volatile("" ::"f"(ft0), "f"(ft1));
800029c8: 87 31 81 00  	fld	ft3, 8(sp)
800029cc: 07 32 01 00  	fld	ft4, 0(sp)
800029d0: 53 80 31 22  	fmv.d	ft0, ft3
800029d4: d3 00 42 22  	fmv.d	ft1, ft4
; }
800029d8: 13 01 01 01  	addi	sp, sp, 16
800029dc: 67 80 00 00  	ret

Disassembly of section .init:

800029e0 <snrt.crt0.init_global_pointer>:
; 1:  auipc     gp, %pcrel_hi(__global_pointer$)
800029e0: 97 11 00 00  	auipc	gp, 1
;     addi      gp, gp, %pcrel_lo(1b)
800029e4: 93 81 81 fa  	addi	gp, gp, -88

800029e8 <snrt.crt0.init_core_info>:
;     call      _snrt_init_core_info
800029e8: 97 00 00 00  	auipc	ra, 0
800029ec: e7 80 40 3c  	jalr	964(ra)

800029f0 <snrt.crt0.init_bss>:
;     mv        s0, a0 # store a0 in s0 since we dont have a stack yet
800029f0: 13 04 05 00  	mv	s0, a0
;     mv        a0, a4
800029f4: 13 05 07 00  	mv	a0, a4
;     call      _snrt_get_base_hartid
800029f8: 97 00 00 00  	auipc	ra, 0
800029fc: e7 80 c0 40  	jalr	1036(ra)
;     mv        t0, a0
80002a00: 93 02 05 00  	mv	t0, a0
;     mv        a0, s0
80002a04: 13 05 04 00  	mv	a0, s0
;     csrr      t1, mhartid
80002a08: 73 23 40 f1  	csrr	t1, mhartid
;     sub       t0, t1, t0
80002a0c: b3 02 53 40  	sub	t0, t1, t0
;     bnez      t0, 2f
80002a10: 63 92 02 02  	bnez	t0, 0x80002a34 <snrt.crt0.init_registers>

80002a14 <.Lpcrel_hi0>:
;     la        t0, _edata
80002a14: 97 12 00 00  	auipc	t0, 1
80002a18: 93 82 42 84  	addi	t0, t0, -1980

80002a1c <.Lpcrel_hi1>:
;     la        t1, _end
80002a1c: 17 13 00 00  	auipc	t1, 1
80002a20: 13 03 03 84  	addi	t1, t1, -1984
;     bge       t0, t1, 2f
80002a24: 63 d8 62 00  	bge	t0, t1, 0x80002a34 <snrt.crt0.init_registers>
; 1:  sw        zero, 0(t0)
80002a28: 23 a0 02 00  	sw	zero, 0(t0)
;     addi      t0, t0, 4
80002a2c: 93 82 42 00  	addi	t0, t0, 4
;     blt       t0, t1, 1b
80002a30: e3 cc 62 fe  	blt	t0, t1, 0x80002a28 <.Lpcrel_hi1+0xc>

80002a34 <snrt.crt0.init_registers>:
;     csrr    t0, misa
80002a34: f3 22 10 30  	csrr	t0, misa
;     andi    t0, t0, (1 << 3) | (1 << 5) # D/F - single/double precision float extension
80002a38: 93 f2 82 02  	andi	t0, t0, 40
;     beqz    t0, 3f
80002a3c: 63 82 02 08  	beqz	t0, 0x80002ac0 <snrt.crt0.init_stack>
;     fcvt.d.w f0, zero
80002a40: 53 00 00 d2  	fcvt.d.w	ft0, zero
;     fcvt.d.w f1, zero
80002a44: d3 00 00 d2  	fcvt.d.w	ft1, zero
;     fcvt.d.w f2, zero
80002a48: 53 01 00 d2  	fcvt.d.w	ft2, zero
;     fcvt.d.w f3, zero
80002a4c: d3 01 00 d2  	fcvt.d.w	ft3, zero
;     fcvt.d.w f4, zero
80002a50: 53 02 00 d2  	fcvt.d.w	ft4, zero
;     fcvt.d.w f5, zero
80002a54: d3 02 00 d2  	fcvt.d.w	ft5, zero
;     fcvt.d.w f6, zero
80002a58: 53 03 00 d2  	fcvt.d.w	ft6, zero
;     fcvt.d.w f7, zero
80002a5c: d3 03 00 d2  	fcvt.d.w	ft7, zero
;     fcvt.d.w f8, zero
80002a60: 53 04 00 d2  	fcvt.d.w	fs0, zero
;     fcvt.d.w f9, zero
80002a64: d3 04 00 d2  	fcvt.d.w	fs1, zero
;     fcvt.d.w f10, zero
80002a68: 53 05 00 d2  	fcvt.d.w	fa0, zero
;     fcvt.d.w f11, zero
80002a6c: d3 05 00 d2  	fcvt.d.w	fa1, zero
;     fcvt.d.w f12, zero
80002a70: 53 06 00 d2  	fcvt.d.w	fa2, zero
;     fcvt.d.w f13, zero
80002a74: d3 06 00 d2  	fcvt.d.w	fa3, zero
;     fcvt.d.w f14, zero
80002a78: 53 07 00 d2  	fcvt.d.w	fa4, zero
;     fcvt.d.w f15, zero
80002a7c: d3 07 00 d2  	fcvt.d.w	fa5, zero
;     fcvt.d.w f16, zero
80002a80: 53 08 00 d2  	fcvt.d.w	fa6, zero
;     fcvt.d.w f17, zero
80002a84: d3 08 00 d2  	fcvt.d.w	fa7, zero
;     fcvt.d.w f18, zero
80002a88: 53 09 00 d2  	fcvt.d.w	fs2, zero
;     fcvt.d.w f19, zero
80002a8c: d3 09 00 d2  	fcvt.d.w	fs3, zero
;     fcvt.d.w f20, zero
80002a90: 53 0a 00 d2  	fcvt.d.w	fs4, zero
;     fcvt.d.w f21, zero
80002a94: d3 0a 00 d2  	fcvt.d.w	fs5, zero
;     fcvt.d.w f22, zero
80002a98: 53 0b 00 d2  	fcvt.d.w	fs6, zero
;     fcvt.d.w f23, zero
80002a9c: d3 0b 00 d2  	fcvt.d.w	fs7, zero
;     fcvt.d.w f24, zero
80002aa0: 53 0c 00 d2  	fcvt.d.w	fs8, zero
;     fcvt.d.w f25, zero
80002aa4: d3 0c 00 d2  	fcvt.d.w	fs9, zero
;     fcvt.d.w f26, zero
80002aa8: 53 0d 00 d2  	fcvt.d.w	fs10, zero
;     fcvt.d.w f27, zero
80002aac: d3 0d 00 d2  	fcvt.d.w	fs11, zero
;     fcvt.d.w f28, zero
80002ab0: 53 0e 00 d2  	fcvt.d.w	ft8, zero
;     fcvt.d.w f29, zero
80002ab4: d3 0e 00 d2  	fcvt.d.w	ft9, zero
;     fcvt.d.w f30, zero
80002ab8: 53 0f 00 d2  	fcvt.d.w	ft10, zero
;     fcvt.d.w f31, zero
80002abc: d3 0f 00 d2  	fcvt.d.w	ft11, zero

80002ac0 <snrt.crt0.init_stack>:
;     addi      a3, a3, -8
80002ac0: 93 86 86 ff  	addi	a3, a3, -8
;     sw        zero, 0(a3)
80002ac4: 23 a0 06 00  	sw	zero, 0(a3)

80002ac8 <.Lpcrel_hi2>:
;     lw        t0, _snrt_team_size
80002ac8: 97 02 00 00  	auipc	t0, 0
80002acc: 83 a2 c2 40  	lw	t0, 1036(t0)
;     sub       a3, a3, t0
80002ad0: b3 86 56 40  	sub	a3, a3, t0
;     mv        a5, a3
80002ad4: 93 87 06 00  	mv	a5, a3

80002ad8 <.Lpcrel_hi3>:
;     lw        t2, snrt_stack_size  # load stack size (overridable by binary)
80002ad8: 97 03 00 00  	auipc	t2, 0
80002adc: 83 a3 83 3f  	lw	t2, 1016(t2)
;     sll       t0, a0, t2  # this hart
80002ae0: b3 12 75 00  	sll	t0, a0, t2
;     sll       t1, a1, t2  # all harts
80002ae4: 33 93 75 00  	sll	t1, a1, t2
;     sub       sp, a3, t0
80002ae8: 33 81 56 40  	sub	sp, a3, t0
;     sub       a3, a3, t1
80002aec: b3 86 66 40  	sub	a3, a3, t1
;     slli      t0, a0, 3  # this hart
80002af0: 93 12 35 00  	slli	t0, a0, 3
;     slli      t1, a1, 3  # all harts
80002af4: 13 93 35 00  	slli	t1, a1, 3
;     sub       sp, sp, t0
80002af8: 33 01 51 40  	sub	sp, sp, t0
;     sub       a3, a3, t1
80002afc: b3 86 66 40  	sub	a3, a3, t1

80002b00 <snrt.crt0.init_tls>:
;     la        t0, __tdata_start
80002b00: 97 02 00 00  	auipc	t0, 0
80002b04: 93 82 82 68  	addi	t0, t0, 1672

80002b08 <.Lpcrel_hi5>:
;     la        t1, __tdata_end
80002b08: 17 03 00 00  	auipc	t1, 0
80002b0c: 13 03 03 68  	addi	t1, t1, 1664

80002b10 <.Lpcrel_hi6>:
;     la        t2, __tbss_start
80002b10: 97 03 00 00  	auipc	t2, 0
80002b14: 93 83 83 67  	addi	t2, t2, 1656

80002b18 <.Lpcrel_hi7>:
;     la        t3, __tbss_end
80002b18: 17 0e 00 00  	auipc	t3, 0
80002b1c: 13 0e 0e 68  	addi	t3, t3, 1664
;     add       sp, sp, t0   # subtract sp to make room for TLS and align
80002b20: 33 01 51 00  	add	sp, sp, t0
;     sub       sp, sp, t1
80002b24: 33 01 61 40  	sub	sp, sp, t1
;     add       sp, sp, t2
80002b28: 33 01 71 00  	add	sp, sp, t2
;     sub       sp, sp, t3
80002b2c: 33 01 c1 41  	sub	sp, sp, t3
;     andi      sp, sp, ~0x7
80002b30: 13 71 81 ff  	andi	sp, sp, -8
;     mv        tp, sp       # palce tp at start of TLS
80002b34: 13 02 01 00  	mv	tp, sp
;     andi      sp, sp, ~0x7 # align stack to 8B
80002b38: 13 71 81 ff  	andi	sp, sp, -8
;     mv        t4, tp
80002b3c: 93 0e 02 00  	mv	t4, tp
;     bge       t0, t1, 2f
80002b40: 63 dc 62 00  	bge	t0, t1, 0x80002b58 <.Lpcrel_hi8>
; 1:  lw        t5, 0(t0)
80002b44: 03 af 02 00  	lw	t5, 0(t0)
;     sw        t5, 0(t4)
80002b48: 23 a0 ee 01  	sw	t5, 0(t4)
;     addi      t0, t0, 4
80002b4c: 93 82 42 00  	addi	t0, t0, 4
;     addi      t4, t4, 4
80002b50: 93 8e 4e 00  	addi	t4, t4, 4
;     blt       t0, t1, 1b
80002b54: e3 c8 62 fe  	blt	t0, t1, 0x80002b44 <.Lpcrel_hi7+0x2c>

80002b58 <.Lpcrel_hi8>:
;     la        t0, __tbss_start
80002b58: 97 02 00 00  	auipc	t0, 0
80002b5c: 93 82 02 63  	addi	t0, t0, 1584

80002b60 <.Lpcrel_hi9>:
;     la        t1, __tbss_end
80002b60: 17 03 00 00  	auipc	t1, 0
80002b64: 13 03 83 63  	addi	t1, t1, 1592
;     bge       t0, t1, 2f
80002b68: 63 da 62 00  	bge	t0, t1, 0x80002b7c <snrt.crt0.init_team>
; 1:  sw        zero, 0(t4)
80002b6c: 23 a0 0e 00  	sw	zero, 0(t4)
;     addi      t0, t0, 4
80002b70: 93 82 42 00  	addi	t0, t0, 4
;     addi      t4, t4, 4
80002b74: 93 8e 4e 00  	addi	t4, t4, 4
;     blt       t0, t2, 1b
80002b78: e3 ca 72 fe  	blt	t0, t2, 0x80002b6c <.Lpcrel_hi9+0xc>

80002b7c <snrt.crt0.init_team>:
;     addi      sp, sp, -20
80002b7c: 13 01 c1 fe  	addi	sp, sp, -20
;     sw        a0, 0(sp)
80002b80: 23 20 a1 00  	sw	a0, 0(sp)
;     sw        a1, 4(sp)
80002b84: 23 22 b1 00  	sw	a1, 4(sp)
;     sw        a2, 8(sp)
80002b88: 23 24 c1 00  	sw	a2, 8(sp)
;     sw        a3, 12(sp)
80002b8c: 23 26 d1 00  	sw	a3, 12(sp)
;     sw        a4, 16(sp)
80002b90: 23 28 e1 00  	sw	a4, 16(sp)
;     call      _snrt_init_team
80002b94: 97 f0 ff ff  	auipc	ra, 1048575
80002b98: e7 80 80 75  	jalr	1880(ra)
;     lw        a0, 0(sp)
80002b9c: 03 25 01 00  	lw	a0, 0(sp)
;     lw        a1, 4(sp)
80002ba0: 83 25 41 00  	lw	a1, 4(sp)
;     lw        a2, 8(sp)
80002ba4: 03 26 81 00  	lw	a2, 8(sp)
;     lw        a3, 12(sp)
80002ba8: 83 26 c1 00  	lw	a3, 12(sp)
;     lw        a4, 16(sp)
80002bac: 03 27 01 01  	lw	a4, 16(sp)
;     addi      sp, sp, 20
80002bb0: 13 01 41 01  	addi	sp, sp, 20

80002bb4 <snrt.crt0.init_interrupt>:
;     la t0, __snrt_crt0_interrupt_handler
80002bb4: 97 02 00 00  	auipc	t0, 0
80002bb8: 93 82 c2 03  	addi	t0, t0, 60
;     csrw   mtvec, t0
80002bbc: 73 90 52 30  	csrw	mtvec, t0

80002bc0 <snrt.crt0.pre_barrier>:
;     call      _snrt_cluster_barrier
80002bc0: 97 00 00 00  	auipc	ra, 0
80002bc4: e7 80 00 22  	jalr	544(ra)

80002bc8 <snrt.crt0.main>:
;     call      main  # main(int core_id, int core_num, void *spm_start, void *spm_end)
80002bc8: 97 e0 ff ff  	auipc	ra, 1048574
80002bcc: e7 80 c0 a6  	jalr	-1428(ra)
;     mv        s0, a0 # store return value in s0
80002bd0: 13 04 05 00  	mv	s0, a0

80002bd4 <snrt.crt0.post_barrier>:
;     call      _snrt_cluster_barrier
80002bd4: 97 00 00 00  	auipc	ra, 0
80002bd8: e7 80 c0 20  	jalr	524(ra)

80002bdc <snrt.crt0.end>:
;     mv        a0, s0 # recover return value of main function in s0
80002bdc: 13 05 04 00  	mv	a0, s0
;     call      _snrt_exit
80002be0: 97 00 00 00  	auipc	ra, 0
80002be4: e7 80 c0 22  	jalr	556(ra)
;     wfi
80002be8: 73 00 50 10  	wfi	
;     j       1b
80002bec: 6f f0 df ff  	j	0x80002be8 <snrt.crt0.end+0xc>

80002bf0 <__snrt_crt0_interrupt_handler>:
;     addi    sp, sp, -80
80002bf0: 13 01 01 fb  	addi	sp, sp, -80
;     sw  ra, 64(sp)
80002bf4: 23 20 11 04  	sw	ra, 64(sp)
;     sw  t0, 60(sp)
80002bf8: 23 2e 51 02  	sw	t0, 60(sp)
;     sw  t1, 56(sp)
80002bfc: 23 2c 61 02  	sw	t1, 56(sp)
;     sw  t2, 52(sp)
80002c00: 23 2a 71 02  	sw	t2, 52(sp)
;     sw  s0, 48(sp)
80002c04: 23 28 81 02  	sw	s0, 48(sp)
;     sw  a0, 44(sp)
80002c08: 23 26 a1 02  	sw	a0, 44(sp)
;     sw  a1, 40(sp)
80002c0c: 23 24 b1 02  	sw	a1, 40(sp)
;     sw  a2, 36(sp)
80002c10: 23 22 c1 02  	sw	a2, 36(sp)
;     sw  a3, 32(sp)
80002c14: 23 20 d1 02  	sw	a3, 32(sp)
;     sw  a4, 28(sp)
80002c18: 23 2e e1 00  	sw	a4, 28(sp)
;     sw  a5, 24(sp)
80002c1c: 23 2c f1 00  	sw	a5, 24(sp)
;     sw  a6, 20(sp)
80002c20: 23 2a 01 01  	sw	a6, 20(sp)
;     sw  a7, 16(sp)
80002c24: 23 28 11 01  	sw	a7, 16(sp)
;     sw  t3, 12(sp)
80002c28: 23 26 c1 01  	sw	t3, 12(sp)
;     sw  t4,  8(sp)
80002c2c: 23 24 d1 01  	sw	t4, 8(sp)
;     sw  t5,  4(sp)
80002c30: 23 22 e1 01  	sw	t5, 4(sp)
;     sw  t6,  0(sp)
80002c34: 23 20 f1 01  	sw	t6, 0(sp)
;     csrr    t0, misa
80002c38: f3 22 10 30  	csrr	t0, misa
;     andi    t0, t0, (1 << 3) # 3: D - single precision float extension
80002c3c: 93 f2 82 00  	andi	t0, t0, 8
;     beqz    t0, 1f
80002c40: 63 84 02 08  	beqz	t0, 0x80002cc8 <__snrt_crt0_interrupt_handler+0xd8>
;     addi    sp, sp, -256
80002c44: 13 01 01 f0  	addi	sp, sp, -256
;     fsd     f0, 248(sp)
80002c48: 27 3c 01 0e  	fsd	ft0, 248(sp)
;     fsd     f1, 240(sp)
80002c4c: 27 38 11 0e  	fsd	ft1, 240(sp)
;     fsd     f2, 232(sp)
80002c50: 27 34 21 0e  	fsd	ft2, 232(sp)
;     fsd     f3, 224(sp)
80002c54: 27 30 31 0e  	fsd	ft3, 224(sp)
;     fsd     f4, 216(sp)
80002c58: 27 3c 41 0c  	fsd	ft4, 216(sp)
;     fsd     f5, 208(sp)
80002c5c: 27 38 51 0c  	fsd	ft5, 208(sp)
;     fsd     f6, 200(sp)
80002c60: 27 34 61 0c  	fsd	ft6, 200(sp)
;     fsd     f7, 192(sp)
80002c64: 27 30 71 0c  	fsd	ft7, 192(sp)
;     fsd     f8, 184(sp)
80002c68: 27 3c 81 0a  	fsd	fs0, 184(sp)
;     fsd     f9, 176(sp)
80002c6c: 27 38 91 0a  	fsd	fs1, 176(sp)
;     fsd     f10, 168(sp)
80002c70: 27 34 a1 0a  	fsd	fa0, 168(sp)
;     fsd     f11, 160(sp)
80002c74: 27 30 b1 0a  	fsd	fa1, 160(sp)
;     fsd     f12, 152(sp)
80002c78: 27 3c c1 08  	fsd	fa2, 152(sp)
;     fsd     f13, 144(sp)
80002c7c: 27 38 d1 08  	fsd	fa3, 144(sp)
;     fsd     f14, 136(sp)
80002c80: 27 34 e1 08  	fsd	fa4, 136(sp)
;     fsd     f15, 128(sp)
80002c84: 27 30 f1 08  	fsd	fa5, 128(sp)
;     fsd     f16, 120(sp)
80002c88: 27 3c 01 07  	fsd	fa6, 120(sp)
;     fsd     f17, 112(sp)
80002c8c: 27 38 11 07  	fsd	fa7, 112(sp)
;     fsd     f18, 104(sp)
80002c90: 27 34 21 07  	fsd	fs2, 104(sp)
;     fsd     f19, 96(sp)
80002c94: 27 30 31 07  	fsd	fs3, 96(sp)
;     fsd     f20, 88(sp)
80002c98: 27 3c 41 05  	fsd	fs4, 88(sp)
;     fsd     f21, 80(sp)
80002c9c: 27 38 51 05  	fsd	fs5, 80(sp)
;     fsd     f22, 72(sp)
80002ca0: 27 34 61 05  	fsd	fs6, 72(sp)
;     fsd     f23, 64(sp)
80002ca4: 27 30 71 05  	fsd	fs7, 64(sp)
;     fsd     f24, 56(sp)
80002ca8: 27 3c 81 03  	fsd	fs8, 56(sp)
;     fsd     f25, 48(sp)
80002cac: 27 38 91 03  	fsd	fs9, 48(sp)
;     fsd     f26, 40(sp)
80002cb0: 27 34 a1 03  	fsd	fs10, 40(sp)
;     fsd     f27, 32(sp)
80002cb4: 27 30 b1 03  	fsd	fs11, 32(sp)
;     fsd     f28, 24(sp)
80002cb8: 27 3c c1 01  	fsd	ft8, 24(sp)
;     fsd     f29, 16(sp)
80002cbc: 27 38 d1 01  	fsd	ft9, 16(sp)
;     fsd     f30, 8(sp)
80002cc0: 27 34 e1 01  	fsd	ft10, 8(sp)
;     fsd     f31, 0(sp)
80002cc4: 27 30 f1 01  	fsd	ft11, 0(sp)
;     call    __snrt_isr
80002cc8: 97 f0 ff ff  	auipc	ra, 1048575
80002ccc: e7 80 40 7c  	jalr	1988(ra)
;     csrr    t0, misa
80002cd0: f3 22 10 30  	csrr	t0, misa
;     andi    t0, t0, (1 << 3) # 3: D - single precision float extension
80002cd4: 93 f2 82 00  	andi	t0, t0, 8
;     beqz    t0, 1f
80002cd8: 63 84 02 08  	beqz	t0, 0x80002d60 <__snrt_crt0_interrupt_handler+0x170>
;     fld     f0, 248(sp)
80002cdc: 07 30 81 0f  	fld	ft0, 248(sp)
;     fld     f1, 240(sp)
80002ce0: 87 30 01 0f  	fld	ft1, 240(sp)
;     fld     f2, 232(sp)
80002ce4: 07 31 81 0e  	fld	ft2, 232(sp)
;     fld     f3, 224(sp)
80002ce8: 87 31 01 0e  	fld	ft3, 224(sp)
;     fld     f4, 216(sp)
80002cec: 07 32 81 0d  	fld	ft4, 216(sp)
;     fld     f5, 208(sp)
80002cf0: 87 32 01 0d  	fld	ft5, 208(sp)
;     fld     f6, 200(sp)
80002cf4: 07 33 81 0c  	fld	ft6, 200(sp)
;     fld     f7, 192(sp)
80002cf8: 87 33 01 0c  	fld	ft7, 192(sp)
;     fld     f8, 184(sp)
80002cfc: 07 34 81 0b  	fld	fs0, 184(sp)
;     fld     f9, 176(sp)
80002d00: 87 34 01 0b  	fld	fs1, 176(sp)
;     fld     f10, 168(sp)
80002d04: 07 35 81 0a  	fld	fa0, 168(sp)
;     fld     f11, 160(sp)
80002d08: 87 35 01 0a  	fld	fa1, 160(sp)
;     fld     f12, 152(sp)
80002d0c: 07 36 81 09  	fld	fa2, 152(sp)
;     fld     f13, 144(sp)
80002d10: 87 36 01 09  	fld	fa3, 144(sp)
;     fld     f14, 136(sp)
80002d14: 07 37 81 08  	fld	fa4, 136(sp)
;     fld     f15, 128(sp)
80002d18: 87 37 01 08  	fld	fa5, 128(sp)
;     fld     f16, 120(sp)
80002d1c: 07 38 81 07  	fld	fa6, 120(sp)
;     fld     f17, 112(sp)
80002d20: 87 38 01 07  	fld	fa7, 112(sp)
;     fld     f18, 104(sp)
80002d24: 07 39 81 06  	fld	fs2, 104(sp)
;     fld     f19, 96(sp)
80002d28: 87 39 01 06  	fld	fs3, 96(sp)
;     fld     f20, 88(sp)
80002d2c: 07 3a 81 05  	fld	fs4, 88(sp)
;     fld     f21, 80(sp)
80002d30: 87 3a 01 05  	fld	fs5, 80(sp)
;     fld     f22, 72(sp)
80002d34: 07 3b 81 04  	fld	fs6, 72(sp)
;     fld     f23, 64(sp)
80002d38: 87 3b 01 04  	fld	fs7, 64(sp)
;     fld     f24, 56(sp)
80002d3c: 07 3c 81 03  	fld	fs8, 56(sp)
;     fld     f25, 48(sp)
80002d40: 87 3c 01 03  	fld	fs9, 48(sp)
;     fld     f26, 40(sp)
80002d44: 07 3d 81 02  	fld	fs10, 40(sp)
;     fld     f27, 32(sp)
80002d48: 87 3d 01 02  	fld	fs11, 32(sp)
;     fld     f28, 24(sp)
80002d4c: 07 3e 81 01  	fld	ft8, 24(sp)
;     fld     f29, 16(sp)
80002d50: 87 3e 01 01  	fld	ft9, 16(sp)
;     fld     f30, 8(sp)
80002d54: 07 3f 81 00  	fld	ft10, 8(sp)
;     fld     f31, 0(sp)
80002d58: 87 3f 01 00  	fld	ft11, 0(sp)
;     addi    sp, sp, 256
80002d5c: 13 01 01 10  	addi	sp, sp, 256
;     lw  t6,  0(sp)
80002d60: 83 2f 01 00  	lw	t6, 0(sp)
;     lw  t5,  4(sp)
80002d64: 03 2f 41 00  	lw	t5, 4(sp)
;     lw  t4,  8(sp)
80002d68: 83 2e 81 00  	lw	t4, 8(sp)
;     lw  t3, 12(sp)
80002d6c: 03 2e c1 00  	lw	t3, 12(sp)
;     lw  a7, 16(sp)
80002d70: 83 28 01 01  	lw	a7, 16(sp)
;     lw  a6, 20(sp)
80002d74: 03 28 41 01  	lw	a6, 20(sp)
;     lw  a5, 24(sp)
80002d78: 83 27 81 01  	lw	a5, 24(sp)
;     lw  a4, 28(sp)
80002d7c: 03 27 c1 01  	lw	a4, 28(sp)
;     lw  a3, 32(sp)
80002d80: 83 26 01 02  	lw	a3, 32(sp)
;     lw  a2, 36(sp)
80002d84: 03 26 41 02  	lw	a2, 36(sp)
;     lw  a1, 40(sp)
80002d88: 83 25 81 02  	lw	a1, 40(sp)
;     lw  a0, 44(sp)
80002d8c: 03 25 c1 02  	lw	a0, 44(sp)
;     lw  s0, 48(sp)
80002d90: 03 24 01 03  	lw	s0, 48(sp)
;     lw  t2, 52(sp)
80002d94: 83 23 41 03  	lw	t2, 52(sp)
;     lw  t1, 56(sp)
80002d98: 03 23 81 03  	lw	t1, 56(sp)
;     lw  t0, 60(sp)
80002d9c: 83 22 c1 03  	lw	t0, 60(sp)
;     lw  ra, 64(sp)
80002da0: 83 20 01 04  	lw	ra, 64(sp)
;     addi    sp, sp, 80
80002da4: 13 01 01 05  	addi	sp, sp, 80
;     mret
80002da8: 73 00 20 30  	mret	

80002dac <_snrt_init_core_info>:
;     mv        a4, a1
80002dac: 13 87 05 00  	mv	a4, a1
;     lw        a1, 4(a4)  # load the number of cores per cluster
80002db0: 83 25 47 00  	lw	a1, 4(a4)
;     lw        t0, 8(a4)  # load cluster's hartid offset
80002db4: 83 22 87 00  	lw	t0, 8(a4)
;     lw        a2, 12(a4) # start address of the TCDM
80002db8: 03 26 c7 00  	lw	a2, 12(a4)
;     lw        t1, 16(a4) # size of TCDM address space
80002dbc: 03 23 07 01  	lw	t1, 16(a4)
;     lw        t2, 20(a4) # offset between cluster TCDMs
80002dc0: 83 23 47 01  	lw	t2, 20(a4)
;     sub       a0, a0, t0
80002dc4: 33 05 55 40  	sub	a0, a0, t0
;     div       t3, a0, a1 # calculate cluster index
80002dc8: 33 4e b5 02  	div	t3, a0, a1
;     mul       t4, t3, t2 # calculate cluster TCDM offset
80002dcc: b3 0e 7e 02  	mul	t4, t3, t2
;     add       a2, a2, t4 # start address of current cluster TCDM
80002dd0: 33 06 d6 01  	add	a2, a2, t4
;     add       a3, a2, t1 # end address of current cluster TCDM
80002dd4: b3 06 66 00  	add	a3, a2, t1
;     remu      a0, a0, a1 # calculate cluster-local core id
80002dd8: 33 75 b5 02  	remu	a0, a0, a1
;     ret
80002ddc: 67 80 00 00  	ret

80002de0 <_snrt_cluster_barrier>:
;     addi      sp, sp, -4
80002de0: 13 01 c1 ff  	addi	sp, sp, -4
;     sw        ra, 0(sp)
80002de4: 23 20 11 00  	sw	ra, 0(sp)
;     call      _snrt_barrier_reg_ptr
80002de8: 97 f0 ff ff  	auipc	ra, 1048575
80002dec: e7 80 c0 68  	jalr	1676(ra)
;     lw        a0, 0(a0)
80002df0: 03 25 05 00  	lw	a0, 0(a0)
;     mv        zero, a0
80002df4: 13 00 05 00  	mv	zero, a0
;     lw        ra, 0(sp)
80002df8: 83 20 01 00  	lw	ra, 0(sp)
;     addi      sp, sp, 4
80002dfc: 13 01 41 00  	addi	sp, sp, 4
;     ret
80002e00: 67 80 00 00  	ret

80002e04 <_snrt_get_base_hartid>:
;     lw        a0, 8(a0)  # load cluster's hartid offset
80002e04: 03 25 85 00  	lw	a0, 8(a0)
;     ret
80002e08: 67 80 00 00  	ret

80002e0c <_snrt_exit>:
;     addi      sp, sp, -8
80002e0c: 13 01 81 ff  	addi	sp, sp, -8
;     sw        a0, 0(sp)
80002e10: 23 20 a1 00  	sw	a0, 0(sp)
;     sw        ra, 4(sp)
80002e14: 23 22 11 00  	sw	ra, 4(sp)
;     call      snrt_global_core_idx
80002e18: 97 f0 ff ff  	auipc	ra, 1048575
80002e1c: e7 80 c0 63  	jalr	1596(ra)
;     lw        t0, 0(sp)
80002e20: 83 22 01 00  	lw	t0, 0(sp)
;     lw        ra, 4(sp)
80002e24: 83 20 41 00  	lw	ra, 4(sp)
;     addi      sp, sp, 8
80002e28: 13 01 81 00  	addi	sp, sp, 8
;     bnez      a0, 1f
80002e2c: 63 1c 05 00  	bnez	a0, 0x80002e44 <.Lpcrel_hi11+0xc>
;     slli      t0, t0, 1
80002e30: 93 92 12 00  	slli	t0, t0, 1
;     ori       t0, t0, 1
80002e34: 93 e2 12 00  	ori	t0, t0, 1

80002e38 <.Lpcrel_hi11>:
;     la        t1, tohost
80002e38: 17 03 00 00  	auipc	t1, 0
80002e3c: 13 03 83 30  	addi	t1, t1, 776
;     sw        t0, 0(t1)
80002e40: 23 20 53 00  	sw	t0, 0(t1)
; 1:  ret
80002e44: 67 80 00 00  	ret
